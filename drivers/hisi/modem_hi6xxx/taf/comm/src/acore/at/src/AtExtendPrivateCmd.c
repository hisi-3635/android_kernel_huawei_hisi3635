...
*/
    ...
    {AT_CMD_NVIM,
    AT_SetT3402Stub,     AT_SET_PARA_TIME,   TAF_NULL_PTR,    AT_NOT_SET_TIME,   TAF_NULL_PTR, AT_SET_PARA_TIME,
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
    AT_CME_INCORRECT_PARAMETERS, CMD_TBL_LIMITED_NULL,
    (TAF_UINT8*)"^CT3402", (VOS_UINT8*)"(0,1)"},
...
/* XML命令 end  */
    ...
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
    AT_CME_INCORRECT_PARAMETERS, CMD_TBL_PIN_IS_LOCKED,
    (VOS_UINT8*)"^LOGCFG",    (VOS_UINT8*)"(0,1),(40-1024),(40-1024),(1000-1200000)"},
#endif
    {AT_CMD_LOGSAVE,
    ...
    {AT_CMD_SCICHG,
    At_SetSciChgPara,           AT_SET_PARA_TIME, At_QrySciChgPara, AT_QRY_PARA_TIME, At_TestSciChgPara,AT_NOT_SET_TIME,
    VOS_NULL_PTR,   AT_NOT_SET_TIME,
    AT_ERROR,                    CMD_TBL_PIN_IS_LOCKED,
    (VOS_UINT8*)"^SCICHG",    (VOS_UINT8*)"(0,1),(0,1)"},
