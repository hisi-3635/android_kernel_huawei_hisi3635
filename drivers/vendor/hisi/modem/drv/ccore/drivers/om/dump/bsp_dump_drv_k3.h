...
/*CP保留区域*/
#define DUMP_CP_RESERVE_OFFSET               (0x470000)
#define DUMP_CP_RESERVE_CPINFO_OFFSET        (0x40)
#define DUMP_CP_RESERVE_CPINFO_ADDR          (DDR_MNTN_ADDR_VIRT+DUMP_CP_RESERVE_OFFSET+DUMP_CP_RESERVE_CPINFO_OFFSET)
#define DUMP_CP_RESERVE_CPINFO_SIZE          (0x400)
