                               ...
                               MAILBOX_SLEEP_PROC_E enProcType)
{
    ...
    if(0 != len)
    {
        ...
        )
        {
            ...
            g_stMbxMntn.stCallback.ulSlice[g_stMbxMntn.stCallback.ulPtr] = BSP_GetSliceValue();
        ...
        else if(((u16)MBX_ADDRESSER_LTE_PHY_RCM == mod) || ((u16)MBX_ADDRESSER_TDS_PHY_RCM == mod))
        {
            ...
            g_stMbxMntn.stRcmCallback.ulSlice[g_stMbxMntn.stRcmCallback.ulPtr] = BSP_GetSliceValue();
        ...
        else if((u16)MBX_ADDRESSER_RTT_AGENT == mod)
        {
            ...
            g_stMbxMntn.stRttAgentCallback.ulSlice[g_stMbxMntn.stRttAgentCallback.ulPtr] = BSP_GetSliceValue();
...
void Mbx_ComPsIntProc(void)
{
    ...
    /* 记录时间，定位中断丢失 */
    g_stMbxMntn.stIntInfo.ulSlice[g_stMbxMntn.stIntInfo.ulPtr] = BSP_GetSliceValue();
