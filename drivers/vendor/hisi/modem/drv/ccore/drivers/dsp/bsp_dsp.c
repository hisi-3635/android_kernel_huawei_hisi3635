...
static struct dsp_info g_dsp_info =
{
    .dsp_timedump.load_start = 0,
	.dsp_timedump.load_end = 0,
	.dsp_timedump.msp_store = 0,
	.dsp_timedump.dpm_store = 0,
	.dsp_timedump.dsp_store = 0,
    .dsp_timedump.dsp_store_end = 0,
	.dsp_timedump.poweroff = 0,
	.dsp_timedump.poweron = 0,
	.dsp_timedump.dpm_wait_store_ok = 0,
	.dsp_timedump.dpm_restore = 0,
    .dsp_timedump.dsp_restore = 0,
	.dsp_timedump.msp_restore = 0,
	.dsp_timedump.msp_restore_ok = 0,
	.dsp_timedump_addr = NULL,
};
...
int bsp_bbe_load_muti(void)
{
    ...
    ret |= bsp_bbe_unreset();/*[false alarm]*/
    ...
    /* 开机时向tcm中拷数据之前做打点 */
    tmp_time = bsp_dsp_get_time_stamp();
...
int bsp_bbe_store(void)
{
    ...
    ret |= bsp_edma_channel_2vec_start(g_bbe16_state.store_edma_channel_id,
        ...
        LPHY_BBE16_PUB_DTCM_LOAD_SIZE, SZ_1K);  
#else
...
int bsp_bbe_restore(void)
{
    int ret = 0;
        ...
        ret |= bsp_edma_channel_2vec_start(g_bbe16_state.restore_edma_channel_id_tds,
            ...
            LPHY_BBE16_PUB_ITCM_LOAD_SIZE, SZ_1K);
#else
...
static inline void bsp_dsp_om_log(void)
{
    bsp_pm_log(PM_OM_DSP, sizeof(struct dsp_pm_om_qos_log), g_dsp_info.dsp_timedump_addr);
}

unsigned int bsp_dsp_get_time_stamp(void)
{
    u32 tmp_time = 0;
...
int bsp_msp_bbe_restore(void)
{
    ...
    {
        stamp_start = bsp_get_slice_value();/*[false alarm]*/
        ret = bsp_bbe_restore();
        g_bbe16_state.is_msp_restoring = 1;/*[false alarm]*/
        /* msp 记录tcm 恢复时间打点*/
        tmp_time = bsp_dsp_get_time_stamp();
...
void bsp_dsp_init(void)
{
    ...
    else
    {
        ...
        memset(g_dsp_info.dsp_timedump_addr, 0, sizeof(struct dsp_pm_om_qos_log));
    }
