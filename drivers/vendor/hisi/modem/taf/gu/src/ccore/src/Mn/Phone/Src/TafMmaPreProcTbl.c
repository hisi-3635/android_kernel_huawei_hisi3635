...
TAF_ACT_STRU        g_astTafMmaPreProcessActTbl[]   =
{
    ...
    TAF_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MMA_RSSI_IND,
                      TAF_MMA_RcvMmcRssiInd_PreProc),
    TAF_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MMA_LMM_CELL_SIGN_INFO_REPORT_IND,
                      TAF_MMA_RcvMmcLmmCellSignReportInd_PreProc),
    ...
    TAF_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MMA_SRCHED_PLMN_INFO_IND,
                      TAF_MMA_RcvMmcSrchedPlmnInfoInd_PreProc ),
    ...
    TAF_ACT_TBL_ITEM( WUEPS_PID_MMC,
                      ID_MMC_MMA_PS_SERVICE_CONN_STATUS_IND,
                      TAF_MMA_RcvMmcPsServiceConnStatusInd_PreProc ),
    /* AT的消息处理 */
