...
LOCAL MN_QRYMSGPARA_ATTR                f_astMnQryMsgParaAttr[] = {
    {TAF_PH_NETWORKNAME_PARA,       {0,0,0},sizeof(TAF_PH_NETWORKNAME_STRU)},
    {TAF_PH_MFR_ID_PARA,            {0,0,0},sizeof(TAF_PH_FMR_ID_STRU)},
    {TAF_PH_MODEL_ID_PARA,          {0,0,0},sizeof(TAF_PH_MODEL_ID_STRU)},
    {TAF_PH_REVISION_ID_PARA,       {0,0,0},sizeof(TAF_PH_REVISION_ID_STRU)},
    {TAF_PH_IMSI_ID_PARA,           {0,0,0},sizeof(TAF_PH_IMSI_STRU)},
    {TAF_PH_MS_CLASS_PARA,          {0,0,0},sizeof(TAF_PH_MS_CLASS_TYPE)},
    {TAF_PH_CS_REG_STATE_PARA,      {0,0,0},sizeof(TAF_PH_REG_STATE_STRU)},
    {TAF_PH_PS_REG_STATE_PARA,      {0,0,0},sizeof(TAF_PH_REG_STATE_STRU)},
    {TAF_PH_MODE_GET_PARA,          {0,0,0},sizeof(TAF_PH_MODE)},
    {TAF_PH_MS_BAND_PARA,           {0,0,0},sizeof(TAF_USER_SET_PREF_BAND64)},
    {TAF_PH_ACCESS_MODE_PARA,       {0,0,0},sizeof(TAF_ACCESS_MODE_QUERY_PARA_STRU)},
    {TAF_PH_CUR_FREQ,               {0,0,0},sizeof(TAF_PH_FRQ_STRU)},
    {TAF_PH_FPLMN_PARA,             {0,0,0},sizeof(TAF_USER_PLMN_LIST_STRU)},
    {TAF_PH_RSSI_VALUE_PARA,        {0,0,0},sizeof(TAF_PH_RSSI_STRU)},
    {TAF_PH_BATTERY_POWER_PARA,     {0,0,0},sizeof(TAF_PH_BATTERYPOWER_STRU)},
    {TAF_PH_CSQLVLEXT_VALUE_PARA,   {0,0,0},sizeof(MN_PH_CSQLVLEXT_PARA_STRU)},
    {TAF_PH_CSQLVL_VALUE_PARA,      {0,0,0},sizeof(MN_PH_CSQLVL_PARA_STRU)},

    {TAF_PH_ICC_ID,                 {0,0,0},sizeof(TAF_PH_ICC_ID_STRU)},
    {TAF_PH_QUICK_START_PARA,       {0,0,0},sizeof(TAF_UINT8)},
    {TAF_PH_AUTO_ATTACH_PARA,       {0,0,0},sizeof(TAF_UINT8)},
    {TAF_PH_SYSINFO_VALUE_PARA,     {0,0,0},sizeof(TAF_PH_SYSINFO_STRU)},
    ...
    {TAF_PH_HS_PARA,                {0,0,0},AT_HS_PARA_MAX_LENGTH},
    {TAF_PH_QRY_PERF_PLMN_PARA,     {0,0,0},sizeof(TAF_PLMN_NAME_LIST_STRU)},
    ...
    {TAF_PH_REGISTER_TIME_VALUE_PARA,   {0,0,0},    sizeof(VOS_UINT32)},
    {TAF_PH_ANQUERY_VALUE_PARA,         {0,0,0},    sizeof(MN_MMA_ANQUERY_PARA_STRU)},

    {TAF_PH_HOMEPLMN_VALUE_PARA,        {0,0,0},    sizeof(TAF_HPLMN_WITH_MNC_LEN_STRU)},

    {TAF_PH_CSNR_VALUE_PARA,            {0,0,0},    sizeof(MN_MMA_CSNR_PARA_STRU)},
    {TAF_PH_SPN_VALUE_PARA,             {0,0,0},    sizeof(MN_MMA_SPN_PARA_STRU)},

    {TAF_PH_EPS_REG_STATE_PARA,        {0,0,0},sizeof(TAF_PH_REG_STATE_STRU)},
    {TAF_PH_SYSINFO_EX_VALUE_PARA,     {0,0,0},sizeof(TAF_PH_SYSINFO_STRU)},

    {TAF_MM_PLMN_INFO_QRY_PARA,         {0,0,0},    sizeof(TAF_MMA_MM_INFO_PLMN_NAME_STRU)},

    {TAF_PH_PLMN_QRY_PARA,             {0,0,0},     sizeof(TAF_PLMN_ID_STRU)},

    {TAF_PH_USER_SRV_STATE_QRY_PARA,   {0,0,0},     sizeof(TAF_USER_SRV_STATE_STRU)},
...
{
    /*定位到文件尾部*/
    if((-1) == DRV_FILE_LSEEK(fp, 0, SEEK_END))
    {
    ...
    /*读取文件大小*/
    *pulFileSize = (VOS_UINT32)DRV_FILE_TELL(fp);
...
VOS_UINT32 MN_GetPidFromClientId(MN_CLIENT_ID_T usClientId)
{
    ...
    switch(usClientId)
    {
        case OAM_CLIENT_ID_OM:
            ulRcvPid = WUEPS_PID_OM_CALLBACK;
            break;
        ...
        case OAM_CLIENT_ID_DIAG:
            ulRcvPid = WUEPS_PID_DIAG;
            break;
