...
/*判断状态是否合法的返回值*/
#define APS_STATE_VALID                 0
#define APS_STATE_INVALID               1

#define APS_SELECT_THIS_FIELD           1
#define APS_USED                        1
#define APS_NOT_SELECT_THIS_FIELD       0
#define APS_FREE                        0

#define APS_INFO_LOG(String)            PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_INFO, String)
#define APS_NORM_LOG(String)            PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_NORMAL, String)
#define APS_WARN_LOG(String)            PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_WARNING, String)
#define APS_ERR_LOG(String)             PS_LOG(WUEPS_PID_TAF, TAF_APS, PS_PRINT_ERROR, String)
#define APS_LOG1(String, Para1)         PS_LOG1(WUEPS_PID_TAF, TAF_APS, PS_PRINT_NORMAL, String, Para1 )
#define APS_LOG2(String, Para1, Para2)  PS_LOG2(WUEPS_PID_TAF, TAF_APS, PS_PRINT_NORMAL, String, Para1, Para2)

/*数组中字节总数 = 数组中最后一个字节的索引数 + 1*/
#define APS_ARRAY_OCTET_0_AMOUNT        1

#define APS_ADDR_STR                    0

#define APS_INVALID_PDPID               0xFF                /*网络发起的激活为主激活时,输出参数设置为此值*/
#define APS_ERR_TI                      0xFF


#define APS_PDP_MIN_CID                 1
#define APS_PDP_RESELECT_CID            (12)
#define APS_PDP_MAX_CID                 (20)
#define APS_ACT_DEFAULT_CID             0
#define APS_INVALID_CID                 0
#define APS_QUE_ALL_CID                 0xFF
#define APS_OPTION_THIS_CID             1
#define  UPCASE( c ) ( (((c) >= 'a') && ((c) <= 'z')) ? ((c) - 0x20) : (c) )
/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
/*                  for APS 流程--APP层相关              */
/*=======================================================*/
/*ATC查看CID的PDP类型时如果出错则函数返回此宏*/
#define TAF_CIDTYPE_FAIL                0

#define APS_USIM_OK                     0
#define APS_USIM_ERR                    1

#define APS_NVIM_OK                     0
#define APS_NVIM_ERR                    1

#define APS_TFT_PACKETFILTER_ID         1
...
#define MN_APS_IPV4V6_ADDR_LEN          (20)
#endif
...
/*----------------------QOS相关--------------------------*/
#define APS_SAPI_NOT_ASSIGNED           0                   /* LLC SAPI not assigned*/
...
/*在打包SM的QOS结构体时，SM的要求QOS数组长度*/
#if(PS_UE_REL_VER < PS_PTL_VER_R5)
#define APS_SM_QOS_LEN                  11
#else
#define APS_SM_QOS_LEN                  14
#endif
...
/*去激活所有的PDP还是只去激活指定的那个PDP*/
#define APS_DEACT_ONE_PDP               0
#define APS_DEACT_ALL_PDP               1
...
#define APS_MDFIND_ADDR_DIFF_WITH_APS   1
#define APS_MDFIND_ADDR_SAME_WITH_APS   0
...
#define APS_NETDCMP_2_ATDCMP(AtDCmp, NetDCmp)                                   \
            ...
            {                                                                   \
                AtDCmp = TAF_PDP_D_COMP_V42;                                    \
            }                                                                   \
            else                                                                \
            {                                                                   \
                AtDCmp = TAF_PDP_D_COMP_ON;                                    \
            }/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/

#define APS_NETPCMP_2_ATHCMP(AtHCmp, NetPCmp)                                   \
            if (SN_1144_ALGRTH == NetPCmp)                                      \
            {                                                                   \
                AtHCmp = TAF_PDP_H_COMP_RFC1144;                                \
            }                                                                   \
            else if (SN_2507_ALGRTH == NetPCmp)                                 \
            {                                                                   \
                AtHCmp = TAF_PDP_H_COMP_RFC2507;                                \
            }                                                                   \
            else                                                                \
            {                                                                   \
                AtHCmp = TAF_PDP_H_COMP_ON;                                     \
            }/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
...
#define APS_NETDNS_2_STRDNS(StrDns, NetDns)                                     \
            StrDns.OP_Spare = APS_FREE;                                         \
            if ( APS_USED == NetDns.OP_PriDns)                                  \
            {                                                                   \
                StrDns.OP_PriDns    = APS_USED;                                 \
                Taf_Dns2Str( NetDns.aucPriDns, StrDns.aucPriDns );              \
            }                                                                   \
            else                                                                \
            {                                                                   \
                StrDns.OP_PriDns    = APS_FREE;                                 \
            }                                                                   \
            if ( APS_USED == NetDns.OP_SecDns)                                  \
            {                                                                   \
                StrDns.OP_SecDns    = APS_USED;                                 \
                Taf_Dns2Str( NetDns.aucSecDns, StrDns.aucSecDns );              \
            }                                                                   \
            else                                                                \
            {                                                                   \
                StrDns.OP_SecDns    = APS_FREE;                                 \
            }/*~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#endif
...
#define APS_2TO3_CUR3_SUCC_LINE         0
#define APS_3TO2_CUR2_SUCC_LINE         1

/*
#define APS_2TO3_CUR3_FAIL_LINE         1
#define APS_2TO3_CUR2_SUCC_LINE         2
#define APS_2TO3_CUR2_FAIL_LINE         3
#define APS_3TO2_CUR2_SUCC_LINE         4
#define APS_3TO2_CUR2_FAIL_LINE         5
#define APS_3TO2_CUR3_SUCC_LINE         6
#define APS_3TO2_CUR3_FAIL_LINE         7 */

#define APS_INACT_ROW                   0
#define APS_ACT_PENDING_ROW             1
#define APS_NET_ACT_PENDING_ROW         2
#define APS_ACT_STABLE_ROW              3
#define APS_ACT_2TO3DEACTIVING_SN_ROW   4
#define APS_MDF_PENDING_ROW             5
#define APS_DEACT_PEND_WAITING_SM_ROW   6
#define APS_DEACT_PEND_WAITING_SN_ROW   7

typedef VOS_UINT8   APS_RABM_TRANS_MODE;
#define APS_ABM_TYPE                    0
#define APS_ADM_TYPE                    1
...
typedef VOS_UINT8   APS_TFT_COMBINE;
#define APS_TFT_COMBINE_VALID                       0
#define APS_TFT_COMBINE_INVALID                     1
...
/*~~~~~~~~~~~~~~~~~~~~~~~~QOS定义需要用的宏  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~*/
#define APS_QOS_DELETE(pQosPara)       ((0 == pQosPara->OP_TrafficClass)        \
                                    &&  (0 == pQosPara->OP_DeliverOrder)        \
                                    &&  (0 == pQosPara->OP_DeliverErrSdu)       \
                                    &&  (0 == pQosPara->OP_MaxSduSize)          \
                                    &&  (0 == pQosPara->OP_MaxBitUl)            \
                                    &&  (0 == pQosPara->OP_MaxBitDl)            \
                                    &&  (0 == pQosPara->OP_ResidualBer)         \
                                    &&  (0 == pQosPara->OP_SduErrRatio)         \
                                    &&  (0 == pQosPara->OP_TransDelay)          \
                                    &&  (0 == pQosPara->OP_TraffHandlePrior)    \
                                    &&  (0 == pQosPara->OP_GuarantBitUl)        \
                                    &&  (0 == pQosPara->OP_GuarantBitDl))


/*~~~~~~~~~~~~~~~~~~~~~~~~TFT定义需要用的宏  ~~~~~~~~~~~~~~~~~~~~~~~~*/
#define APS_TFT_DELETE(pTftPara)       ((0 == pTftPara->OP_ucPrecedence)        \
                                    &&  (0 == pTftPara->OP_HighSourcePort)      \
                                    &&  (0 == pTftPara->OP_LowSourcePort)       \
                                    &&  (0 == pTftPara->OP_HighDestPort)        \
                                    &&  (0 == pTftPara->OP_LowDestPort)         \
                                    &&  (0 == pTftPara->OP_SourceIpAddr)        \
                                    &&  (0 == pTftPara->OP_SourceIpMask)        \
                                    &&  (0 == pTftPara->OP_ProtocolId )         \
                                    &&  (0 == pTftPara->OP_ulSecuParaIndex)     \
                                    &&  (0 == pTftPara->OP_ucTypeOfService)     \
                                    &&  (0 == pTftPara->OP_ucTypeOfServiceMask))

 #define APS_TFT_PARA_DELETE(pTftPara) (pTftPara->OP_HighSourcePort)       = 0; \
                                       (pTftPara->OP_LowSourcePort)        = 0; \
                                       (pTftPara->OP_HighDestPort)         = 0; \
                                       (pTftPara->OP_LowDestPort)          = 0; \
                                       (pTftPara->OP_SourceIpAddr)         = 0; \
                                       (pTftPara->OP_SourceIpMask)         = 0; \
                                       (pTftPara->OP_ProtocolId )          = 0; \
                                       (pTftPara->OP_ulSecuParaIndex)      = 0; \
                                       (pTftPara->OP_ucTypeOfService)      = 0; \
                                       (pTftPara->OP_ucTypeOfServiceMask)  = 0;


#define APS_TFT_DEF_VALID(pTftPara)     (1 == pTftPara->bitOpPrecedence )

/*~~~~~~~~~~~~~~~~~~~~~~~~AUTH定义需要用的宏  ~~~~~~~~~~~~~~~~~~~~~~~~*/
#define APS_AUTH_DELETE(pAuthPara)     ((0 == pAuthPara->OP_Auth)               \
                                    &&  (0 == pAuthPara->OP_Username)           \
                                    &&  (0 == pAuthPara->OP_Password))

#define APS_AUTH_DEF_VALID(pAuthPara)  ((0 == pAuthPara->OP_Auth)               \
                                    || ((1 == pAuthPara->OP_Auth)               \
                                    &&  (1 == pAuthPara->OP_Username)           \
                                    &&  (1 == pAuthPara->OP_Password)))

/*~~~~~~~~~~~~~~~~~~~~~~~~DNS参数定义需要用的宏  ~~~~~~~~~~~~~~~~~~~~~~*/
#define APS_DNS_PARA_DELETE(pDnsPara)  ((0 == pDnsPara->OP_PriDns)\
                                    &&  (0 == pDnsPara->OP_SecDns))

/*~~~~~~~~~~~~~~~~~~~~~~~~AUTHDATA参数定义需要用的宏  ~~~~~~~~~~~~~~~~~~~~~~*/
#define APS_AUTHDATA_PARA_DELETE(pauthdataPara)  ((0 == pauthdataPara->OP_AuthType) \
                                             &&  (0 == pauthdataPara->OP_Plmn)      \
                                             &&  (0 == pauthdataPara->OP_Password)  \
                                             &&  (0 == pauthdataPara->OP_Username))
...
typedef struct
{
    ...
    VOS_UINT8                           aucRsv5[3];
    TAF_PDP_AUTH_STRU                   AuthTab;                                /*鉴权参数表*/
    ...
    VOS_UINT8                           aucRsv7[26];                            /* 多余的24个保留字节，目的是为了和NV项对齐 */
...
typedef struct
{
    ...
    #if(PS_UE_REL_VER <= PS_PTL_VER_R4)
    VOS_UINT8                           aucRsv[3];         /* 4字节对齐 */
...
typedef struct
{
    ...
    APS_PDP_ACT_TYPE_ENUM               ActType;            /*激活类型*/
...
typedef struct
{
    ...
    /*TearDown 去激活的PDP的数目，包括TEARDOWN本身的那个PDPID.如果没有TEARDOWN,
    则只填TEARDOWN自己的那个PdpId*/
    VOS_UINT8                           ucPdpNum;
    VOS_UINT8                           aucPdpIdList[TAF_APS_MAX_PDPID + 1];
} APS_TEARDOWN_PDP_ST;
...
typedef struct
{
    VOS_UINT8                           ucAppCause;                             /*aps的原因值*/
    VOS_UINT32                          ulEsmCause;                             /*L4A返回的原因值*/
} APS_ESM_CAUSE_TO_APP_CAUSE_STRU;
#endif

typedef struct
{
    VOS_UINT8                           OP_ADDRG            : 1;
    VOS_UINT8                           OP_APN              : 1;
    VOS_UINT8                           OP_SPARE            : 6;

    APS_PDP_ADDR_ST                     PdpAddr;
    APS_PDP_APN_ST                      PdpApn;
} APS_ACTIND_ADDR_APN_ST;
...
/*有TEARDOWN时去激活SNDCP需要的参数*/
typedef struct
{
    VOS_UINT8                           ucPdpId;
    VOS_UINT8                           ucTearDown; /*0:tear down not requested
...
typedef struct
{
    VOS_UINT8                           ucFlg;              /*0-未激活,1-激活;*/
    VOS_UINT8                           ucRadioPriority;    /*Refer to 24.008 10.5.7.2*/
    APS_ST_QOS                          Qos;                /*Refer to ExtAppCmInterface.h*/
}APS_SNDCP_ACT_CNF_TAB_ST;

typedef struct
{   /*使用前请清空此结构体*/
    APS_SNDCP_ACT_CNF_TAB_ST            ApsSnActCnfTab[APS_NSAPI_MAX + 1];
                                                            /*该数组的位置为NSAPI的索引*/
}APS_SNDCP_ACT_CNF_ST;
...
typedef struct
{
    VOS_UINT8                           ucFlag;             /*0 - 该结构变量无效;
                                                              1 - 该结构变量有效 */

    VOS_UINT8                           ucPdpNum;           /*SAPI相关的PDP的数目*/
    VOS_UINT8                           aucPdpIdList[TAF_APS_MAX_PDPID + 1];
}APS_SAPI_PDP_ST;
...
/* 终端可配置需求: Traffic class可配置 */
typedef struct
{
    VOS_UINT8   ucStatus;       /* 1: NV有效标志位，0：无效 */
    VOS_UINT8   ucTrafficClass;
}APS_TRAFFIC_CLASS_CUSTOMIZE_STRU;
...
----------------------------------------------------------------------------*/
extern  HTIMER                          g_TimerTable[APS_MAX_PDP_NUM + 1];
...
/*定义、修改、删除PDP的鉴权信息，AT无此命令，需要增加自定义的*/
...
VOS_UINT8   Aps_CompAddr(               VOS_UINT8                   ucReqPdpId,
                                        VOS_UINT8                   ucDstPdpId  );

VOS_UINT8   Aps_CompApn(               VOS_UINT8           ucReqPdpId,
                                        VOS_UINT8           ucDstPdpId  );
...
VOS_UINT32      Aps_TftValidOrNot(          APS_PDP_TFT_ST             *psTft);
VOS_UINT32      Aps_QosValidOrNot(          APS_PDP_QOS_STRU           *psQos);

APS_PDP_CONTEXT_ENTITY_ST*  Aps_FindPdpContext(VOS_UINT8            ucPdpId);
...
VOS_VOID    Aps_dealRabmLocalPdpDeactReqMsg(RABM_APS_LOCAL_PDP_DEACT_REQ* pMsg);
...
/*****************************************************************************
 函 数 名  : MN_APS_RcvSetPdpAuthInfoReq
 功能描述  :
 输入参数  : VOS_VOID                           *pMsgData
 输出参数  : 无
 返 回 值  : VOS_UINT32
...
/*****************************************************************************
 函 数 名  : MN_APS_RcvGetPdpAuthInfoReq
 功能描述  :
 输入参数  : VOS_VOID                           *pMsgData
 输出参数  : 无
 返 回 值  : VOS_UINT32
...
/*****************************************************************************
 函 数 名  : MN_APS_RcvTrigGprsDataReq
 功能描述  :
 输入参数  : VOS_VOID                           *pMsgData
 输出参数  : 无
 返 回 值  : VOS_UINT32
