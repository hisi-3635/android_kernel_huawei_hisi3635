...
{
    g_stTafMmaCtx.stDelayReportServiceInfo.ucEnable = ucDelayReportServiceStatusFlg;
}
...
{
    return (g_stTafMmaCtx.stDelayReportServiceInfo.ucEnable);
}
...
{
    g_stTafMmaCtx.stDelayReportServiceInfo.ulRptSrvStaDelayTimerValue = ulTimerLen;
}
...
{
    return (g_stTafMmaCtx.stDelayReportServiceInfo.ulRptSrvStaDelayTimerValue);
}
