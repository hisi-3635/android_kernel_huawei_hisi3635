...
typedef struct
{
    ...
    VOS_UINT8                           ucRseCfg            : 1;
    VOS_UINT8                           ucG900B7Cfg         : 1;
...
typedef struct
{
    ...
    TAF_MTC_SRV_CONN_STATE_ENUM_UINT8   enRcmPsSrvConnState;
...
typedef struct
{
    MTC_MODEM_CONN_STATE_INFO_STRU          stConnStateInfo;
...
typedef struct
{
    ...
    RRC_MTC_MS_BAND_INFO_STRU               stCurBandInfo;                      /* Modem当前所有的频段信息 */
    RRC_MTC_MS_BAND_INFO_STRU               stSerCellBandInfo;                  /* Modem当前驻留的服务频段信息, 目前只有TRRC、GAS1上报 */
    RRC_MTC_MS_BAND_INFO_STRU               stServiceBandInfo;                  /* Modem当前业务频段信息, 目前只有GAS1上报 */
    RRC_MTC_MS_BAND_INFO_STRU               stNCellBandInfo;                    /* Modem当前邻区频段信息, 目前只有GAS1上报 */
