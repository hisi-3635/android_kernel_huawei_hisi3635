...
VOS_VOID MTC_SetCsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId,
    TAF_MTC_SRV_CONN_STATE_ENUM_UINT8   enConnSt
)
{
    MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enCsSrvConnState = enConnSt;
}


TAF_MTC_SRV_CONN_STATE_ENUM_UINT8 MTC_GetCsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId
)
{
    return  MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enCsSrvConnState;
}


VOS_VOID MTC_SetPsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId,
    TAF_MTC_SRV_CONN_STATE_ENUM_UINT8   enConnSt
)
{
     MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enPsSrvConnState = enConnSt;
}


VOS_VOID MTC_SetRcmPsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId,
    TAF_MTC_SRV_CONN_STATE_ENUM_UINT8   enConnSt
)
{
     MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enRcmPsSrvConnState = enConnSt;
}


TAF_MTC_SRV_CONN_STATE_ENUM_UINT8 MTC_GetPsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId
)
{
    return  MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enPsSrvConnState;
}


TAF_MTC_SRV_CONN_STATE_ENUM_UINT8 MTC_GetRcmPsConnStateInfo(
    MODEM_ID_ENUM_UINT16                enModemId
)
{
    return  MTC_GetModemCtxAddr(enModemId)->stConnStateInfo.enRcmPsSrvConnState;
}
...
MTC_CFG_ENUM_UINT8 MTC_GetG900B7Cfg(VOS_VOID)
{
    MTC_RF_INTRUSION_CFG_STRU          *pstRfIntrusionCfg = VOS_NULL_PTR;
    MTC_CFG_ENUM_UINT8                  enMtcCfg;

    pstRfIntrusionCfg = (MTC_RF_INTRUSION_CFG_STRU *)&(MTC_GetIntrusionCtxAddr()->stIntrusionCfg);
    enMtcCfg          = (VOS_TRUE == pstRfIntrusionCfg->ucG900B7Cfg) ? MTC_CFG_ENABLE : MTC_CFG_DISABLE;
