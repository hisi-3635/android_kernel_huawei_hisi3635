...
/* ulServiceStatus */
#define     MMC_MM_NORMAL_SERVICE                   MMA_MMC_SERVICE_STATUS_NORMAL_SERVICE
#define     MMC_MM_LIMITED_SERVICE                  MMA_MMC_SERVICE_STATUS_LIMITED_SERVICE
#define     MMC_MM_LIMITED_SERVICE_REGION           MMA_MMC_SERVICE_STATUS_LIMITED_SERVICE_REGION
#define     MMC_MM_NO_IMSI                          MMA_MMC_SERVICE_STATUS_NO_IMSI
#define     MMC_MM_NO_SERVICE                       MMA_MMC_SERVICE_STATUS_NO_SERVICE
...
/* MMC发给MM的原语 */
    ...
    MMCMM_LAU_REQ                       = 46,   /* _H2ASN_MsgChoice MMCMM_LAU_REQ_STRU */
...
typedef VOS_UINT32 MMC_MM_DETACH_CAUSE_ENUM_UINT32;
...
typedef struct
{
    ...
    MMC_MM_DETACH_CAUSE_ENUM_UINT32     enDetachCause ;                         /* DETACH 类型 */
