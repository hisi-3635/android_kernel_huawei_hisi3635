...
#define     MMC_MMA_MAX_SRCHED_LAI_NUM  (18)
...
enum MMA_MMC_MSG_ID_ENUM
{
    ...
    ID_MMA_MMC_AUTO_RESEL_SET_REQ         = 53,                                 /* _H2ASN_MsgChoice MMA_MMC_AUTO_RESEL_SET_REQ_STRU */
    ...
    ID_MMC_MMA_PS_SERVICE_CONN_STATUS_IND = 77,
    ID_MMC_MMA_LMM_CELL_SIGN_INFO_REPORT_IND             = 78,                                   /* MMC_MMA_LMM_CELL_SIGN_INFO_REPORT_IND_STRU */

    ID_MMC_MMA_SRCHED_PLMN_INFO_IND       = 81,                                     /* MMC_MMA_SRCHED_PLMN_INFO_IND_STRU */
...
typedef struct
{
    ...
    MMA_MMC_NET_RAT_TYPE_ENUM_UINT8     enRat;                                  /*当前上报信号的制式*/
...
typedef struct
{
    ...
    MMC_MMA_CQI_INFO_STRU               stCQI;                                  /* Channle Quality Indicator*/
}MMA_MMC_LMM_CELL_SIGN_INFO_STRU;
...
typedef struct
{
    ...
    MMA_MMC_SCELL_MEAS_REPORT_TYPE_UN   unMeasReportType;                       /* 本次上报类型 */
    MMA_MMC_LMM_CELL_SIGN_INFO_STRU     stLteRssi;                              /* LTE cell Signal INFO */
}MMC_MMA_LMM_CELL_SIGN_INFO_REPORT_IND_STRU;
typedef struct
{
    MSG_HEADER_STRU                                         MsgHeader;          /* 消息头                                   */
...
typedef struct
{
    ...
    VOS_UINT8                                               aucReserved[3];
} MMA_MMC_AUTO_RESEL_SET_REQ_STRU;
typedef struct
{
...
typedef struct
{
    ...
    VOS_UINT8                           aucReserved[3];
}MMC_MMA_PS_SERVICE_CONN_STATUS_IND_STRU;
typedef struct
{
    MSG_HEADER_STRU                            stMsgHeader;
...
typedef struct
{
    ...
    MMA_MMC_NET_RAT_TYPE_ENUM_UINT8            enRat;
    VOS_UINT8                                  aucReserved[3];
     
    VOS_UINT32                                 ulLaiNum;
    MMC_MMA_LAI_STRU                           astLai[MMC_MMA_MAX_SRCHED_LAI_NUM];
}MMC_MMA_SRCHED_PLMN_INFO_IND_STRU;
