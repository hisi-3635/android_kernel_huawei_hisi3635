...
)
{
    ...
    {
        PS_LOG(WUEPS_PID_CC, VOS_NULL, PS_PRINT_ERROR, "MN_CALL_SndAcpuOmFaultErrLogInd:ERROR: Alloc msg fail.");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_CC, VOS_NULL, PS_PRINT_ERROR, "MN_CALL_SndAcpuOmFaultErrLogInd:ERROR: SEND MSG FIAL.");
    }
