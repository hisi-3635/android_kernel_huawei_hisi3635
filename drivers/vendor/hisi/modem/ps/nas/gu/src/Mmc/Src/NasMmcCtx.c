...
VOS_UINT8  NAS_MMC_IsNeedStartNcellAvailableTimer(VOS_VOID)
{
   ...
   */
    if ((VOS_TRUE == ucNcellSearchFlag)
     ...
     && (ulAvailableSearchTimeLen >= (VOS_UINT32)(2*ucNcellSearchTimerLen))
...
void NAS_REBOOTSTUB(NAS_MML_REBOOT_SCENE_ENUM_UINT8 reboot)
{
	NAS_MML_SoftReBoot(reboot);
...
VOS_VOID NAS_MMC_SetRatChgForLteOos2GPrefPlmnSelFlg(VOS_UINT8 ucRatChgForLteOos2GPrefPlmnSelFlg)
{
    NAS_MMC_GetMmcCtxAddr()->stPlmnSearchCtrl.ucRatChgForLteOos2GPrefPlmnSelFlg = ucRatChgForLteOos2GPrefPlmnSelFlg;
}


VOS_UINT8 NAS_MMC_GetRatChgForLteOos2GPrefPlmnSelFlg(VOS_VOID)
{
    return NAS_MMC_GetMmcCtxAddr()->stPlmnSearchCtrl.ucRatChgForLteOos2GPrefPlmnSelFlg;
}
#endif
