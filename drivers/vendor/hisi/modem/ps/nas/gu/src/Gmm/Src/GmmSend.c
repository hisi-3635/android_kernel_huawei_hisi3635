...
#if (VOS_WIN32 == VOS_OS_VER)
    /* 调用VOS发送原语 */
    ulRet = PS_SEND_MSG(WUEPS_PID_GMM, pstReselSecuInfoReq);
    if(VOS_OK != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmReselSecuInfoReq:向LMM发送消息失败");
    }
#else
    /* 内部消息的发送 */
    ulRet = NAS_MML_SndInternalMsg(pstReselSecuInfoReq);
    if(VOS_TRUE != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmReselSecuInfoReq:向LMM发送消息失败");
    }
...
#if (VOS_WIN32 == VOS_OS_VER)
    /* 调用VOS发送原语 */
    ulRet = PS_SEND_MSG(WUEPS_PID_GMM, pstHoSecuInfoReq );
    if(VOS_OK != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmHoSecuInfoReq:向LMM发送消息失败");
    }

#else
    /* 内部消息的发送 */
    ulRet = NAS_MML_SndInternalMsg(pstHoSecuInfoReq);
    if(VOS_TRUE != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmHoSecuInfoReq:向LMM发送消息失败");
    }
...
#if (VOS_WIN32 == VOS_OS_VER)
    /* 调用VOS发送原语 */
    ulRet = PS_SEND_MSG(WUEPS_PID_GMM, pstInfoChange );
    if (VOS_OK != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmInfoChangeNotifyReq:向LMM发送消息失败");
    }
#else
    /* 内部消息的发送 */
    ulRet = NAS_MML_SndInternalMsg(pstInfoChange);
    if (VOS_TRUE != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmInfoChangeNotifyReq:向LMM发送消息失败");
    }
...
#if (VOS_WIN32 == VOS_OS_VER)
    /* 调用VOS发送原语 */
    ulRet = PS_SEND_MSG(WUEPS_PID_GMM, pstTimerStatusNotify);
    if (VOS_OK != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmTimerInfoNotify:向LMM发送消息失败");
    }
#else
    /* 内部消息的发送 */
    ulRet = NAS_MML_SndInternalMsg(pstTimerStatusNotify);
    if (VOS_TRUE != ulRet)
    {
        NAS_ERROR_LOG(WUEPS_PID_GMM, "NAS_GMM_SndLmmTimerInfoNotify:向LMM发送消息失败");
    }
...
VOS_VOID GMM_ReportM2NOtaMsg(NAS_MSG_STRU *pNasMsg)
{
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "GMM_ReportM2NOtaMsg:NORMAL: msg id is", pNasMsg->aucNasMsg[1]);
    ...
    switch(pNasMsg->aucNasMsg[1])
    {
        ...
        default:
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "GMM_ReportM2NOtaMsg:WARNING: invalid msg id");
                       ...
                       )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmEstReq:WARNING: Null pointer");
        return;
    }
    ...
    {   /*如果是W,则调用原来处理过程*/
        ...
        if (AS_SUCCESS != lRet)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmEstReq:WARNING: Send msg fail.");
        }
    }
    else
    {   /*GPRS情况*/
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmEstReq:WARNING: Free msg fail.");
    }
                        ...
                        )
{
    ...
    if(VOS_NULL_PTR == pMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmDataReq:WARNING: Null pointer");
        return;
    }
    ...
    if (GMM_TRUE == GMM_IsCasGsmMode())
    {
        ...
        if (VOS_OK != ulRet)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmDataReq:WARNING: Free msg fail.");
        }
        return;
    }
    ...
    if (AS_SUCCESS != lRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmDataReq:WARNING: Send msg fail.");
    }
...
VOS_VOID Gmm_SndRrmmRelReq(RRC_CELL_BAR_ENUM_UINT32  enBarValidFlg)
{
    ...
    if (AS_SUCCESS != lRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmRelReq:WARNING: Send msg fail.");
    }
    return;                                                                     /* 返回                                     */
}
...
VOS_VOID  NAS_GMM_SndRrmmRelCsPsAllConnReq(VOS_VOID)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_SndRrmmRelCsPsAllConnReq:WARNING: Memory Alloc Fail.");
        return;
    }
                           ...
                           )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmEstablishCnf:WARNING: Send msg fail.");
    }
    return;
}
...
VOS_VOID Gmm_SndSmStatusInd(VOS_VOID)
{
    ...
    case GMM_SUSPENDED_WAIT_FOR_SYSINFO:
        return;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_SndSmStatusInd:INFO: g_GmmGlobalCtrl.ucState need not report");
        return;
...
/*modify by liurui, 2006-04-27, A32D01286 test end*/
    ...
    if (VOS_NULL_PTR == pMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmStatusInd:WARNING: Alloc Memory Fail.");
        return;
    }
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmStatusInd:WARNING: Send msg Fail.");
    }
    return;
}
...
)
{
    ...
    if (VOS_NULL_PTR == pstMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_SndSmStatusInd:WARNING: Alloc Memory Fail.");
        return;
    }
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_SndSmStatusInd:WARNING: Send msg Fail.");
    }
    return;
                      ...
                      )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmDataInd:WARNING: Send msg Fail.");
    }
    return;
}
                        ...
                        )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "GMM_SndSmServiceRej:WARNING: Send msg Fail.");
    }
    return;
}
                        ...
                        )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmPdpStatusInd:WARNING: Send msg Fail.");
    }
    return;
}
VOS_VOID Gmm_SndSmSysInfoInd(VOS_UINT8 ucSgsnRelease)
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmSysInfoInd:WARNING: Send msg Fail.");
    }
    return;
}
VOS_VOID Gmm_SndSmRelInd(VOS_VOID)
{
    ...
    if (VOS_NULL_PTR == pMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_SndSmRelInd:WARNING: Memory Alloc Fail.");
        return;
    }
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmRelInd:WARNING: Send msg Fail.");
    }
    return;
}
/*******************************************************************************
                               ...
                               )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRabmReestablishCnf:WARNING: Send msg Fail.");
    }
    return;
}
                            ...
                            )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Com_DealOfPlmnList:INFO: The Entry Pointer is VOS_NULL_PTR");
        return GMM_FALSE;                                                       /* 返回                                     */
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Com_DealOfPlmnList:WARNING: Alloc mem fail.");
        return GMM_FALSE;                                                       /* 返回                                     */
    }
                        ...
                        )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Com_DealOfMsId:WARNING: The Entry Pointer is VOS_NULL_PTR");
        return;                                                                 /* 返回                                     */
    }
...
VOS_VOID NAS_GMM_SndAcpuOmChangePtmsi(VOS_VOID)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "NAS_GMM_SndAcpuOmChangePtmsi:INFO: FTM CTRL OFF.");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "NAS_GMM_SndAcpuOmChangePtmsi:INFO: PTMSI NOT CHANGE.");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_SndAcpuOmChangePtmsi:ERROR: Alloc msg fail.");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_SndAcpuOmChangePtmsi:ERROR: SEND MSG FIAL.");
    }
                                   ...
                                   )
{
    ...
    switch (usEfId)
    {
    case GMM_USIM_FILE_PS_KEY_GPRS:
    /* BEGIN: Modified by liurui id:40632, 2006/6/29   PN:A32D04514 */
    case GMM_USIM_FILE_KC_KEY_GPRS:     /* 2G SIM GPRS Kc Key */
    /* END:   Modified by liurui id:40632, 2006/6/29   PN:A32D04514 */
        pucPsKey = (VOS_UINT8 *)Gmm_MemMalloc(9);               /* 申请空间 */
        if (VOS_NULL_PTR == pucPsKey)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndAgentUsimUpdateFileReq:WARNING: Alloc mem fail.");
            return;                                                            /* 返回                                     */
        }
        ...
        NAS_USIMMAPI_SetFileReq(WUEPS_PID_GMM, 0, &stSetFileInfo);

        Gmm_MemFree(pucPsKey);                                                  /* 释放内存 */

        break;
    case GMM_USIM_FILE_PS_KEY:
    ...
    case GMM_USIM_FILE_PS_LOC_INFO:                                             /* 更新PS Location information              */
        ...
        if (0 != PS_MEM_CMP(pucPsLocInfo, NAS_MML_GetSimPsLociFileContent(), NAS_MML_PS_LOCI_SIM_FILE_LEN))
        {
            ...
            if (NV_OK != NV_Write(en_NV_Item_Ps_Loci, &stPsLociSimFiles, 14))
            {
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndAgentUsimUpdateFileReq:WARNING: EF id error");
        break;
    }
...
VOS_VOID Gmm_SndSmsRegStateInd(VOS_VOID)
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmsRegStateInd:WARNING: Send msg fail.");
    }
    return;
}
...
VOS_VOID Gmm_SndSmsEstCnf(VOS_VOID)
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmsEstCnf:WARNING: Send msg fail.");
    }
    return;
}
                           ...
                           )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmsUnitdataInd:WARNING: Send msg fail.");
    }
    return;
}
                        ...
                        )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmsErrorInd:WARNING: Send msg fail.");
    }
    return;
}
...
VOS_VOID Gmm_SndSmsServiceStatusInd(VOS_VOID)
{
    ...
    {                                                                           /* 服务状态变化了才上报给短信模块           */
        ...
        if (VOS_OK != ulRet)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndSmsServiceStatusInd:WARNING: Send msg fail.");
        }
    }
                      ...
                      )
{
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndTcDataInd:WARNING: Send msg fail.");
    }
    return;
}
                            ...
                            )
{
    ...
    if (AS_SUCCESS != lRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndRrmmDataReqForCm:WARNING: Send msg fail.");
    }
    return;                                                                     /* 返回                                     */
}
...
VOS_VOID Gmm_SndCcEmergencyNumberList(NAS_MML_EMERGENCY_NUM_LIST_STRU *pEmergencyList)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_SndCcEmergencyNumberList:ERROR:Receive Null Pointer!");
        return;                                                                 /* 返回                                     */
    }
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_SndCcEmergencyNumberList:ERROR:MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
    ...
    if (VOS_OK != ulRst)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_SndCcEmergencyNumberList:ERROR:Send Message ERROR!");
        return;
    }
...
)
{
    ...
    pstMsg->ulAttachAttCounter = g_GmmAttachCtrl.ucAttachAttmptCnt;             /* 置Attach attempt counter                    */
...
)
{
    ...
    {                                                                           /* 判断当前specific过程                     */
        ...
        case 0x40:                                                                  /* 当前是sevice request流程                 */
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_SndMmcGmmActionResultInd:WARNING: Current procedure error");
            return;
    }
...
)
{
    ...
    {
        /* RAU succ假流程可能带原因值NAS_MML_REG_FAIL_CAUSE_HO_SUCC */
        /* 除了NAS_MML_REG_FAIL_CAUSE_HO_SUCC，其他原因值都填为NAS_MML_REG_FAIL_CAUSE_LOCAL_NULL */
        if (NAS_MML_REG_FAIL_CAUSE_HO_SUCC != enCause)
        {
...
VOS_VOID NAS_GMM_SndSmSigConnInd(VOS_VOID)
{
    ...
    if (VOS_NULL_PTR == pstMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_SndSmSigConnInd:WARNING: Memory Alloc Fail.");
        return;
    }
    ...
    if (VOS_OK != ulRet)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_SndSmSigConnInd:WARNING: Send msg Fail.");
    }
