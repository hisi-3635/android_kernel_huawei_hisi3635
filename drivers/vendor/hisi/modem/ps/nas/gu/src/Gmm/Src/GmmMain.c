...
VOS_VOID GMM_ReportN2MOtaMsg(NAS_MSG_STRU *pNasMsg)
{
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "GMM_ReportN2MOtaMsg:NORMAL: msg type is ", pNasMsg->aucNasMsg[1]);
    ...
    switch(pNasMsg->aucNasMsg[1])
    {
        ...
        default:
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "GMM_ReportN2MOtaMsg:WARNING: invalid msg type!");
...
#endif
VOS_UINT32 NAS_GMM_SndOutsideContextData()
{
...
)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_MsgDistribute:WARNING: Receive Msg from AGENT,RABM,SM or SMS is Abnormal when GMM is in GMM_TC_ACTIVE");
        ucRst = GMM_FALSE;
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_MsgDistribute:WARNING: Receive Msg except RRMM_REL_IND,RRMM_DATA_IND is Abnormal when GMM is in GMM_TC_ACTIVE");
        ucRst = GMM_FALSE;
    }
           ...
           && (MMCGMM_DETACH_REQ == pNasMsgHeader->ulMsgName) )
    {
        ...
        {
            Gmm_MsInitNormalDetach(pstDetachReq->enDetachCause);
        }
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: GMM is in GMM_TC_ACTIVE");
                       ...
                       )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_MsgDistribute:WARNING: Receive Msg from AGENT or RRC is Abnormal when GMM is in GMM_NULL");
        ucRst = GMM_FALSE;
    }
    else if ((WUEPS_PID_TC == pNasMsgHeader->ulSenderPid)
        && (TCGMM_TEST_REQ != pNasMsgHeader->ulMsgName))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_MsgDistribute:WARNING: Receive TCGMM_TEST_REQ Msg is Abnormal when  is in GMM_NULL");
        ucRst = GMM_FALSE;
    }
    else
    {
                       ...
                       )
{
    ...
    case PS_USIM_AUTHENTICATION_CNF:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from USIM is ignored");
        break;
    }
                       ...
                       )
{
    ...
    case RRMM_INTER_RAT_HANDOVER_INFO_CNF:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from RRC is ignored");
        break;
    }
                       ...
                       )
{
    ...
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from RABM is ignored");
        break;
    }
                       ...
                       )
{
    ...
    case GMMSM_PDP_MODIFY_IND:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from SM is ignored");
        break;
    }
                       ...
                       )
{
    ...
    case PMMSMS_UNITDATA_REQ:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from SMS is ignored");
        break;
    }
                       ...
                       )
{
    ...
    case ID_LL_DATA_INFORM :
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from LLC is ignored");
        break;
    }
                       ...
                       )
{
    ...
    case TCGMM_TEST_REQ:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from TC is ignored");
        break;
    }
                       ...
                       )
{
    ...
    switch (pNasMsgHeader->ulMsgName)
    {
        ...
        default :
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_MsgDistribute:INFO: The Msg from GAS is ignored");
            break;
    }
...
)
{
    ...
    switch (pstNasMsgHeader->ulMsgName)
    {
        ...
        case MMGMM_T3211_TIMER_EXPIRED_NOTIFY:
            NAS_Gmm_RcvMmT3211ExpiredNotify(pstRcvMsg);                           /* MMGMM_CS_LOCAL_DETACH_IND接收处理 */
            break;
...
VOS_VOID Gmm_ComVariantInit(VOS_VOID)
{
    ...
    ulLength = 0;
    NV_GetLength(en_NV_Item_NAS_GMM_REL_CONN_AFTER_PDP_DEACT, &ulLength);
...
MMCGMM_DETACH_REQ_STRU* NAS_GMM_MakeDetachMsg( VOS_UINT32  ulDetachCause )
{
    ...
    {                                                                           /* 内存申请失败                             */
        PS_LOG(WUEPS_PID_MMC, VOS_NULL, PS_PRINT_ERROR, "Mmc_SndGmmDetachReq:ERROR: Memory Alloc Error for pMsg");
    ...
    pSndMsg->enDetachCause = ulDetachCause;
     ...
     && (VOS_FALSE == g_GmmGlobalCtrl.ucUserPsAttachFlag))
    {
        ...
        if (GMM_SM_PDP_CONTEXT_NOT_EXIST == (pSmPdpStatusInd->ulPdpContextStatus & 0xFFFF))
        {
             ...
             || (VOS_TRUE == gstGmmCasGlobalCtrl.ucRauCmpFlg))
            {
                ...
                ptr = NAS_GMM_MakeDetachMsg(MMA_MMC_DETACH_TYPE_GPRS);

                if (VOS_NULL_PTR == ptr)
                {
                    g_GmmGlobalCtrl.MsgHold.ulMsgHoldMsk &= ~GMM_MSG_HOLD_FOR_DETACH;
                    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvMmcDetachReq:ERROR: Allocate memory error in Gmm_RcvMmcDetachReq");
                    return;
                }
    ...
    {                                                                           /* 如果有保留的power off原语                */
        ...
        if (MMCGMM_POWER_OFF_REQ == pNasMsgHeader->ulMsgName)
        {
            ...
            {                                                                   /* DETACH成功且使用了P_TMSI_SIGNATURE       */
                ...
                Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_LOC_INFO);       /* 更新SIM卡信息                            */
            }
                        ...
                        )
{
    ...
    {                                                                           /* 错误的消息                               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: CS data is received in RRMM_DATA_IND");
        return;
    }
    if (GMM_FALSE == g_GmmGlobalCtrl.ucSigConFlg)
    {                                                                           /* 当前没有信令                             */
        ...
        {                                                                       /*3G下如果当前没有信令，直接返回。2G下信令连接标志始终有效 */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: Signalling connection is not existed");
            return;
        }
    }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: In TC_ACTIVE, other NT message than TC is omitted");
    ...
    {                                                                           /* 消息过短                                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: Message from NT is too short");
        return;
    }

    if (GMM_FALSE == GMM_ComCheckIntegrityProtection(pNasMsg->aucNasMsg, pNasMsg->ulNasMsgSize))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: Integrity Check Fail");
    }
    else
    {
        ...
        case GMM_PD_GMM:
            ...
            {
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: NT message is invalid");
                return;
            }
            ...
            case GMM_MSG_SERVICE_REJECT:
                ...
                break;
            case GMM_MSG_P_TMSI_REALLOCATION_COMMAND:
                if ((0x20 != (g_GmmGlobalCtrl.ucSpecProc & 0xF0))
                    && (0x30 != (g_GmmGlobalCtrl.ucSpecProc & 0xF0)))
                {
            ...
            case GMM_MSG_IDENTITY_REQUEST:
                ...
                break;
            case GMM_MSG_GMM_STATUS:
                if (0x30 != (g_GmmGlobalCtrl.ucSpecProc & 0xF0))
                {/* 该消息非Detach  */
            ...
            default :
                ...
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: The MsgType is Abnormal");
                break;
            }
            break;
        ...
        default :
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmDataInd:WARNING: Protocol discriminator is Error");
            break;
        }
    }
...
VOS_VOID NAS_GMM_RcvMmcRelReq_DeregInit()
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "NAS_GMM_RcvMmcRelReq_DeregInit:INFO: specific procedure ended");
...
VOS_VOID NAS_GMM_RcvMmcRelReq_RegImsiDtchInit()
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "NAS_GMM_RcvMmcRelReq_RegImsiDtchInit:INFO: specific procedure ended");
...
VOS_VOID Gmm_RcvMmcCoverageLostInd(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProcHold      = GMM_NULL_PROCEDURE;                   /* 清除保留的过程                           */
    g_GmmGlobalCtrl.ucSpecProcInCsTrans = GMM_NULL_PROCEDURE;                   /* 清除记录的CS通信中流程                   */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcCoverageLostInd:INFO: specific procedure ended");
...
VOS_VOID Gmm_RcvMmcPlmnSearchInitiated(VOS_VOID)
{
    ...
    if (GMM_NULL == g_GmmGlobalCtrl.ucState)
    {                                                                           /* 当前状态为NULL状态                       */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcPlmnSearchInitiated:WARNING: GMM state is VOS_NULL_PTR(Gmm_RcvMmcPlmnSearchInitiated)");
        return;
    }
...
)
{
    ...
    {                                                                           /* 要求ATTACH CS域                          */
        ...
        {                                                                       /* CS域已经ATTACH                           */
            ...
            if ( MMA_MMC_ATTACH_TYPE_GPRS_IMSI == pstAttachReq->enAttachType )
            {
                pstAttachReq->enAttachType  = MMC_GMM_ATTACH_TYPE_GPRS;
                ulRet                       = VOS_FALSE;
            }
...
)
{
    ...
    if ( GMM_WAIT_NULL_DETACH != g_GmmGlobalCtrl.stDetachInfo.enDetachType )
    {
          ...
          && ( NAS_MML_NET_MODE_I    == pstCampInfo->enNetworkMode) )
        {
            ...
            {
                  PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "NAS_GMM_CheckNeedBuffDetach:ERROR: Allocate memory error in Gmm_RcvMmcDetachReq");
                  return VOS_TRUE;
            }
...
VOS_VOID Gmm_ComReset(VOS_VOID)
{
    ...
    {                                                                           /* GMM当前状态为ATTACHED                    */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_ComReset:NORMAL: STATUS IS GMM_NULL");
...
VOS_VOID Gmm_DealWithBuffAfterProc(VOS_VOID)
{
    ...
    {                                                                           /* 如果有保留的SR原语                       */
        ...
        {
            Gmm_MemFree(pMsg);
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR,
...
)
{
    ...
    {                                                                           /* 不是用户模式A且网络模式I                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcCmServiceRejectInd:WARNING: It is not A+I(Gmm_RcvMmcCmServiceRejectInd)");
        return;
    }
...
)
{
    ...
    {                                                                           /* 无信令且正在建立信令连接                 */
        ...
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvMmcCmServiceInd_InProc:ERROR: Memory is not allocated");
              return;
        }
                       ...
                       )
{
    ...
    if (RRC_NAS_PS_DOMAIN != pRrEstCnf->ulCnDomainId)
    {                                                                           /* 判断是PS域信息,否                        */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmEstCnf:WARNING: It is not PS domain(Gmm_RcvRrmmEstCnf)");
        return;
    }
    if (GMM_RRC_RRMM_EST_CNF_FLG
        != (g_GmmReqCnfMng.ucCnfMask & GMM_RRC_RRMM_EST_CNF_FLG))
    {                                                                           /* 判断是否正在等该响应,否                  */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmEstCnf:WARNING: RRMM_EST_CNF is unexpected");
        return;
    }
    if (g_GmmReqCnfMng.ucRrmmEstOpid != pRrEstCnf->ulOpId)
    {                                                                           /* OP ID不相等                              */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmEstCnf:WARNING: RRMM_EST_CNF is unexpected(OPID is not same)");
        return;
    }

    if (RRC_EST_ESTING == pRrEstCnf->ulResult)
    {                                                                           /* 结果为正在建                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmEstCnf:WARNING: The result is invalid(Gmm_RcvRrmmEstCnf)");
        return;
    }
    if (RRC_EST_PRESENT == pRrEstCnf->ulResult)
    {                                                                           /* 结果为已经存在                           */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf:INFO: The result of RRMM_EST_CNF is unexpected");
    }
    ...
    {                                                                           /* 信令建立成功                             */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf:INFO: PS signatual exist");
    ...
    case GMM_REGISTERED_IMSI_DETACH_INITIATED:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmEstCnf:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
    return;
}
                               ...
                               )
{
    ...
    {                                                                           /* 有消息保留                               */
        ...
        {                                                                       /* 保留消息处理成功                         */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmEstCnf_RegInit:NORMAL: Deal Hold Msg success");
            return;
        }
    }
    ...
    {                                                                           /* Access barred                            */
        ...
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清除当前流程                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf_RegInit:INFO: specific procedure ended");
    }
    else
    {                                                                           /* 信令连接建立失败                         */
        Gmm_AttachAttemptCounter(NAS_MML_REG_FAIL_CAUSE_RR_CONN_EST_FAIL);                /* 调用attach attempt counter的处理         */
                                 ...
                                 )
{
    ...
    {                                                                           /* 有其他消息保留                           */
        if (GMM_TRUE == Gmm_DealWithBuffInProc())
        {                                                                       /* 保留消息处理成功                         */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmEstCnf_DeregInit:NORMAL: Deal Hold Msg success");
            return;
        }
    }
    ...
    {                                                                           /* 信令连接建立失败                         */
        ...
        Gmm_SndMmcSignalingStatusInd(MMC_GMM_SIGNALING_STATUS_ABSENT);
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清除当前流程                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf_DeregInit:INFO: specific procedure ended");
    }
    return;
}
                               ...
                               )
{
    ...
    {                                                                           /* 有其他消息保留                           */
        if (GMM_TRUE == Gmm_DealWithBuffInProc())
        {                                                                       /* 保留消息处理成功                         */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmEstCnf_RauInit:NORMAL: Deal Hold Msg success");
            return;
        }
    }
    ...
    {                                                                           /* Access barred                            */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf_RauInit:INFO: specific procedure ended");
    }
    else
    {                                                                           /* 信令连接建立失败                         */
        Gmm_RoutingAreaUpdateAttemptCounter(NAS_MML_REG_FAIL_CAUSE_RR_CONN_EST_FAIL);     /* 调用RAU attempt counter的处理            */
        Gmm_SndMmcSignalingStatusInd(MMC_GMM_SIGNALING_STATUS_ABSENT);
                                   ...
                                   )
{
    ...
    {                                                                           /* 有其他消息保留                           */
        if (GMM_TRUE == Gmm_DealWithBuffInProc())
        {                                                                       /* 保留消息处理成功                         */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmEstCnf_ServReqInit:NORMAL: Deal Hold Msg success");
            return;
        }
    }
    ...
    {                                                                           /* 信令连接建立失败                         */
        ...
        Gmm_SndMmcSignalingStatusInd(MMC_GMM_SIGNALING_STATUS_ABSENT);
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清除当前流程                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf_ServReqInit:INFO: specific procedure ended");
    }
                                       ...
                                       )
{
    ...
    {                                                                           /* 有其他消息保留                           */
        if (GMM_TRUE == Gmm_DealWithBuffInProc())
        {                                                                       /* 保留消息处理成功                         */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmEstCnf_RegImsiDtchInit:NORMAL: Deal Hold Msg success");
            return;
        }
    }
    ...
    {                                                                           /* 信令连接建立失败                         */
        ...
        g_GmmGlobalCtrl.ucSpecProc               = GMM_NULL_PROCEDURE;          /* 清除当前流程                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmEstCnf_RegImsiDtchInit:INFO: specific procedure ended");
    }
    return;
}
                       ...
                       )
{
    ...
    */
    ...
    if (GMM_MSG_HOLD_FOR_POWEROFF
        == (g_GmmGlobalCtrl.MsgHold.ulMsgHoldMsk & GMM_MSG_HOLD_FOR_POWEROFF))
    {                                                                           /* 如果有保留的power off原语                */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd:INFO:DEAL HOLD_POWEROFF_MSG");
        Gmm_TimerStop( GMM_TIMER_PROTECT_FOR_SIGNALING );
        g_GmmReqCnfMng.ucCnfMask &= ~GMM_RRC_RRMM_EST_CNF_FLG;
        pAddr = (VOS_VOID *)g_GmmGlobalCtrl.MsgHold.ulMsgAddrForPowerOff;       /* 读取power off原语地址                    */
        g_GmmGlobalCtrl.MsgHold.ulMsgHoldMsk &= ~GMM_MSG_HOLD_FOR_POWEROFF;     /* 清除保留标志                             */
    ...
    default:
        g_GmmGlobalCtrl.ucRelCause = RR_REL_CAUSE_RR_CONNECTION_FAILURE;
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd:INFO: The Relase Cause is default");
        break;
    ...
    if (GMM_TC_ACTIVE == g_GmmGlobalCtrl.ucState)
    {
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd:INFO: PS signatual nonexist");
        Gmm_SndMmcSignalingStatusInd(MMC_GMM_SIGNALING_STATUS_ABSENT);
    ...
    {   /* 当前有缓存的 SMS 消息,且当前过程正常结束,发起缓存的SMS呼叫 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd:INFO: Buffered SMS Request will be handled.");
    }
    else
    {
        if (!((GMM_TRUE == g_GmmServiceCtrl.ucSmsFlg)
    ...
    case GMM_DEREGISTERED_PLMN_SEARCH:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmRelInd:WARNING: g_GmmGlobalCtrl.ucState is WRong");
        Gmm_SndMmcSignalingStatusInd(MMC_GMM_SIGNALING_STATUS_ABSENT);
        break;
    }
...
VOS_VOID Gmm_RcvRrmmRelInd_DeregNmlServ(VOS_VOID)
{
    ...
    {                                                                           /* 当前流程为SIM卡拔出的detach流程          */
        ...
        Gmm_ComStaChg(GMM_DEREGISTERED_NO_IMSI);                                /* 调用状态的公共处理                       */
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清当前流程                               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd_DeregNmlServ:INFO: specific procedure ended");
    }
...
VOS_VOID Gmm_RcvRrmmRelInd_RegInit(RRMM_REL_IND_STRU *pRrRelInd)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc    = GMM_NULL_PROCEDURE;                         /* 清除正在进行的specific过程标志           */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd_RegInit:INFO: specific procedure ended");
    g_GmmGlobalCtrl.ucFollowOnFlg = GMM_FALSE;                                  /* 清除fallowon标志                         */
    NAS_MML_SetPsServiceBufferStatusFlg(VOS_FALSE);
...
VOS_VOID Gmm_RcvRrmmRelInd_DeregInit(RRMM_REL_IND_STRU *pRrRelInd)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Mm_StopRelTimer:WARNING: Stop timer unsuccessfully");
    }
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd_DeregInit:INFO: specific procedure ended");
                                   ...
                                   )
{
    ...
    {                                                                           /* 其他原因                                 */
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清除当前流程                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd_ServReqInit:INFO: specific procedure ended");
    }
...
VOS_VOID Gmm_RcvRrmmRelInd_RegImsiDtchInit(RRMM_REL_IND_STRU *pRrRelInd)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc               = GMM_NULL_PROCEDURE;              /* 将流程清空                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmRelInd_RegImsiDtchInit:INFO: specific procedure ended");
...
VOS_VOID Gmm_RcvCoverLost_RauInit()
{
    ...
    {                                                                           /* ucRauAttmptCnt大于等于5                  */
        ...
        Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_LOC_INFO);               /* 通知AGENT更新状态改变                    */
                      ...
                      )
{
    ...
    case GMM_SERVICE_REQUEST_INITIATED:
        ...
        if (GMM_SERVICE_REQUEST_DATA_CONN == g_GmmGlobalCtrl.ucSpecProc)
        {
            ...
            {
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvSmDataReq:NORMAL:Gmm Buf SM Data Req.");
    ...
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvSmDataReq:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
...
VOS_VOID Gmm_BufferSmDataReq(VOS_VOID       *pMsg)
{
    ...
    if (VOS_NULL_PTR == ptr)
    {
          PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvSmDataReq_DeregInit:WARNING: VOS_NULL_PTR pointer in Gmm_RcvSmDataReq_DeregInit");
          return;
    }
    if (4 > pGmmSmDataReq->SmMsg.ulNasMsgSize)
    {
...
)
{
    ...
    {                                                                           /* 当前有信令连接                           */
        ...
        else
        {
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvSmDataReq_RegNmlServ:NORMAL: STATUS IS GMM_SERVICE_REQUEST_INITIATED");
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvSmDataReq_RegNmlServ:INFO: SR(signaling) procedure started");
    ...
    {                                                                           /* 当前没有信令连接                         */
        ...
        case GMM_SM_RRC_EST_CAUSE_ORG_ST_CALL:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvSmDataReq_RegNmlServ():INFO: The RRC Connection Setup Cause is GMM_SM_RRC_EST_CAUSE_ORG_HP_SIGNAL");
                                  ...
                                  )
{
    ...
    {                                                                           /* 不支持GPRS                               */
        ...
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清当前流程                               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_RegInit:INFO: specific procedure ended");
                                    ...
                                    )
{
    ...
    {                                                                           /* 不支持GPRS                               */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_DeregInit:INFO: specific procedure ended");
    }
    else if (MMC_GMM_NO_FORBIDDEN != pSysInfo->ulForbiddenMask)
    {                                                                           /* 在forbidden列表中                        */
        Gmm_TimerStop(GMM_TIMER_T3321);                                         /* 停T3321                                  */
                                  ...
                                  )
{
    ...
    {                                                                           /* 不支持GPRS                               */
        ...
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清当前流程                               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_RauInit:INFO: specific procedure ended");
    }
    else if (MMC_GMM_NO_FORBIDDEN != pSysInfo->ulForbiddenMask)
    {                                                                           /* 在forbidden列表中                        */
        Gmm_TimerStop(GMM_TIMER_T3330);                                         /* 停T3330                                  */
    ...
    {                                                                           /* RA改变                                   */
        ...
        Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_LOC_INFO);               /* 更新SIM                                  */
        Gmm_RoutingAreaUpdateInitiate(GMM_UPDATING_TYPE_INVALID);               /* 进行RAU                                  */
    }
    else if (GMM_TRUE == ucDrxLengthChgFlg)
    {                                                                           /* DRX改变                                  */
                                      ...
                                      )
{
    ...
    {                                                                           /* 不支持GPRS                               */
        ...
        Gmm_ComCnfHandle();
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清当前流程                               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_ServReqInit:INFO: specific procedure ended");
        NAS_GMM_SndMmcActionResultIndWhenBarorNotSupportGprs(NAS_MML_REG_FAIL_CAUSE_SERVING_CELL_DOMAIN_NOT_SUPPORT);
                                       ...
                                       )
{
    ...
    {                                                                           /* 原来SIM无效                              */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvMmcSysInfoInd_DeregNmlServ:NORMAL: STATUS IS GMM_DEREGISTERED_NO_IMSI");
        return;
    }
    if (VOS_FALSE == NAS_MML_GetPsAttachAllowFlg())
    {
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcSysInfoInd_DeregNmlServ:WARNING: Not allow Attach");
    ...
    {                                                                           /* 不支持GPRS                               */
        ...
        {                                                                       /* 前一个小区也不支持GPRS                   */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcSysInfoInd_DeregNmlServ:WARNING: Not support GPRS and No cell available");
            return;
        }
        Gmm_TimerStop(GMM_TIMER_T3311);                                         /* 停T3311                                  */
        Gmm_TimerStop(GMM_TIMER_T3302);                                         /* 停T3302                                  */
            ...
            {                                                                   /* 更新状态是GU1                            */
                ...
                else
                {
                    ...
                    {                                                               /* 非A+I                                    */
                        ...
                        g_GmmGlobalCtrl.ucSpecProc = GMM_RAU_NORMAL;
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_RegNoCell:INFO: normal RAU procedure started");
                        ...
                        GMM_SndRabmRauInd(GMM_RABM_RAU_UNDER_NORMAL, GMM_RABM_RAU_SUCCESS);
                        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_RegNoCell:INFO: specific procedure ended");
...
VOS_VOID Gmm_RcvMmcSysInfoInd_SuspWaitSys(VOS_VOID* pRcvMsg,VOS_UINT8 ucRaiChgFlg,VOS_UINT8 ucLaiChgFlg)
{
    ...
    {                                                                           /* 原来SIM无效                              */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvMmcSysInfoInd_SuspWaitSys:NORMAL: STATUS IS GMM_DEREGISTERED_NO_IMSI");
        return;
    }
    if (VOS_FALSE == NAS_MML_GetPsAttachAllowFlg())
    {
        g_GmmGlobalCtrl.ucCvrgAreaLostFlg = GMM_FALSE;                          /* 清除出覆盖区标志                         */
        Gmm_ComStaChg(GMM_DEREGISTERED_NORMAL_SERVICE);                         /* 调用状态的公共处理                       */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcSysInfoInd_SuspWaitSys:WARNING: Not allow Attach");
            ...
            else
            {
                ...
                if (GMM_TRUE == g_GmmGlobalCtrl.ucFollowOnFlg)
                {
                    ...
                    case GMM_SERVICE_REQUEST_SIGNALLING:
                        ...
                        break;
                    default:
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd_SuspWaitSys:INFO: No Hold Procedure");
                        break;
                    }
                    g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;
                }
...
VOS_VOID NAS_GMM_RcvMmAuthenticationFailureInd(VOS_VOID)
{
    ...
    {                                                                           /* 判断当前状态                             */
        ...
        case GMM_DEREGISTERED_PLMN_SEARCH:
            ...
            g_GmmGlobalCtrl.ucSpecProc     = GMM_NULL_PROCEDURE;                    /* 清除当前流程                             */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcAuthenticationFailureInd:INFO: specific procedure ended");
            g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;                    /* 清除保留流程                             */
        ...
        default:                                                                    /* 其他情况                                 */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcAuthenticationFailureInd:WARNING: g_GmmGlobalCtrl.ucState is Error");
            break;                                                                  /* 跳出                                     */
    }
}
...
)
{
    ...
    if ((VOS_TRUE != NAS_MML_GetCsAttachAllowFlg())
     || (GMM_NET_MODE_I     != g_GmmGlobalCtrl.ucNetMod))
    {                                                                           /* 不是用户模式A且网络模式I                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvMmcCmServiceInd:NORMAL: It is not A+I(Gmm_RcvMmcCmServiceInd)");
        return;
    }
        ...
        */
        ...
        {                                                                       /* CS触发RAU                                */
             ...
             case GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM:
                 ...
                 break;
             default:
                 PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcCmServiceInd:WARNING: g_GmmGlobalCtrl.ucState is Error");
                 break;
             }
                                            ...
                                            )
{
        ...
        == (pSysInfoInd->ulMask & MMC_GMM_SYS_MSK_CSPS_INFO))
    {
        if (0 != pSysInfoInd->ulPsInfoSize)
        {
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd:INFO: MS camp on a cell that GPRS is supported");
        }
        else
        {
            g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs = GMM_NOT_SUPPORT_GPRS;  /* 设置当前小区不支持GPRS标志                */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvMmcSysInfoInd:INFO: MS camp on a cell that GPRS is not supported");
        }
    }
    else
    {
            ...
            {                                                                       /* 用户模式为A,并且已经注册                 */
                ...
                {/* 非异系统挂起过程等待小区系统消息状态 */
                    if ((GMM_FALSE == g_GmmGlobalCtrl.ucSigConFlg)
                     && (GMM_RRC_RRMM_EST_CNF_FLG == (g_GmmReqCnfMng.ucCnfMask & GMM_RRC_RRMM_EST_CNF_FLG)))
                    {
                        Gmm_RcvMmcSysInfoIndRelEstingLink();
                        ucRst = GMM_FALSE;
                        return ucRst;
                    }
                    else
                                  ...
                                  )
{
    ...
    case GMM_DEREGISTERED_NO_IMSI:
        ...
        break;
    default :
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcSysInfoInd:WARNING:g_GmmGlobalCtrl.ucState is Error");
        break;
    }
...
)
{
    ...
    {                                                                           /* A+I                                      */
        ...
        case GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcRegisterInitiation:WARNING: g_GmmGlobalCtrl.ucState is Error");
            break;
        }
    }
    else
                                              ...
                                              )
{
    ...
    {                                                                           /* 无信令且正在建立信令连接                 */
        ...
        if (VOS_NULL_PTR == ptr)
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvMmcRegisterInitiation_ServReqInit:ERROR: Memory is not allocated");
              return;
        }
...
VOS_UINT8 Gmm_ComUnrealProc(VOS_VOID)
{
    ...
    case GMM_SUSPENDED_WAIT_FOR_SYSINFO:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComUnrealProc:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
    return ucGmmAction;
}
                          ...
                          )
{
    ...
    g_GmmGlobalCtrl.ucRealProFlg = GMM_REAL_PROCEDURE;                          /* 设置真流程标志                           */
    g_GmmGlobalCtrl.ucSpecProc   = GMM_NULL_PROCEDURE;
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ComForbiddenList:INFO: specific procedure ended");
    return;
}
                                                            ...
                                                            VOS_UINT8 ucLaiChgFlg)
{
    ...
    if (GMM_NULL == g_GmmGlobalCtrl.ucState)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComNetModeChange_NotSupportGprs_Handling:WARNING: g_GmmGlobalCtrl.ucState is GMM_NULL");
        return;
    }
                                                  ...
                                                  VOS_UINT8 ucRaiChgFlg)
{
    ...
    case GMM_REGISTERED_INITIATED:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComNetModeChange_Netmode_I2II_Handling:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
                                                            ...
                                                            VOS_UINT8 ucRaiChgFlg)
{
    ...
    case GMM_REGISTERED_INITIATED:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComNetModeChange_Netmode_II2I_Handling:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
...
VOS_VOID Gmm_ComNetModeChange(VOS_VOID  *pMsg)
{
    ...
    if (VOS_NULL_PTR == pRaiTemp)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_ComNetModeChange:ERROR: alloc rai temp memory fail.");
        return;
    }
...
VOS_VOID Gmm_ComNetModeChangeGsm(VOS_VOID  *pMsg)
{
    ...
    {                                                                           /* 正在建信令                               */
        ...
        if (VOS_NULL_PTR == ptr)
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_ComNetModeChangeGsm:ERROR: Memory is not allocated");
              return;
        }
        ...
        &&(0 != (g_GmmReqCnfMng.ucCnfMask & GMM_RRC_RRMM_EST_CNF_FLG)))
    {
        ...
        if (VOS_NULL_PTR == ptr)
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_ComNetModeChange:ERROR: Memory is not allocated");
              return;
        }
        Gmm_MemCpy(ptr, pMsg, sizeof(MMCGMM_GSM_SYS_INFO_IND_ST));
    ...
    if (GMM_NOT_SUPPORT_GPRS == g_GmmGlobalCtrl.SysInfo.ucNotSupportGprs)
    {
        ...
        if (GMM_NULL == g_GmmGlobalCtrl.ucState)
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComNetModeChangeGsm:WARNING: g_GmmGlobalCtrl.ucState is GMM_NULL");
            Gmm_MemFree(pRaiTemp);
            return;
        }
        if ((0x10 == (g_GmmGlobalCtrl.ucState & 0xF0))
...
)
{
    ...
    case NAS_MML_MS_MODE_NULL:
        ...
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcGmmModeChangeReq:WARNING: MMCGMM_MODE_CHANGE_REQ is invalid");
        }
        break;
    ...
    case NAS_MML_MS_MODE_CS_ONLY:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvMmcGmmModeChangeReq:WARNING: The MsMode is Abnormal");
        break;
    }
    return;
}
                                   ...
                                   )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_GmmStatusMsgMake:ERROR: Alloc mem fail.");
        return pGmmStatus;
    }
...
)
{
    ...
    {                                                                           /* TC激活                                   */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvTcTestReq:NORMAL: STATUS IS GMM_TC_ACTIVE");
    ...
    {                                                                           /* TC去激活                                 */
        ...
        PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvTcTestReq:NORMAL: STATUS IS ",g_GmmGlobalCtrl.ucState);
                      ...
                      )
{
    ...
    if (GMM_TC_ACTIVE != g_GmmGlobalCtrl.ucState)
    {                                                                           /* 当前状态不是GMM_TC_ACTIVE                */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvTcDataReq:WARNING: TCGMM_DATA_REQ is unexpected");
        return;
    }
                                         ...
                                         )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvGmmStatusMsg:WARNING: The length of GMM STATUS is invalid");
...
VOS_UINT8 GMM_GetSignalingStatus(VOS_VOID)
{
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO,
 ...
 *  HISTORY  :
     1.  欧阳飞   2009.06.11  新版作成
 ************************************************************************/
VOS_VOID Gmm_FillNasMmInfo_NetMod(NAS_OM_MM_CONFIRM_STRU *pMsg)
{
    if (GMM_NET_MODE_I == g_GmmGlobalCtrl.SysInfo.ucNetMod)
    {
        pMsg->ucNetMode = NET_OPERATE_MODE_1;
    }
    else if (GMM_NET_MODE_II == g_GmmGlobalCtrl.SysInfo.ucNetMod)
    {
        pMsg->ucNetMode = NET_OPERATE_MODE_2;
    }
    else if (GMM_NET_MODE_III == g_GmmGlobalCtrl.SysInfo.ucNetMod)
    {
        pMsg->ucNetMode = NET_OPERATE_MODE_3;
    }
    else
    {
        pMsg->ucNetMode = NET_OPERATE_MODE_BUTT;
    }
...
{
    pstMsg->ucGmmSubState = GMM_SUB_STATE_BUTT;

    switch (g_GmmGlobalCtrl.ucState)
    {
        case GMM_NULL:
            pstMsg->ucGmmState = STATE_GMM_NULL;
            break;
        case GMM_REGISTERED_INITIATED:
            pstMsg->ucGmmState = REGISTERED_INITIATED;
            break;
        case GMM_DEREGISTERED_INITIATED:
            pstMsg->ucGmmState = DEREGISTERED_INITIATED;
            break;
        case GMM_ROUTING_AREA_UPDATING_INITIATED:
            pstMsg->ucGmmState = ROUTING_AREA_UPDATING_INITIATED;
            break;
        case GMM_SERVICE_REQUEST_INITIATED:
            pstMsg->ucGmmState = SERVICE_REQUEST_INITIATED;
            break;
        case GMM_TC_ACTIVE:
            pstMsg->ucGmmState = TC_ACTIVE;
            break;
        case GMM_GPRS_SUSPENSION:
            pstMsg->ucGmmState = GPRS_SUSPENSION;
            break;
        case GMM_DEREGISTERED_NORMAL_SERVICE:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_NORMAL_SERVICE;
            break;
        case GMM_DEREGISTERED_LIMITED_SERVICE:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_LIMITED_SERVICE;
            break;
        case GMM_DEREGISTERED_ATTACH_NEEDED:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_ATTACH_NEEDED;
            break;
        case GMM_DEREGISTERED_ATTEMPTING_TO_ATTACH:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_ATTEMPTING_TO_ATTACH;
            break;
        case GMM_DEREGISTERED_NO_CELL_AVAILABLE:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_NO_CELL_AVAILABLE;
            break;
        case GMM_DEREGISTERED_PLMN_SEARCH:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_PLMN_SEARCH;
            break;
        case GMM_DEREGISTERED_NO_IMSI:
            pstMsg->ucGmmState = DEREGISTERED;
            pstMsg->ucGmmSubState = DEREGISTERED_NO_IMSI;
            break;
        case GMM_REGISTERED_NORMAL_SERVICE:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_NORMAL_SERVICE;
            break;
        case GMM_REGISTERED_LIMITED_SERVICE:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_LIMITED_SERVICE;
            break;
        case GMM_REGISTERED_UPDATE_NEEDED:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_UPDATE_NEEDED;
            break;
        case GMM_REGISTERED_ATTEMPTING_TO_UPDATE:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_ATTEMPTING_TO_UPDATE;
            break;
        case GMM_REGISTERED_NO_CELL_AVAILABLE:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_NO_CELL_AVAILABLE;
            break;
        case GMM_REGISTERED_PLMN_SEARCH:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_PLMN_SEARCH;
            break;
        case GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_ATTEMPTING_TO_UPDATE_MM;
            break;
        case GMM_REGISTERED_IMSI_DETACH_INITIATED:
            pstMsg->ucGmmState = REGISTERED;
            pstMsg->ucGmmSubState = REGISTERED_IMSI_DETACH_INITIATED;
            break;
        case GMM_SUSPENDED_NORMAL_SERVICE:
            pstMsg->ucGmmState = SUSPENDED_NORMAL_SERVICE;
            break;
        case GMM_SUSPENDED_GPRS_SUSPENSION:
            pstMsg->ucGmmState = SUSPENDED_GPRS_SUSPENSION;
            break;
        case GMM_SUSPENDED_WAIT_FOR_SYSINFO:
            pstMsg->ucGmmState = SUSPENDED_WAIT_FOR_SYSINFO;
            break;
        default:
            pstMsg->ucGmmState = GMM_STATE_BUTT;
 ...
 *  HISTORY  :
     1.  欧阳飞   2009.06.11  新版作成
 ************************************************************************/
VOS_VOID Gmm_FillNasMmInfo_ucUpdateSta(NAS_OM_MM_CONFIRM_STRU *pMsg)
{
    switch (NAS_MML_GetPsUpdateStatus())
    {
    case NAS_MML_ROUTING_UPDATE_STATUS_UPDATED:
        pMsg->ucGmmUpdateStatus = UPDATE_STATUS_GU1;
        break;
    case NAS_MML_ROUTING_UPDATE_STATUS_NOT_UPDATED:
        pMsg->ucGmmUpdateStatus = UPDATE_STATUS_GU2;
        break;
    case NAS_MML_ROUTING_UPDATE_STATUS_PLMN_NOT_ALLOWED:
    case NAS_MML_ROUTING_UPDATE_STATUS_ROUTING_AREA_NOT_ALLOWED:
        pMsg->ucGmmUpdateStatus = UPDATE_STATUS_GU3;
        break;
    default:
        pMsg->ucGmmUpdateStatus = GMM_UPDATE_STATUS_BUTT;
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING,
...
VOS_VOID Gmm_Com_ServiceStatus_Handle(VOS_VOID)
{
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Com_ServiceStatus_Handle:INFO: g_GmmGlobalCtrl.ucState is :", (VOS_INT32)g_GmmGlobalCtrl.ucState);
...
NAS_MM_COM_SERVICE_STATUS_ENUM_UINT8 Gmm_ComServiceSts(VOS_VOID)
{
    ...
    case GMM_REGISTERED_ATTEMPTING_TO_UPDATE:
        ...
        {
            PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComServiceSts:WARNING: Unexpected g_GmmGlobalCtrl.ucState is :", (VOS_INT32)g_GmmGlobalCtrl.ucState);
        }
        break;
    default:
        PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ComServiceSts:WARNING: Unexpected g_GmmGlobalCtrl.ucState is :", (VOS_INT32)g_GmmGlobalCtrl.ucState);
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ComServiceSts:INFO: g_GmmGlobalCtrl.ucState is :", (VOS_INT32)g_GmmGlobalCtrl.ucState);
...
)
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "NAS_GMM_ProcSmDataReq_RAUInit:NORMAL:Gmm receive SM Data Req.");
...
)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_SaveWasSysInfo:WARNING: Mem alloc fail.");
        return;
    }
