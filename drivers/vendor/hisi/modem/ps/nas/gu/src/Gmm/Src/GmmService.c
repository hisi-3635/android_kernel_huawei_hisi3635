 ...
 */
    ...
    case GMM_RABM_RRC_EST_CAUSE_ORG_BG_CALL:
        ...
        break;
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRabmReestablishReq:WARNING: RRC Connection Setup Cause is Abnormal");
        return;
    }
    ...
    case GMM_REGISTERED_IMSI_DETACH_INITIATED:
        ...
        if (VOS_NULL_PTR == ptr)
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvRabmReestablishReq:ERROR: Memory is not allocated");
              return;
        }
    ...
    case GMM_REGISTERED_UPDATE_NEEDED:
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRabmReestablishReq:NORMAL: STATUS IS GMM_SERVICE_REQUEST_INITIATED");
        ...
        {                                                                       /* 无信令                                   */
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRabmReestablishReq:INFO: SR(data) procedure started");
    ...
    default:
        /* 其他状态回复失败消息 */
        Gmm_SndRabmReestablishCnf(GMM_RABM_SERVICEREQ_FAILURE);                 /* 发送GMMRABM_REESTABLISH_CNF(fail)        */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRabmReestablishReq:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
...
VOS_VOID Gmm_RcvRrmmSecurityInd(VOS_VOID *pMsg)
{
    ...
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmSecurityInd:WARNING: g_GmmGlobalCtrl.ucState is Error");
        break;
    }
}
                                        ...
                                        )
{
    ...
    {                                                                           /* ulRptMode=一个SMC流程结束                */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmSecurityInd_ServReqInit:INFO: specific procedure ended");
                             ...
                             )
{
    ...
    {                                                                           /* 空中接口长度非法                         */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvServiceAcceptMsg:WARNING: Length of SERVICE ACCEPT is invalid");
    ...
    case GMM_SERVICE_REQUEST_INITIATED:
        ...
        g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                        /* 清当前进行的specific流程                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvServiceAcceptMsg:INFO: specific procedure ended");
        if (GMM_TIMER_T3311_FLG
            == (g_GmmTimerMng.ulTimerSusMask & GMM_TIMER_T3311_FLG))
        {                                                                       /* 存在被挂起的T3311                        */
            Gmm_TimerResume(GMM_TIMER_T3311);                                   /* 恢复T3311                                */
    ...
    default:
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvServiceAcceptMsg:WARNING: SERVICE ACCEPT is unexpected");
                             ...
                             )
{
    ...
    {                                                                           /* 空中接口长度非法                         */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvServiceRejectMsg:WARNING: Length of SERVICE REJECT is invalid");
        pGmmStatus = Gmm_GmmStatusMsgMake(NAS_MML_REG_FAIL_CAUSE_INVALID_MANDATORY_INF);
        Gmm_SndRrmmDataReq(RRC_NAS_MSG_PRIORTY_HIGH , pGmmStatus);
        return;
    }
    ...
    {                                                                           /* GMM状态= GMM-SERVICE-REQUEST-INITIATED   */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvServiceRejectMsg:WARNING: SERVICE REJECT is unexpected");
                                ...
                                )
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue3:INFO: SERVICE REJECT is unexpected");
...
VOS_VOID Gmm_ServiceReqRejectCasue7(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue7:INFO: specific procedure ended");
    g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;                        /* 清保留流程                               */
...
VOS_VOID Gmm_ServiceReqRejectCasue11(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue11:INFO: specific procedure ended");
    g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;                        /* 清保留流程                               */
...
VOS_VOID Gmm_ServiceReqRejectCasue12(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue12:INFO: specific procedure ended");
    g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;                        /* 清保留流程                               */
                             ...
                             )
{
    ...
    Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_LOC_INFO);                   /* 更新USIM中的PS_LOC_INFO                  */
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue13:INFO: specific procedure ended");
    g_GmmGlobalCtrl.ucSpecProcHold = GMM_NULL_PROCEDURE;                        /* 清保留流程                               */
...
VOS_VOID Gmm_ServiceReqRejectCasue40(VOS_VOID)
{
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectCasue40:INFO: specific procedure ended");
                                       ...
                                       )
{
    ...
    g_GmmGlobalCtrl.ucSpecProc = GMM_NULL_PROCEDURE;                            /* 清当前流程                               */
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_ServiceReqRejectTheOtherCause:INFO: specific procedure ended");
    if (GMM_TIMER_T3311_FLG
        == (g_GmmTimerMng.ulTimerSusMask & GMM_TIMER_T3311_FLG))
    {                                                                           /* 存在被挂起的T3311                        */
        Gmm_TimerResume(GMM_TIMER_T3311);                                       /* 恢复T3311                                */
...
NAS_MSG_STRU *Gmm_ServiceRequestMsgMake()
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ServiceRequestMsgMake:WARNING: Alloc memory fail.");
        return pNasMsg;
    }
    ...
    NAS_GMM_ConvertPdpCtxStatusToNetworkPdpCtxStatusForSingalServiceReq(pstPsBearerCtx, &ulPdpCtxStatus);
...
)
{
    ...
    if (VOS_NULL_PTR == pNasMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_ServiceRequestMsgMake_ForData:WARNING: Alloc memory fail.");
        return pNasMsg;
    }
                           ...
                           )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvSmsUnitdataReq:WARNING: PS signalling connection is invalid");
...
)
{
    ...
    else
    {
        ...
        if (VOS_NULL_PTR == ptr)
        {
              PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvSmsEstReq:ERROR: Memory is not allocated");
              return;
        }
    ...
    else
    {
        ...
        case GMM_REGISTERED_ATTEMPTING_TO_UPDATE_MM:
          ...
          && (gstGmmCasGlobalCtrl.ucLastDataSender != NAS_MML_NET_RAT_TYPE_LTE)
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvSmsEstReq:NORMAL: STATUS IS GMM_SERVICE_REQUEST_INITIATED");

            g_MmSubLyrShare.GmmShare.ucDeatchEnableFlg = GMM_DETACH_ABLE;

            g_GmmGlobalCtrl.ucSpecProc = GMM_SERVICE_REQUEST_SIGNALLING;        /* 存储当前的流程                           */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvSmsEstReq:INFO: SR(signaling) procedure started");
        ...
        default:
            Gmm_SndSmsErrorInd(GMM_SMS_SPEC_PROC_ONGOING);
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvSmsEstReq:WARNING: Receive SMS Request in a not suitable state");
            break;
        }
    }
    return;
...
VOS_VOID NAS_GMM_ChangePsSerRejCauseAvoidInvalidSim(VOS_UINT8 *pucRcvMsg)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_ChangeDetachCauseAvoidInvalidSim: The sim is Test card");
        return;
    }
