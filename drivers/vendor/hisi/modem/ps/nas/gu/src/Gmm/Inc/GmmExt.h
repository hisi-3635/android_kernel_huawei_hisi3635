...
extern VOS_VOID  Gmm_AttachRauAcceptCause16(VOS_VOID);
extern VOS_VOID  Gmm_AttachRauAcceptCause2(VOS_VOID);
...
extern TAF_PH_RAT_TYPE_ENUM_UINT8 NAS_GMM_ConvertGmmRatTypeToStkRatType (
...
extern VOS_UINT32 NAS_GMM_IsFollowOnPend(VOS_VOID);
...
VOS_UINT32 NAS_GMM_RcvMmcGmmDetachReqMsg_GmmRegisteredInitiated(
    VOS_VOID                           *pMsg
);

VOS_UINT32 NAS_GMM_RcvMmcGmmDetachReqMsg_GmmServiceReqInitiated(
    VOS_VOID                           *pMsg
);
