...
)
{
    ...
    if (VOS_TRUE == NAS_USIMMAPI_IsTestCard())
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ChangeMmAbortCauseAvoidInvalidSim: The sim is Test card");
        return;
    }

    if (3 > usMsgSize)
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ChangeMmAbortCauseAvoidInvalidSim:WARNING: RCV MM ABORT MSG WITH ERROR SIZE!");
        return;
    }
...
)
{
    ...
    if (VOS_TRUE == NAS_USIMMAPI_IsTestCard())
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ChangeCmSerRejCauseAvoidInvalidSim: The sim is Test card");
        return;
    }

    if (3 > usMsgSize)
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ChangeCmSerRejCauseAvoidInvalidSim:WARNING: RCV CM SERVICE REJECT MSG WITH ERROR SIZE!");
        return;
    }
