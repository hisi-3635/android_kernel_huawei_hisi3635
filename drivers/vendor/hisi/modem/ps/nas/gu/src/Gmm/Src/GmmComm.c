                          ...
                          )
{
    ...
    case GMM_REGISTERED_UPDATE_NEEDED:
       ...
       break;
    default:
       PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd:WARNING: g_GmmGlobalCtrl.ucState is Error");
       break;
    }
...
VOS_VOID Gmm_Attach_Prepare(VOS_VOID)
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Attach_Prepare:INFO: specific procedure ended");
                                    ...
                                    )
{
    ...
    {                                                                           /* 寻呼的类型为IMSI                         */
        ...
        {                                                                       /* 无信令且正在建立信令连接                 */
            ...
            {
                  PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvRrmmPagingInd_DeregInit:ERROR: allocate memory error");
                  return;
            }
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd_DeregInit:WARNING: NOT RRC_IMSI_GSM_MAP");
    }
                                  ...
                                  )
{
    ...
    {                                                                           /* 寻呼的类型为IMSI                         */
        ...
        {                                                                       /* 无信令且正在建立信令连接                 */
            ...
            if (VOS_NULL_PTR == pMsg)
            {
                  PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvRrmmPagingInd_RauInit:ERROR: Allocate memory error");
                  return;
            }
            Gmm_MemCpy(pMsg, ptr, sizeof(RRMM_PAGING_IND_STRU));
            g_GmmGlobalCtrl.MsgHold.ulMsgAddrForPaging = (VOS_UINT32)pMsg;            /* 保留RRMM_PAGING _IND首地址              */
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd_RauInit:WARNING: NOT RRC_IMSI_GSM_MAP");
    }
                                     ...
                                     )
{
    ...
    {                                                                           /* 寻呼的类型为IMSI(RRC_IMSI_DS41,RRC不支持 */
        ...
        {                                                                       /* 无信令且正在建立信令连接                 */
            ...
            if (VOS_NULL_PTR == pMsg)
            {
                  PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_RcvRrmmPagingInd_ServReqInit:ERROR: Allocate memory error");
                  return;
            }
            Gmm_MemCpy(pMsg, ptr, sizeof(RRMM_PAGING_IND_STRU));
            g_GmmGlobalCtrl.MsgHold.ulMsgAddrForPaging = (VOS_UINT32)pMsg;           /* 保留RRMM_PAGING _IND首地址               */
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd_ServReqInit:WARNING: NOT RRC_IMSI_GSM_MAP");
    }
                                     ...
                                     )
{
    ...
    {                                                                           /* 寻呼的类型为TMSI/P_TMSI                  */
        ...
        {                                                                       /* 无信令                                   */
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvRrmmPagingInd_RegNmlServ:INFO: Service request(paging response) procedure started");
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_RcvRrmmPagingInd_RegNmlServ:NORMAL: STATUS IS GMM_SERVICE_REQUEST_INITIATED");
            ...
            case RRC_PAGE_CAUSE_TERMINAT_LOW_PRIORITY_SIGNAL:
                ...
                break;
            default:
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd_RegNmlServ:WARNING: RRC establish Cause is UNKNOWN");
        ...
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvRrmmPagingInd_RegNmlServ:WARNING: STATUS IS GMM_SERVICE_REQUEST_INITIATED");
        }
                                       ...
                                       )
{
    ...
    NAS_GMM_LogAuthInfo(ptr->ucOpId, g_GmmAuthenCtrl.ucOpId);

    /* 当前不在等待此消息,丢弃 */
    if (ptr->ucOpId != g_GmmAuthenCtrl.ucOpId)
    {
        return;
    }
    ...
    if (GMM_AGENT_USIM_AUTHENTICATION_CNF_FLG
        != (g_GmmReqCnfMng.ucCnfMask & GMM_AGENT_USIM_AUTHENTICATION_CNF_FLG))
    {                                                                           /* 不等待该原语                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAgentUsimAuthenticationCnf:WARNING: USIM_Authentication_cnf is not expected");
        return;
    }
                                        ...
                                        )
{
    ...
    {                                                                           /* 非REGISTERED状态                         */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiReallocationCommandMsg:WARNING: P-TMSI reallocation is not expected");
    ...
    {                                                                           /* 如果空中接口消息的长度非法               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiReallocationCommandMsg:WARNING: The length of P-TMSI REALLOCATION is invalid");
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiReallocationCommandMsg:WARNING: The check result of P-TMSI REALLOCATION is invalid");
    ...
    Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_LOC_INFO);                   /* 更新USIM中的P-TMSI信息                   */
                                                           ...
                                                           VOS_UINT8 *pucAutnFlag)
{
    ...
    if (VOS_NULL == pMsg)
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Auth_Request_Option_Ie_Check:ERROR: Null Pointer");
        return GMM_FAILURE;
    }
                                      ...
                                      )
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRequestMsg_ForceToStandby:WARNING: AUTHENTICATION AND CIPHER REQUEST is semantically incorrect");
        gstGmmCasGlobalCtrl.ucFtsFlg = GMM_FALSE;
    }
                                                ...
                                                )
{
    ...
    {                                                                           /* 如果空中接口消息的长度过短               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRequestMsg:WARNING: The length of AUTHENTICATION AND CIPHER REQUEST is invalid");
        pGmmStatus = Gmm_GmmStatusMsgMake(NAS_MML_REG_FAIL_CAUSE_INVALID_MANDATORY_INF);
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRequestMsg:WARNING: The check result of P-TMSI REALLOCATION is invalid AUTHENTICATION AND CIPHER REQUEST is not expected");
        return GMM_FAILURE;
    }
...
)
{
    ...
    else
    {
        ...
        {
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRequestMsg:WARNING: cksn in AUTHENTICATION AND CIPHER REQUEST is expected");
            pGmmStatus = Gmm_GmmStatusMsgMake(
                                     ...
                                     )
{
    ...
    {                                                                           /* 如果空中接口消息的长度非法               */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRejectMsg:WARNING: The length of AUTHENTICATION AND CIPHER REJECT is invalid");
        pGmmStatus = Gmm_GmmStatusMsgMake(NAS_MML_REG_FAIL_CAUSE_INVALID_MANDATORY_INF);
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_RcvAuthenAndCipherRejectMsg:INFO: specific procedure ended");
                               ...
                               )
{
    ...
    {                                                                           /* 如果空中接口消息长度过短                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvIdentityRequestMsg:WARNING: Invalid mandatory information");
        pGmmStatus = Gmm_GmmStatusMsgMake(NAS_MML_REG_FAIL_CAUSE_INVALID_MANDATORY_INF);
    ...
    if ((GMM_STATUS_DETACHED == g_MmSubLyrShare.GmmShare.ucAttachSta)
        && (GMM_REGISTERED_INITIATED != g_GmmGlobalCtrl.ucState))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvIdentityRequestMsg:WARNING: IDENTITY REQUEST is unexpected");
        return;
    }

    if ( 0 != (pMsg->aucNasMsg[2] & 0x08))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvIdentityRequestMsg:WARNING: The length of IDENTITY REQUEST is invalid");
        pGmmStatus =
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvIdentityRequestMsg:WARNING: Wrong information of [Force to standby]");
        gstGmmCasGlobalCtrl.ucFtsFlg = GMM_FALSE;
    }
                                ...
                                )
{
    ...
    if (5 != *(pucMsgTemp++))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiRelocCmdIEChk:WARNING: The length of P-TMSI REALLOCATION is invalid");
        return GMM_FALSE;
    }
    if (GMM_MOBILE_ID_TMSI_PTMSI != ((*pucMsgTemp++) & 0x07))
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiRelocCmdIEChk:WARNING: MS ID in P-TMSI REALLOCATION is not P-TMSI");
        return GMM_FALSE;
    }
    ...
    {                                                                           /* force to standby                         */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvPtmsiRelocCmdIEChk:WARNING: IE\" Force To Standby\" of P-TMSI REALLOCATION is invalid");
        gstGmmCasGlobalCtrl.ucFtsFlg = GMM_FALSE;
    }
...
VOS_UINT32  GMM_GetSecurityInfo(MM_CSPS_INFO_ST *pPsInfo)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO,
...
VOS_VOID GMM_GetTlliInfo(VOS_UINT32 *pulNewTlli, VOS_UINT32 *pulOldTlli)
{
    ...
    {
        *pulNewTlli = gstGmmCasGlobalCtrl.ulTLLI;
        *pulOldTlli = gstGmmCasGlobalCtrl.ulOldTLLI;
    }
    else
    {
        *pulNewTlli = 0xffffffff;
...
)
{
    ...
    NV_GetLength(en_NV_Item_EquivalentPlmn, &ulLength);
...
)
{
    ...
    OM_TraceMsgHook(pstPsRegContainDrxInfo);
...
VOS_VOID NAS_GMM_ConvertPdpCtxStatusToNetworkPdpCtxStatusForSingalServiceReq(
    NAS_MML_PS_BEARER_CONTEXT_STRU     *pstPsBearerCtx,
    VOS_UINT32                         *pulPdpCtxStatus
)
{
