...
VOS_VOID Mm_Cell_S3_E13(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
        ...
        else if (GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType)
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S3_E13:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
            ...
            Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                             MM_CKSN_INVALID);
            Mm_SndAgentUsimUpdateFileReq(MM_READ_LOCA_INFO_FILE_ID);            /* 更新SIM卡更新状态                        */

            if (NAS_MML_SIM_TYPE_SIM == NAS_MML_GetSimType())
            {
                Mm_SndAgentUsimUpdateFileReq(MM_READ_KC_FILE_ID);               /* 更新SIM卡更新状态                        */
            }
            else
            {
    ...
    {                                                                           /* 如果为非A+I模式                          */
        ...
        else if (GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType)
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E13:NORMAL: STATUS is MM_IDLE_ATTEMPTING_TO_UPDATE");
            Mm_ComProcCauseClear();
        }
        else
        {
...
VOS_VOID Mm_Cell_S3_E17(VOS_VOID *pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E17:NORMAL: STATUS is  LOCATION_UPDATING_PENDING");
}
...
VOS_VOID Mm_Cell_S4_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
        ...
        {
            NAS_MM_SetLikeBFlg();
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S4_E5:INFO: MmLikeB is MM_TRUE");
...
VOS_VOID Mm_Cell_S5_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
        ...
        {                                                                       /* RAC为0的场合                             */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S5_E5:INFO: MmLikeB is MM_TRUE");
...
VOS_VOID Mm_Cell_S6_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S6_E5:INFO: MmLikeB is MM_TRUE");
            ...
            {                                                               /* 如果LAI不变,更新状态为U1                 */
                ...
                else
                {
                    ...
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S6_E5:INFO: MmServiceState is MM_NORMAL_SERVICE");
                    NAS_MM_SndMmcCsRegResultInd(MM_MMC_LU_PROC_FALSE,
                                                MM_MMC_LU_RESULT_SUCCESS,
                    ...
                    Mm_ComSetMmState(MM_IDLE_NORMAL_SERVICE);
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S6_E5:NORMAL: STATUS is  MM_IDLE_NORMAL_SERVICE");
                    NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
                }
            }
            else
...
VOS_VOID Mm_Cell_S9_E13(VOS_VOID *pMsg)
{
    ...
    if (GMMMM_NET_DETACH_REATTACH == pstNetWkDetachInd->enDetachType)
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E13:INFO: MmLikeB is MM_TRUE");
    }
    else if (GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType)
    {
        Mm_ComSaveProcAndCauseVal(MM_NET_DETACH_PROC,
    ...
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E13:INFO: MmServiceState is MM_NO_IMSI");
                ...
                RcvXXEstReq.ulCallType))
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E14:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            }
            break;
    ...
    {                                                                           /* 结果为失败的场合                         */
        ...
        {                                                                       /* 如果类型不为空的场合                     */
            ...
            case NAS_MML_REG_FAIL_CAUSE_ILLEGAL_ME:
                ...
                g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;               /* 设置服务状态                             */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E14:INFO: MmServiceState is MM_NO_IMSI");
            ...
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
                g_MmGlobalInfo.ucLikeB = MM_TRUE;                               /* 类似于B模式的全局量                      */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E14:INFO: MmLikeB is MM_TRUE");
                break;
            case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_ROAM_NOT_ALLOW:
...
VOS_VOID Mm_Cell_S11_E9(VOS_VOID *pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E9:NORMAL: STATUS is IMSI_DETACH_PENDING");
}
...
VOS_VOID Mm_Cell_S11_E11(VOS_VOID *pMsg)
{
    ...
    g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                         /* 记录前状态                               */
    Mm_ComSetMmState(IMSI_DETACH_PENDING);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E11:NORMAL: STATUS is IMSI_DETACH_PENDING");
}
...
VOS_VOID Mm_Cell_S11_E13(VOS_VOID *pMsg)
{
    ...
    if ( GMMMM_NET_DETACH_REATTACH == pstNetWkDetachInd->enDetachType )
    {
        ...
        g_MmGlobalInfo.ucLikeB = MM_TRUE;
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S11_E13:INFO: MmLikeB is MM_TRUE");
    }
    else if ( GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType )
    {
        Mm_TimerStop(MM_TIMER_PROTECT_AGENT);
    ...
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            Mm_ComSaveProcAndCauseVal(MM_NET_DETACH_PROC,
                                      (VOS_UINT8)pstNetWkDetachInd->ulDetachCause);   /* 记录流程和原因值                         */
            g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                       /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S11_E13:INFO: MmServiceState is MM_NO_IMSI");
            Mm_ComToNoImsiHandle();                                             /* 调用删除IMSI的公共处理                   */
            break;
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW:
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
...
VOS_VOID Mm_Cell_S11_E14(VOS_VOID* pMsg)
{
    ...
    {                                                                           /* 结果为失败的场合                         */
        ...
        case GMMMM_ACTION_SR:                                                  /* 类型为SR的场合                           */
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S11_E14:WARNING: ulGmmActionType Abnormal");
            break;
        }
        if ( MM_NULL_PROC != ucActionType )
        {                                                                       /* 如果类型为空的场合                       */
            ...
            case NAS_MML_REG_FAIL_CAUSE_ILLEGAL_ME:
                ...
                Mm_ComSaveProcAndCauseVal(ucActionType,
                                  (VOS_UINT8)pstGmmActionRstInd->enCause);        /* 记录流程和原因值                         */
                g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;               /* 设置服务状态                             */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S11_E14:INFO: MmServiceState is MM_NO_IMSI");
                Mm_ComToNoImsiHandle();                                     /* 调用删除IMSI的公共处理                   */
                Mm_SndRrRelReq(RRC_CELL_UNBARRED);
                break;
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
                g_MmGlobalInfo.ucLikeB = MM_TRUE;                               /* 类似于B模式的全局量                      */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S11_E14:INFO: MmLikeB is MM_TRUE");
                break;
            case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_ROAM_NOT_ALLOW:
...
VOS_VOID Mm_Cell_S11_E16(VOS_VOID *pMsg)
{
    ...
    g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                               /* 设置服务状态                             */
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S11_E16:INFO: MmServiceState is MM_NO_IMSI");
    Mm_ComToNoImsiHandle();                                                     /* 调用删除IMSI的公共处理                   */
}
VOS_VOID Mm_Cell_S12_E13(VOS_VOID *pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S12_E13:INFO: MmServiceState is MM_NET_DETACH_PROC");
    if ( GMMMM_NET_DETACH_REATTACH == pstNetWkDetachInd->enDetachType )
    {
        NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
        g_MmGlobalInfo.ucLikeB = MM_TRUE;
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S12_E13:INFO: MmLikeB is MM_TRUE");
    }
    else if ( GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType )
    {
        Mm_TimerStop(MM_TIMER_T3230);                                           /* 停止T3230                                */
        ...
        Mm_ComSaveProcAndCauseVal(MM_NET_DETACH_PROC,
                                                    NAS_MML_REG_FAIL_CAUSE_NTDTH_IMSI);   /* 记录流程和原因值                         */
        g_MmGlobalInfo.ucMmServiceState = MM_ATTEMPTING_TO_UPDATE;              /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S12_E13:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
...
VOS_VOID Mm_Cell_S12_E14(VOS_VOID* pMsg)
{
    ...
    {                                                                           /* 结果为失败的场合                         */
        ...
        case GMMMM_ACTION_SR:                                                  /* 类型为SR的场合                           */
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S12_E14:WARNING: ulGmmActionType Abnormal");
            break;
        }
        ...
        if (MM_NULL_PROC != ucActionType)
        {
            ...
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
                g_MmGlobalInfo.ucLikeB = MM_TRUE;                               /* 类似于B模式的全局量                      */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S12_E14:INFO: MmLikeB is MM_TRUE");
                break;
            case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
                if ( ( MM_GMM_SR_PROC == ucActionType ) ||
                    ( ( MM_GMM_ATTACH_PROC == ucActionType ) &&
...
VOS_VOID Mm_Cell_S17_E5(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 如果为A+I,且不是类似B或A+II处理的场合    */
         ...
         || (MMCMM_FORBIDDEN_PLMN_FOR_GPRS == g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E5:INFO: MmLikeB is MM_TRUE");

            if (VOS_TRUE == NAS_MML_IsCampLaiInfoChanged())
            {                                                               /* LAI变化的场合                            */
                Mm_ComSetMmState(g_MmGlobalInfo.ucPreState);
                PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E5:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
                g_MmGlobalInfo.LuInfo.ucLuType = MM_IE_LUT_NORMAL_LU;       /* 设置LU类型                               */
                Mm_ComLuOnly();                                             /* LU REQ                                   */
            }
        }
...
VOS_VOID Mm_Cell_S17_E7(VOS_VOID *pMsg)
{
                        ...
                        pCombinedAttatchAccpt->enAttachResult )
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E7:INFO: MmLikeB is MM_FALSE");
        Mm_TimerStop( MM_TIMER_T3212 );                                         /* 停T3212                                  */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E7:INFO: MmServiceState is MM_NORMAL_SERVICE");
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E7:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
    }
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_IMSI_UNKNOWN_IN_HLR:
            ...
            g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                       /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E7:INFO: MmServiceState is MM_NO_IMSI");
            Mm_ComToNoImsiHandle();                                             /* 调用进NO IMSI的公共处理                  */
            Mm_ComSetMmState(MM_IDLE_NO_IMSI);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E7:NORMAL: STATUS is MM_IDLE_NO_IMSI");
            break;
        ...
        case NAS_MML_REG_FAIL_CAUSE_PROCEDURE_CONGESTION:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S17_E7:WARNING: Cause Abnormal");
...
VOS_VOID Mm_Cell_S17_E8(VOS_VOID *pMsg)
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E8:INFO: MmServiceState is MM_NO_IMSI");
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E8:NORMAL: STATUS is MM_IDLE_NO_IMSI");

        break;
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW:
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
        g_MmGlobalInfo.ucLikeB = MM_TRUE;                                       /* 设置类似于B模式的全局量                  */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E8:INFO: MmLikeB is MM_TRUE");
        if ( MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState )
        {
            if ( VOS_FALSE == NAS_MML_IsCsLaiChanged() )
            {
                Mm_ComSetMmState(MM_IDLE_NORMAL_SERVICE);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E8:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
        ...
        else
        {
            ...
            {                                                                   /* 如果LAI不变,更新状态为U1的场合           */
                ...
                else
                {
                    ...
                    g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;        /* 设置服务状态                             */
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E8:INFO: MmServiceState is MM_NORMAL_SERVICE");
    ...
    case NAS_MML_REG_FAIL_CAUSE_ACCESS_BARRED:
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E8:NORMAL: STATUS is MM_IDLE_LOCATION_UPDATE_NEEDED");
        Mm_ComSaveProcAndCauseVal(
                                  MM_COMB_RAU_PROC,
                                  (VOS_UINT8)pCombinedAttachRjct->enCause);         /* 记录流程和原因值                         */
    ...
    default:
        ...
        else if ( pCombinedAttachRjct->ulAttachAttCounter < 5)
        {
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E8:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
                g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;             /* 记录前状态                               */
                Mm_ComSetMmState(MM_IDLE_ATTEMPTING_TO_UPDATE);
                NAS_MML_SetCsUpdateStatus(NAS_MML_LOCATION_UPDATE_STATUS_NOT_UPDATED);
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E8:NORMAL: STATUS is MM_IDLE_ATTEMPTING_TO_UPDATE");
            }
        }
...
VOS_VOID Mm_Cell_S17_E11(VOS_VOID *pMsg)
{
    ...
    g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                         /* 记录前状态                               */
    Mm_ComSetMmState(IMSI_DETACH_PENDING);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E11:NORMAL: STATUS is IMSI_DETACH_PENDING");
}
...
VOS_VOID Mm_Cell_S17_E13(VOS_VOID *pMsg)
{
    ...
    else if ( GMMMM_NET_DETACH_NOATTACH == pstNetWkDetachInd->enDetachType )
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
            g_MmGlobalInfo.ucLikeB = MM_TRUE;                                   /* 设置类似于B模式的全局量                  */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E13:INFO: MmLikeB is MM_TRUE");
            switch(g_MmGlobalInfo.ucMmServiceState)
            {
            case MM_NORMAL_SERVICE:
                Mm_ComSetMmState(MM_IDLE_NORMAL_SERVICE);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E13:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
                NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
                break;
            case MM_LIMITED_SERVICE:
                Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E13:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
                break;
            case MM_ATTEMPTING_TO_UPDATE:
                Mm_ComSetMmState(MM_IDLE_ATTEMPTING_TO_UPDATE);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E13:NORMAL: STATUS is MM_IDLE_ATTEMPTING_TO_UPDATE");
                NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
                break;
            case MM_NO_IMSI:
                Mm_ComSetMmState(MM_IDLE_NO_IMSI);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E13:NORMAL: STATUS is MM_IDLE_NO_IMSI");
                break;
            default:
                break;
            }
...
VOS_VOID Mm_Cell_S17_E18(VOS_VOID *pMsg)
{
    ...
    if ( GMMMM_RAU_RESULT_COMBINED == pstCombinedRauAccpt->enRauResult )
    {
        g_MmGlobalInfo.ucLikeB = MM_FALSE;                                      /* 设置类似于B模式的全局量                  */
        g_MmGlobalInfo.ucLikeNetmode2 = MM_FALSE;
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E18:INFO: MmLikeB is MM_FALSE");
        Mm_TimerStop( MM_TIMER_T3212 );                                         /* 停T3212                                  */
        Mm_TimerStop( MM_TIMER_T3211 );                                         /* 停T3211                                  */
        Mm_ComSaveProcAndCauseVal(
                                  MM_COMB_RAU_PROC,
        ...
        g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;                    /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E18:INFO: MmServiceState is MM_NORMAL_SERVICE");
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E18:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
    }
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_IMSI_UNKNOWN_IN_HLR:
            ...
            g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                       /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E18:INFO: MmServiceState is MM_NO_IMSI");

            Mm_ComToNoImsiHandle();                                             /* 调用进NO IMSI的公共处理                  */
            Mm_ComSetMmState(MM_IDLE_NO_IMSI);

            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E18:NORMAL: STATUS is MM_IDLE_NO_IMSI");
            break;
        case NAS_MML_REG_FAIL_CAUSE_MSC_UNREACHABLE:
        case NAS_MML_REG_FAIL_CAUSE_NETWORK_FAILURE:
        case NAS_MML_REG_FAIL_CAUSE_PROCEDURE_CONGESTION:
...
VOS_VOID Mm_Cell_S17_E19(VOS_VOID *pMsg)
{
    ...
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
        ...
        g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                           /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E19:INFO: MmServiceState is MM_NO_IMSI");
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is MM_IDLE_NO_IMSI");
        break;
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW:
    case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
        g_MmGlobalInfo.ucLikeB = MM_TRUE;                                       /* 设置类似于B模式的全局量                  */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E19:INFO: MmLikeB is MM_TRUE");
        if ( MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState )
        {
            if ( VOS_FALSE == NAS_MML_IsCsLaiChanged() )
            {
                Mm_ComSetMmState(MM_IDLE_NORMAL_SERVICE);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
            }
            else
            {
        ...
        else
        {
            ...
            {                                                                   /* 如果LAI不变,更新状态为U1的场合           */
                ...
                else
                {
                    ...
                    g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;        /* 设置服务状态                             */
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E19:INFO: MmServiceState is MM_NORMAL_SERVICE");
    ...
    case NAS_MML_REG_FAIL_CAUSE_MS_ID_NOT_DERIVED:
        ...
        g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                     /* 记录前状态                               */
        Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
        Mm_ComNasInfoSav(
                        MM_STATUS_ATTACHED,
                        NAS_MML_GetSimCsSecurityCksn()
                        );                                                      /* 设置MM信息                               */
    ...
    case NAS_MML_REG_FAIL_CAUSE_IMPLICIT_DETACHED:
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E19:INFO: MmServiceState is MM_LIMITED_SERVICE");
        Mm_ComNasInfoSav(
                        MM_STATUS_DETACHED,
                        NAS_MML_GetSimCsSecurityCksn()
                        );                                                      /* 设置MM信息                               */
        g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                     /* 记录前状态                               */
        Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
        break;
    case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
    case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
        Mm_ComSaveProcAndCauseVal(
    ...
    case NAS_MML_REG_FAIL_CAUSE_ACCESS_BARRED:
        Mm_ComSetMmState(MM_IDLE_LOCATION_UPDATE_NEEDED);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is MM_IDLE_LOCATION_UPDATE_NEEDED");
        Mm_ComSaveProcAndCauseVal(
                                  MM_COMB_RAU_PROC,
                                  (VOS_UINT8)pstCombinedRauRjct->enCause);        /* 记录流程和原因值                         */
        break;
    default:
        ...
        if ( pstCombinedRauRjct->ulRauAttCounter < 5)
        {
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S17_E19:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S17_E19:NORMAL: STATUS is MM_IDLE_ATTEMPTING_TO_UPDATE");
            }
        }
...
VOS_VOID Mm_Cell_S18_E5(VOS_VOID *pMsg)
{
    ...
    if (g_MmGlobalInfo.ucNtMod != g_MmGlobalInfo.ucNewNtMod)
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S18_E5:INFO: MmServiceState is MM_DETACHED");
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S18_E5:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
    }
...
VOS_VOID Mm_Cell_S18_E10(VOS_VOID *pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S18_E10:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
}
...
VOS_VOID Mm_Cell_S18_E12(VOS_VOID *pMsg)
{
    ...
    {                                                                           /* 关机的场合                               */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S18_E12:NORMAL: STATUS is MM_STATE_NULL");
    }
    else
    {
        /* 判断等待标志是否存在，如果存在则发送MMCGMM_DETACH CNF */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S18_E12:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
    }
                    ...
                    )
{
    ...
    /* 当前不在等待此消息,丢弃 */
    NAS_MM_LogAuthInfo(pstUsimAuthCnf->ucOpId, g_MmGlobalInfo.AuthenCtrlInfo.ucOpId);

    if (pstUsimAuthCnf->ucOpId != g_MmGlobalInfo.AuthenCtrlInfo.ucOpId)
    {
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S9_E48:ERROR: authentication type is not expected!");
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E55:INFO: RECEIVE MM T3214 EXPIRED");
    return;
}
/*******************************************************************************
                    ...
                    )
{
    ...
    Mm_ComT3214orT3216Expired();                                                /* 调用T3214或者T3216溢出的处理             */
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E56:INFO: RECEIVE MM T3216 EXPIRED");
    return;
}
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E57:INFO: RECEIVE MM T3218 EXPIRED");
    return;
}
/*******************************************************************************
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E59:INFO: RECEIVE MM T3230 EXPIRED");
    return;
}
/*******************************************************************************
                    ...
                    )
{
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S11_E50:ERROR: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
   ...
   /*   && ( MMC_MM_NORMAL_SERVICE == g_MmGlobalInfo.ucMmServiceState ) ) */
    {                                                                           /* 网侧建立的MM连接                         */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E50:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
        Mm_ComCheckDelayMmConn(MM_FALSE);

        /* 记录异常状态为CSFB MT业务消息已经接收到 */
#if (FEATURE_ON == FEATURE_PTM)
        NAS_MML_SetErrLogCsfbMtState(NAS_ERR_LOG_CSFB_MT_STATE_RCV_SERVICE_REQ);
#endif
    }
                    ...
                    )
{
    ...
    g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                         /* 记录迁移之前的状态                       */
    Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S14_E40:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
                    ...
                    )
{
    if (MM_TRUE == Mm_RcvMmcPlmnSrchIni(pMsg))
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S0_E3:NORMAL: STATUS is MM_IDLE_PLMN_SEARCH");
    }
    else
    {
    }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* TI合法                                   */
            ...
            {                                                                   /* 消息制作失败                             */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S3_E65:WARNING: MAKE MSG CM SERVICE REQUEST ERROR!");
                return;                                                         /* 返回                                     */
            }
            else
            {                                                                   /* 消息制作成功                             */
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* TI合法                                   */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E65:NORMAL: STATUS is WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION");
        }
        /*lint +e701*/
    }
                    ...
                    )
{
    ...
    if ( MM_FALSE == Mm_RcvSsEstReq(pRcvMsg) )
    {                                                                           /* 消息检查结果失败                         */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S11_E65:WARNING: MMSS_EST_REQ check fail.");
    }
    else
    {                                                                           /* 消息检查结果成功                         */
        /* 当前小区主叫业务受限则不处理 */
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* TI合法                                   */
            ...
            if ( VOS_NULL_PTR == pucCmSvcReq )
            {                                                                   /* 消息制作失败                             */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S3_E62:WARNING: MAKE MSG CM SERVICE REQUEST ERROR!");
                return;                                                         /* 返回                                     */
            }
            else
            {                                                                   /* 消息制作成功                             */
...
VOS_VOID NAS_MM_ProcSmsEstReq_WaitForOutgoingMmConnection(VOS_VOID)
{
    ...
    else
    {
        ...
        if (VOS_NULL_PTR == pucCmSvcReq)
        {                                                           /* 消息制作失败                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S4_E62:WARNING: MAKE MSG CM SERVICE REQUEST ERROR!");
            return;                                                 /* 返回                                     */
        }
        else
        {                                                           /* 消息制作成功                             */
        ...
        g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;         /* 记录迁移之前的状态                       */
        Mm_ComSetMmState(WAIT_FOR_RR_CONNECTION_MM_CONNECTION);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S4_E62:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_MM_CONNECTION");
    }
}
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* TI合法                                   */
            ...
            g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                 /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E62:NORMAL: STATUS is WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION");
        }
        /*lint +e701*/
    }
                    ...
                    )
{
    ...
    if ( MM_FALSE == Mm_RcvSmsEstReq(pRcvMsg) )
    {                                                                           /* 消息检查结果失败                         */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S11_E62:WARNING: MMSMS_EST_REQ check fail.");
    }
    else
    {                                                                           /* 消息检查结果成功                         */
        /* 当前小区主叫业务受限则不处理 */
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有存在的MM连接 */
            ...
            g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S27_E68:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
        ...
        {                                                                       /* 有存在的MM连接 */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S27_E68:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
        }
    }
                    ...
                    )
{
    ...
    {                                                                           /* 支持CCBS                                 */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E47:NORMAL: STATUS is PROCESS_CM_SERVICE_PROMPT");
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 该消息中的TI大于7不存在并且TIO !=111     */
            ...
            g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S27_E27:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
        }
        else
        {
                    ...
                    )
{
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S9_E69:ERROR: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
    pucBakCMMsg = pucCMMsg;
    ...
    {                                                                           /* 网侧建立的MM连接                         */
        ...
        {                                                                       /* 该连接不存在                             */
            ...
            if ( g_MmGlobalInfo.ucState == WAIT_FOR_OUTGOING_MM_CONNECTION )
            {
                g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;                          /* 记录迁移之前的状态                       */
                Mm_ComSetMmState(WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E69:NORMAL: STATUS is WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION");
            }
    ...
    {                                                                           /* SS建立的MM连接                           */
        ...
        {                                                                       /* 该连接不存在                             */
            ...
            g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E69:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
            Mm_ComCheckDelayMmConn( MM_FALSE );
        }
        /*lint +e701*/
    }
                    ...
                    )
{
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S9_E70:ERROR: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
    pucBakCMMsg = pucCMMsg;
    PS_MEM_SET(pucCMMsg, 0, pRrDataInd->RcvNasMsg.ulNasMsgSize );              /* 初始化内存                               */
    ...
    {                                                                           /* 网侧建立的MM连接                         */
        ...
        {                                                                       /* 该连接不存在                             */
            ...
            if ( g_MmGlobalInfo.ucState == WAIT_FOR_OUTGOING_MM_CONNECTION )
            {
                g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;                          /* 记录迁移之前的状态                       */
                Mm_ComSetMmState(WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E70:NORMAL: STATUS is WAIT_FOR_ADDITIONAL_OUTGOING_MM_CONNECTION");
            }
    ...
    {                                                                           /* SMS建立的MM连接                          */
        ...
        {                                                                       /* 该连接不存在                             */
            ...
            g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E70:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
            Mm_ComCheckDelayMmConn( MM_FALSE );
        }
        /*lint +e701*/
    }
                    ...
                    )
{
    ...
    if( VOS_NULL_PTR == pucCMMsg )
    {                                                                           /* 内存申请失败                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S11_E69:WARNING: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
    pucBakCMMsg = pucCMMsg;
    PS_MEM_SET(pucCMMsg, 0, pRrDataInd->RcvNasMsg.ulNasMsgSize );              /* 初始化内存                               */
    ...
    {                                                                           /* 网侧建立的MM连接                         */
        ...
        g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;                   /* 记录迁移之前的状态                       */
        Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E69:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
        Mm_ComCheckDelayMmConn( MM_FALSE );
                    ...
                    )
{
    ...
    if( VOS_NULL_PTR == pucCMMsg )
    {                                                                           /* 内存申请失败                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S11_E70:WARNING: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
    pucBakCMMsg = pucCMMsg;
    PS_MEM_SET(pucCMMsg, 0, pRrDataInd->RcvNasMsg.ulNasMsgSize );              /* 初始化内存                               */
    ...
    {                                                                           /* 网侧建立的MM连接                         */
        ...
        g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;                   /* 记录迁移之前的状态                       */
        Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E70:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
        Mm_ComCheckDelayMmConn( MM_FALSE );
    }
    else if ( ( MM_CONST_NUM_7 < ucTI ) && ( MM_CONST_NUM_15 > ucTI ) )
    {                                                                           /* SMS建立的MM连接                          */
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E63:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
        }
    }
                    ...
                    )
{
    if ( MM_FALSE == Mm_RcvSmsRelReq(pRcvMsg) )
    {                                                                           /* 消息检查结果失败                         */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S12_E63:WARNING:  CHECK PRIMITIVE ERROR!");
    }
    else
    {                                                                           /* 消息检查结果成功                         */
            ...
            g_MmSmsRelReq.ulTi )
        {
            if (g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SMS].ucRat == NAS_MML_GetCurrNetRatType())
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                Mm_ComSaveProcAndCauseVal( MM_MM_CONN_PROC, NAS_MML_REG_FAIL_CAUSE_NULL );    /* MM连接流程                               */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E63:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
            }
            else
            {
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S16_E63:NORMAL: STATUS is WAIT_FOR_OUTGOING_MM_CONNECTION");
        }
    }
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E49:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E49:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E49:NORMAL: STATUS is WAIT FOR OUTGOING MM CONNECTION");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E49:NORMAL: STATUS is MM CONNECTION ACTIVE");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E49:NORMAL: STATUS is WAIT FOR RR CONNECTION");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E49:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_LOCATION_UPDATING");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E49:NORMAL: STATUS is LOCATION_UPDATING_INITIATED");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E49:NORMAL: STATUS is LOCATION_UPDATE_REJECTED");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E49:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
...
)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S26_E49:NORMAL: STATUS is IMSI_DETACH_INITIATED");
