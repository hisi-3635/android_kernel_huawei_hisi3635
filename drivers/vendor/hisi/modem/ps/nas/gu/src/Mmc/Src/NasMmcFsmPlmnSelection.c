...
VOS_VOID NAS_MMC_SndMmaSrchedGuPlmnInfo(   
    NAS_MML_NET_RAT_TYPE_ENUM_UINT8     enRat,
    RRMM_SEARCHED_PLMN_INFO_IND_STRU   *pstSearchedPlmnInfoMsg
)
{
    MMC_MMA_SRCHED_PLMN_INFO_IND_STRU  stMmcSrchedPlmnINfo;
    VOS_UINT32                         i;
    ...
    if (MMC_MMA_MAX_SRCHED_LAI_NUM < stMmcSrchedPlmnINfo.ulLaiNum)
    {
        stMmcSrchedPlmnINfo.ulLaiNum = MMC_MMA_MAX_SRCHED_LAI_NUM;
    }
    ...
    NAS_MMC_SndMmaSrchedPlmnInfo(&stMmcSrchedPlmnINfo);
}
...
)
{
    ...
    NAS_MMC_SndMmaSrchedGuPlmnInfo(NAS_MML_NET_RAT_TYPE_WCDMA, pstSearchedPlmnInfoMsg);
...
)
{
    ...
    NAS_MMC_SndMmaSrchedGuPlmnInfo(NAS_MML_NET_RAT_TYPE_GSM, pstSearchedPlmnInfoMsg);
...
VOS_VOID NAS_MMC_SndMmaSrchedLtePlmnInfo(
    LMM_MMC_SEARCHED_PLMN_INFO_IND_STRU                    *pstSearchedPlmnInfoInd
)
{
    MMC_MMA_SRCHED_PLMN_INFO_IND_STRU  stMmcSrchedPlmnINfo;
    VOS_UINT32                         i;
    MMA_MMC_PLMN_ID_STRU               stGuNasPlmn;
    ...
    if (MMC_MMA_MAX_SRCHED_LAI_NUM < pstSearchedPlmnInfoInd->ulTaiNum)
    {
        stMmcSrchedPlmnINfo.ulLaiNum = MMC_MMA_MAX_SRCHED_LAI_NUM;
    }

    stMmcSrchedPlmnINfo.enRat = NAS_MML_NET_RAT_TYPE_LTE;
...
)
{
    ...
    NAS_MMC_SndMmaSrchedLtePlmnInfo(pstSearchedPlmnInfoInd);
...
)
{
    ...
    VOS_UINT8                                               ucRatChgForLteOosPlmnSelFlg;
    NAS_MMC_PLMN_SEARCH_SCENE_ENUM_UINT32                   enPlmnSearchScene;
#endif
    ...
    ucRatChgForLteOosPlmnSelFlg = NAS_MMC_GetRatChgForLteOos2GPrefPlmnSelFlg();
    
    if  ((VOS_TRUE == NAS_MML_IsNeedSortRatPrioForLteOos2GPrefPlmnSel(&stPrioRatList))
      && (VOS_TRUE == ucRatChgForLteOosPlmnSelFlg)
