                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E66:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                       ...
                       )
{
    if (MM_FALSE == Mm_RcvSsRelReq(pRcvMsg))
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S12_E66:WARNING: Rcv SS Rel Req error.");
    }
    else
    {
          ...
          && (MM_TRUE == g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SS].RcvXXEstReq.ucFlg))
        {
            ...
            if (g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SS].ucRat == NAS_MML_GetCurrNetRatType())
            {
                ...
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                Mm_ComSaveProcAndCauseVal( MM_MM_CONN_PROC, NAS_MML_REG_FAIL_CAUSE_NULL );    /* MM连接流程                               */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E80:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
            }
            else
            {
...
VOS_VOID Mm_Cell_S24_E13(VOS_VOID *pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E13:INFO: MmServiceState is MM_NET_DETACH_PROC");
    ...
    else if (GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType)
    {
        ...
        Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E13:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
    }
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E13:INFO: MmServiceState is MM_NO_IMSI");
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E13:INFO: MmLikeB is MM_TRUE");
            break;
...
VOS_VOID Mm_Cell_S3_E14(VOS_VOID* pMsg)
{
    ...
    if (GMMMM_ACTION_FAILURE == pstGmmActionRstInd->enActionResult)
    {
        ...
        case GMMMM_ACTION_SR:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S3_E14:WARNING: ulGmmActionType Abnormal");
            break;
        }
...
VOS_VOID Mm_Cell_S24_E14(VOS_VOID* pMsg)
{
    ...
    if (GMMMM_ACTION_FAILURE == pstGmmActionRstInd->enActionResult)
    {
        ...
        case GMMMM_ACTION_SR:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S24_E14:WARNING: ulGmmActionType Abnormal");
            break;
        }
        if (MM_NULL_PROC != ucActionType)
        {
            ...
            case NAS_MML_REG_FAIL_CAUSE_ILLEGAL_ME:
                ...
                g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;               /* 设置服务状态                             */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E14:INFO: MmServiceState is MM_NO_IMSI");
                Mm_ComToNoImsiHandle();                                     /* 调用删除IMSI的公共处理                   */
                Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E14:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                break;
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
                g_MmGlobalInfo.ucLikeB = MM_TRUE;                               /* 设置类似于B模式的全局量                  */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E14:INFO: MmLikeB is MM_TRUE");
                break;
            case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
            case NAS_MML_REG_FAIL_CAUSE_ROAM_NOT_ALLOW:
...
VOS_VOID Mm_Cell_S24_E16(VOS_VOID* pMsg)
{
    ...
    g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                               /* 设置服务状态                             */
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S24_E16:INFO: MmServiceState is MM_NO_IMSI");
    Mm_ComToNoImsiHandle();                                                     /* 调用删除IMSI的公共处理                   */
    Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E16:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
}
VOS_VOID Mm_Cell_S25_E16(VOS_VOID* pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E16:NORMAL: STATUS is MM_STATE_NULL");
}
/*******************************************************************************
...
VOS_VOID Mm_Cell_S3_E22(VOS_VOID* pMsg)
{
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
        ...
        if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
        {
            if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S3_E22:INFO: MmServiceState is MM_DETACHED");
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E22:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E22:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
                g_MmGlobalInfo.ucMmServiceState = MM_DETACHED;                  /* 设置服务状态                             */
            }
        }
...
VOS_VOID Mm_Cell_S4_E22(VOS_VOID* pMsg)
{
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
        ...
        g_MmGlobalInfo.ucMmServiceState = MM_DETACHED;                      /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S4_E22:INFO: MmServiceState is MM_DETACHED");
        Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                         NAS_MML_GetSimCsSecurityCksn());             /* 设置MM信息                               */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S4_E22:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
    }
}
...
VOS_VOID Mm_Cell_S8_E22(VOS_VOID* pMsg)
{
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
        NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
        g_MmGlobalInfo.ucMmServiceState = MM_NO_IMSI;                           /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S8_E22:INFO: MmServiceState is MM_NO_IMSI");
...
VOS_VOID Mm_Cell_S9_E22(VOS_VOID* pMsg)
{
    ...
    if ( VOS_TRUE == NAS_MM_IsNeedGmmProcUserDetach() )
    {
        ...
        Mm_ComRelAllMmConn(NAS_MMCM_REL_CAUSE_MM_INTER_ERR_CS_DETACH);
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E22:NORMAL: STATUS is IMSI_DETACH_PENDING");
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
                        ...
                        g_MmSubLyrShare.MmShare.ucCsAttachState))
        {
            ...
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E22:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
        ...
        else
        {
            ...
            Mm_ComSetMmState(IMSI_DETACH_INITIATED);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E22:NORMAL: STATUS is IMSI_DETACH_INITIATED");
        }
...
VOS_VOID Mm_Cell_S12_E22(VOS_VOID* pMsg)
{
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
                                ...
                                g_MmSubLyrShare.MmShare.ucCsAttachState))
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E22:NORMAL: STATUS is MM_IDLE_NO_IMSI");
        }
        else
        {
            g_MmGlobalInfo.ucDetachType = MM_DETACH_CS_NORMAL;              /* 设置DETACH类型                           */
            ...
            g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;
            Mm_ComSetMmState(WAIT_FOR_RR_CONNECTION_IMSI_DETACH);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E22:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
        }
    }
}
...
VOS_VOID Mm_Cell_S0_E23(VOS_VOID* pMsg)
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S0_E23:NORMAL: STATUS is MM_STATE_NULL");
}
VOS_VOID Mm_Cell_S3_E23(VOS_VOID* pMsg)
{
    ...
    if (NAS_MML_NET_RAT_TYPE_LTE == NAS_MML_GetCurrNetRatType())
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E23:NORMAL: STATUS is MM_STATE_NULL");
    ...
    if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        ...
        if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
        {
            NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                    /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S3_E23:INFO: MmServiceState is MM_NO_IMSI");
            Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                             NAS_MML_GetSimCsSecurityCksn());             /* 设置MM信息                               */
        ...
        else
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E23:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
        }
    ...
    else if (MM_STATUS_DETACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
        g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                        /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S3_E23:INFO: MmServiceState is MM_NO_SERVICE");
        Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                         NAS_MML_GetSimCsSecurityCksn());                 /* 设置MM信息                               */
        Mm_SndMmcPowerOffCnf();                                                 /* 向MMC发送MMCMM_POWER_OFF_CNF             */
...
VOS_VOID Mm_Cell_S9_E23(VOS_VOID* pMsg)
{
    ...
    {                                                                           /* 如果为A+I模式                            */
         ...
         && (GMM_STATUS_ATTACHED == g_MmSubLyrShare.GmmShare.ucAttachSta))
        {
            ...
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E23:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            return;                                                             /* 不是类似B或者A+II模式的场合              */
        }
    }
    ...
    if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
        {
            Mm_SndRrRelReq(RRC_CELL_UNBARRED);
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                    /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E23:INFO: MmServiceState is MM_NO_SERVICE");
            Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                             NAS_MML_GetSimCsSecurityCksn());             /* 设置MM信息                               */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E23:NORMAL: STATUS is MM_STATE_NULL");
        }
        else
        {
            NAS_MM_FillMobileID(&(Msg.MmIeMobileId.MobileID));
            ...
            Mm_TimerStart(MM_TIMER_PROTECT_DETACH);
            Mm_ComSetMmState(IMSI_DETACH_INITIATED);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E23:NORMAL: STATUS is IMSI_DETACH_INITIATED");
        }
    }
    else
    {
...
VOS_VOID Mm_Cell_S12_E23(VOS_VOID* pMsg)
{
    ...
    if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        ...
        {
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                    /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S12_E23:INFO: MmServiceState is MM_NO_SERVICE");
            Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                             NAS_MML_GetSimCsSecurityCksn());             /* 设置MM信息                               */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E23:NORMAL: STATUS is MM_STATE_NULL");
        }
        else
        {
            NAS_MM_FillMobileID(&(Msg.MmIeMobileId.MobileID));
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E23:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
        }
    }
    else
    {
...
VOS_VOID Mm_Cell_S14_E23(VOS_VOID* pMsg)
{
    ...
    if (MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState)
    {
        if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
        {
            Mm_SndRrRelReq(RRC_CELL_UNBARRED);
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                    /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S14_E23:INFO: MmServiceState is MM_NO_SERVICE");
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S14_E23:NORMAL: STATUS is MM_STATE_NULL");
        }
        else
        {
            if (MM_CS_SIG_CONN_PRESENT == g_MmGlobalInfo.ucCsSigConnFlg)
            {
                ...
                Mm_TimerStart(MM_TIMER_PROTECT_DETACH);
                Mm_ComSetMmState(IMSI_DETACH_INITIATED);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S14_E23:NORMAL: STATUS is IMSI_DETACH_INITIATED");
            }
            else
            {
                Mm_SndRrRelReq(RRC_CELL_UNBARRED);
                ...
                g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;
                Mm_ComSetMmState(WAIT_FOR_RR_CONNECTION_IMSI_DETACH);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S14_E23:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
            }
...
VOS_VOID Mm_Cell_S22_E32(VOS_VOID* pMsg)
{
        ...
        && (RRC_EST_PRESENT != pRrcEstCnf->ulResult))
    {
        ...
        if (NAS_MML_MS_MODE_PS_ONLY == NAS_MML_GetMsMode())
        {
            ...
            Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E32:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
    ...
    case RRC_EST_PRESENT:
        ...
        {
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S22_E32:WARNING: RR CONNECTION PRESENT!");
        }
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E32:INFO: MmCsSigConnFlg is MM_CS_SIG_CONN_PRESENT");
        Mm_SndMmcRrConnInfInd(MMC_MM_RR_CONN_ESTED);                            /* RR连接建立成功                           */
        Mm_ComSetMmState(LOCATION_UPDATING_INITIATED);

        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E32:NORMAL: STATUS is LOCATION_UPDATING_INITIATED");
        break;
    case RRC_EST_ESTING:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S22_E32:WARNING: RR CONNECTION ESTING!");
        break;
    ...
    case RRC_EST_RANDOM_ACCESS_REJECT_NO_VALID_INFO:
        ...
        if (g_MmGlobalInfo.LuInfo.ucLuAttmptCnt < MM_CONST_NUM_4)
        {
            ...
            {                                                                   /* 如果LAI不变,且更新状态为U1的时候         */
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E32:INFO: MmServiceState is MM_NORMAL_SERVICE");
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E32:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E32:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
    ...
    case RRC_EST_ACCESS_BARRED:
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E32:NORMAL: STATUS is MM_IDLE_LOCATION_UPDATE_NEEDED");
    ...
    default:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S22_E32:WARNING:  Result Abnormal");
        break;
    }
...
VOS_VOID Mm_Cell_S25_E32(VOS_VOID* pMsg)
{
    ...
    case RRC_EST_PRESENT:
        if (RRC_EST_PRESENT == pRrcEstCnf->ulResult)
        {
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S25_E32:WARNING: RR CONNECTION PRESENT!");
            return;
        }

        Mm_TimerStart(MM_TIMER_T3220);                                          /* 启动T3220                                */
        g_MmGlobalInfo.ucCsSigConnFlg = MM_CS_SIG_CONN_PRESENT;                 /* 设置信令连接已存在                       */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S25_E32:INFO: MmCsSigConnFlg is MM_CS_SIG_CONN_PRESENT");
        Mm_SndMmcRrConnInfInd(MMC_MM_RR_CONN_ESTED);                            /* RR连接建立成功                           */
        NAS_MM_SndGmmCsConnectInd(MMGMM_CS_CONNECT_EXIST);
        Mm_ComSetMmState(IMSI_DETACH_INITIATED);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E32:NORMAL: STATUS is IMSI_DETACH_INITIATED");
        break;
    case RRC_EST_ESTING:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S25_E32:WARNING: RR CONNECTION ESTING!");
        break;
    case RRC_EST_RJ_CONGEST:
    case RRC_EST_RJ_UNSPEC:
    case RRC_EST_REGISTER_ACCESS_BARRED:
    ...
    case RRC_EST_RANDOM_ACCESS_REJECT_NO_VALID_INFO:
        ...
        if (MM_DETACH_CS_POWEROFF == g_MmGlobalInfo.ucDetachType)
        {
            ...
            Mm_ComSetMmState(MM_STATE_NULL);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E32:NORMAL: STATUS is MM_STATE_NULL");
        ...
        else
        {
            ...
            if (MM_WAIT_CS_DETACH== (g_MmGlobalInfo.stDetachInfo.enDetachType
                         & MM_WAIT_CS_DETACH))
            {
                NAS_MM_SndMmcDetachCnf(MMC_MM_NORMAL_SERVICE);
                /* 清除等待标志 */
                g_MmGlobalInfo.stDetachInfo.enDetachType = MM_WAIT_NULL_DETACH;
            }

            Mm_ComSetMmState(g_MmGlobalInfo.ucPreState);
            PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E32:NORMAL: STATUS is",g_MmGlobalInfo.ucState);
        }
        break;
    default:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S25_E32:WARNING: Result Abnormal");
        break;
    }
...
VOS_VOID Mm_Cell_S22_E33(VOS_VOID *pRcvMsg)
{
    ...
    if (MM_TRUE == ucValidFlg)
    {
        ...
        g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;
        Mm_ComSetMmState(g_MmGlobalInfo.ucStaOfRcvXXEstReq);
        PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E33:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
        ...
        if (RRC_REL_CAUSE_NAS_REL_SUCCESS == pMsg->ulRelCause)
        {
            ...
            {
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S22_E33:WARNING: Mm_ComChkLu return MM_FALSE\n");
            }
        }
        else
        {
            ...
            if (NAS_MML_MS_MODE_PS_ONLY == NAS_MML_GetMsMode())
            {
                 ...
                 Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
                 PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E33:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
                 Mm_ComCheckDelayMmConn(MM_FALSE);
                 NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
                 return;
            }
            ...
            {
                g_MmGlobalInfo.ucMmServiceState = MM_ATTEMPTING_TO_UPDATE;
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E33:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
    ...
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S22_E33:WARNING: ulRelCause Abnormal");
    }
}
...
VOS_VOID Mm_Cell_S23_E33(VOS_VOID* pMsg)
{
    ...
    if (NAS_MML_MS_MODE_PS_ONLY == NAS_MML_GetMsMode())
    {
        ...
        NAS_MM_SndGmmCsConnectInd(MMGMM_CS_CONNECT_NOT_EXIST);
        Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E33:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
        Mm_ComCheckDelayMmConn(MM_FALSE);
...
VOS_VOID  Mm_Cell_S25_E33( VOS_VOID* pMsg )
{
    ...
    if (MM_TRUE == ucValidFlg)
    {
        ...
        if (MM_DETACH_CS_POWEROFF == g_MmGlobalInfo.ucDetachType)
        {
            ...
            Mm_SndMmcPowerOffCnf();
            Mm_ComSetMmState(MM_STATE_NULL);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E33:NORMAL: STATUS is MM_STATE_NULL");
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;
        }
        else
        {
            ...
            Mm_ComSetMmState(g_MmGlobalInfo.ucPreState);
            PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E33:NORMAL: STATUS is",g_MmGlobalInfo.ucState);
        }
    ...
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S25_E33:WARNING: ulRelCause Abnormal");
    }
    return;
}
VOS_VOID Mm_Cell_S26_E33(VOS_VOID* pMsg)
{
    ...
    case MM_DETACH_CS_POWEROFF:
        ...
        Mm_ComSetMmState(MM_STATE_NULL);
        g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S26_E33:NORMAL: STATUS is MM_STATE_NULL");
        Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                         NAS_MML_GetSimCsSecurityCksn());
        Mm_SndMmcPowerOffCnf();
        break;
    case MM_DETACH_CS_NORMAL:
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S26_E33:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
        break;
    default:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S26_E33:WARNING: Detach type Abnormal");
        break;
    }
...
VOS_VOID Mm_Cell_S23_E51(VOS_VOID* pMsg)
{
    ...
    {                                                                           /* 判断LU Counter是否小于4                  */
        ...
        {                                                                       /* 判断LAI是否未改变,且更新状态为U1         */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S23_E46:INFO: MmServiceState is MM_NORMAL_SERVICE");
        ...
        else
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S23_E46:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
    ...
    NAS_MM_SndGmmLuResultInd(MMGMM_LU_FAILURE,
                             NAS_MML_REG_FAIL_CAUSE_TIMER_TIMEOUT);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E51:NORMAL: STATUS is LOCATION_UPDATE_REJECTED");
}
...
VOS_VOID Mm_Cell_S26_E58(VOS_VOID* pMsg)
{
    ...
    case MM_DETACH_CS_POWEROFF:
        ...
        Mm_ComSetMmState(MM_STATE_NULL);
        g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S26_E58:NORMAL: STATUS is MM_STATE_NULL");
        Mm_ComNasInfoSav(MM_STATUS_DETACHED,
                         NAS_MML_GetSimCsSecurityCksn());
        Mm_SndMmcPowerOffCnf();
        break;
    case MM_DETACH_CS_NORMAL:
        ...
        Mm_ComSetMmState(MM_IDLE_LIMITED_SERVICE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S26_E58:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
        break;
    default:
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S26_E58:WARNING: Detach type Abnormal");
        break;
    }
...
VOS_VOID Mm_Cell_S23_E45(VOS_VOID* pMsg)
{
    ...
    {
        if (pstEmergencyNumList->ulMcc != pstCurrCampLai->stPlmnId.ulMcc)
        {
    ...
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S23_E45:WARNING: LU ACCEPTED LAI ERROR!");
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S23_E45:INFO: MmServiceState is MM_NORMAL_SERVICE");
    ...
    Mm_SndAgentUsimUpdateFileReq(MM_READ_LOCA_INFO_FILE_ID);                    /* 向USIM发送AGENT_USIM_UPDATE_FILE_REQ(U1) */
    ...
    {
        Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E45:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
...
NAS_STK_UPDATE_TYPE_ENUM_UINT8 NAS_MM_ConvertMmLuTypeToStkLuType (LAU_TYPE_ENUM_UINT8 enMmLuType)
{
    switch (enMmLuType)
    {
        ...
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ConvertMmLuTypeToStkLuType:WARNING: The input in invalid");
...
TAF_PH_RAT_TYPE_ENUM_UINT8 NAS_MM_ConvertMmRatTypeToStkRatType (NAS_MML_NET_RAT_TYPE_ENUM_UINT8 enMmRatType)
{
    switch (enMmRatType)
    {
        ...
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "NAS_MM_ConvertMmRatTypeToStkRatType:WARNING: The input in invalid");
...
VOS_VOID Mm_Cell_S23_E46(VOS_VOID* pMsg)
{
    ...
    default:
        ...
        if (VOS_TRUE == NAS_MML_IsRoamingRejectNoRetryFlgActived(g_MmMsgLuRjct.MmIeRejCause.ucRejCause))
        {
            g_MmGlobalInfo.LuInfo.ucLuAttmptCnt = MM_CONST_NUM_4;
        }
    ...
    NAS_MM_SndGmmLuResultInd(MMGMM_LU_FAILURE,
                             g_MmGlobalInfo.usCauseVal);
    Mm_ComSetMmState(LOCATION_UPDATE_REJECTED);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E46:NORMAL: STATUS is LOCATION_UPDATE_REJECTED");
    Mm_TimerStart(MM_TIMER_T3240);                                              /* 停止T3240                                */
}
            ...
            if (VOS_TRUE == NAS_MML_GetCsAttachAllowFlg())
            {
                ...
                {                                                               /* 如果LAI不变,更新状态为U1                 */
                    if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
                    {
                        ...
                        g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;    /* 设置服务状态                             */
                        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S4_E2:INFO: MmServiceState is MM_NORMAL_SERVICE");
                        ...
                        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S4_E2:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
            ...
            if (VOS_TRUE == NAS_MML_GetCsAttachAllowFlg())
            {
                ...
                {                                                               /* 如果LAI不变,更新状态为U1                 */
                    if (MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg)
                    {
                        ...
                        g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;    /* 设置服务状态                             */
                        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S19_E2:INFO: MmServiceState is MM_NORMAL_SERVICE");
                        NAS_MM_SndMmcCsRegResultInd(MM_MMC_LU_PROC_FALSE,
                                                    MM_MMC_LU_RESULT_SUCCESS,
                                                    NAS_MML_REG_FAIL_CAUSE_NULL);                /* 向MMC发送MMCMM_LU_RESULT_IND             */
                        NAS_MM_SndGmmLuResultInd(MMGMM_LU_SUCCESS,
                        ...
                        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S19_E2:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
                        NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
                    }
                    else
                    {
...
VOS_VOID Mm_Cell_S1_E20(VOS_VOID* pMsg)
{
    ...
    else
    {
        ...
        case NAS_MML_MS_MODE_NULL:
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S1_E20:WARNING: MsMode Abnormal");
            break;
        }
    }
}
...
VOS_VOID Mm_Cell_S22_E1(VOS_VOID* pMsg)
{
    ...
    else
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S22_E1:NORMAL: STATUS is MM_STATE_NULL");
    ...
    else
    {
        ...
        {                                                                       /* 网络模式为I,且用户模式为A的场合          */
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S3_E12:INFO: MmLikeB is MM_TRUE");
    ...
    else
    {
        ...
        {                                                                       /* 网络模式为I,且用户模式为A的场合          */
            ...
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S4_E12:INFO: MmLikeB is MM_TRUE");
            }
        ...
        case NAS_MML_MS_MODE_PS_CS:                                                     /* A模式的场合                              */
            ...
            {                                                                   /* 存在缓存系统信息的场合                   */
                ...
                {                                                               /* SIM无效的场合                            */
                    ...
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S0_E20:NORMAL: STATUS is MM_IDLE_NO_IMSI");
                }
                else
                {
                    ...
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S0_E20:NORMAL: STATUS is MM_WAIT_FOR_ATTACH");
                }
            }
            else
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S0_E20:NORMAL: STATUS is MM_IDLE_NO_CELL_AVAILABLE");
            }
            break;
        case NAS_MML_MS_MODE_PS_ONLY:                                                    /* CG模式的场合                             */
            NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
...
VOS_VOID Mm_Cell_S3_E20(VOS_VOID* pMsg)
{
    ...
    else
    {
        ...
        case NAS_MML_MS_MODE_PS_ONLY:                                                    /* CG模式的场合                             */
            NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S3_E20:WARNING: MsMode Abnormal");
            break;
        case NAS_MML_MS_MODE_CS_ONLY:                                                    /* CC模式的场合                             */
            NAS_MML_SetCsAttachAllowFlg(VOS_TRUE);
            break;
        ...
        case NAS_MML_MS_MODE_PS_CS:                                                     /* A模式的场合                              */
            ...
            {                                                                   /* 网络模式为I的场合                        */
                if (MM_TRUE == g_MmGlobalInfo.ucLikeB)
                {
                    ...
                    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S9_E20:INFO: MmLikeB is MM_FALSE");
                }
            }
            break;
        case NAS_MML_MS_MODE_PS_ONLY:                                                    /* CG模式的场合                             */
            NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S9_E20:WARNING: MsMode Abnormal");
            break;
        case NAS_MML_MS_MODE_CS_ONLY:                                                    /* CC模式的场合                             */
            NAS_MML_SetCsAttachAllowFlg(VOS_TRUE);
            break;
                    ...
                    )
{
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S14_E50:ERROR: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
...
VOS_VOID Mm_Cell_S23_E5(VOS_VOID* pMsg)
{
            ...
            g_MmGlobalInfo.MsCsInfo.ulCurFobidnFlg))
    {
        ...
        NAS_MM_SndGmmLuResultInd(MMGMM_LU_FAILURE,
                                 g_MmGlobalInfo.usCauseVal);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E5:NORMAL: STATUS is LOCATION_UPDATE_REJECTED");
        Mm_TimerStart(MM_TIMER_T3240);                                          /* 启动TIMER3240                            */
    }
    else
    {
...
VOS_VOID Mm_Cell_S24_E22(VOS_VOID* pMsg)
{
    ...
    if (MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause)
    {
                            ...
                            g_MmSubLyrShare.MmShare.ucCsAttachState))
        {
            ...
            Mm_ComSaveProcAndCauseVal(MM_IMSI_DETACH, NAS_MML_REG_FAIL_CAUSE_NULL);       /* 记录流程和原因值                         */
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E22:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动T3240                                */
        }
        else
        {
            ...
            Mm_TimerStart(MM_TIMER_T3220);                                      /* 启动T3220                                */
            Mm_ComSetMmState(IMSI_DETACH_INITIATED);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S24_E22:NORMAL: STATUS is IMSI_DETACH_INITIATED");
        }
    }
}
    ...
    if (GMMMM_NET_DETACH_REATTACH == pstNetWkDetachInd->enDetachType)
    {
        ...
        {                                                                       /* 如果为A+I模式                            */
            if (MM_FALSE == g_MmGlobalInfo.ucLikeB)
            {
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S4_E13:INFO: MmLikeB is MM_TRUE");
            }
        }
    }
    else if (GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType)
...
VOS_VOID Mm_Cell_S5_E13(VOS_VOID *pMsg)
{
    ...
    if (GMMMM_NET_DETACH_REATTACH == pstNetWkDetachInd->enDetachType)
    {
        ...
        {                                                                       /* 如果为A+I模式                            */
            ...
            {
                g_MmGlobalInfo.ucLikeB = MM_TRUE;                               /* 设置类似于B模式                          */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S5_E13:INFO: MmLikeB is MM_TRUE");
                NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
            }
        }
    }
    ...
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S5_E13:INFO: MmServiceState is MM_LIMITED_SERVICE");
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S5_E13:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
            break;
        case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
        case NAS_MML_REG_FAIL_CAUSE_ROAM_NOT_ALLOW:
        case NAS_MML_REG_FAIL_CAUSE_NO_SUITABL_CELL:
...
VOS_VOID    Mm_Cell_S6_E62( VOS_VOID* pMsg)
{
    ...
    else
    {
        ...
        if (MM_COM_SRVST_NORMAL_SERVICE == NAS_MM_GetLauUptNeededCsSrvStatus())
        {
            ...
            {
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S6_E62:WARNING: MAKE MSG CM SERVICE REQUEST ERROR!");
                return;
            }
            else
            {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E62:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_MM_CONNECTION");
    ...
    else
    {
        ...
        if (MM_COM_SRVST_NORMAL_SERVICE == NAS_MM_GetLauUptNeededCsSrvStatus())
        {
           ...
           /* 正常服务发起建链 */
            ...
            if (VOS_NULL_PTR == pucCmSvcReq)
            {
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S6_E65:WARNING: MAKE MSG CM SERVICE REQUEST ERROR!");
                return;
            }
            else
            {
            ...
            g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;
            Mm_ComSetMmState(WAIT_FOR_RR_CONNECTION_MM_CONNECTION);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S3_E65:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_MM_CONNECTION");
        }
        else
        {
            /* ==>A32D12640 */
...
VOS_VOID Mm_Cell_S0_E22(VOS_VOID* pMsg)
{
    ...
    if ( MMC_MM_PS_DETACH != pMmcDetachReq->enDetachCause )
    {
        NAS_MML_SetCsAttachAllowFlg(VOS_FALSE);
        g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                        /* 设置服务状态                             */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S0_E22:INFO: MmServiceState is MM_NO_SERVICE");
        Mm_ComNasInfoSav(
                         MM_STATUS_DETACHED,
                         NAS_MML_GetSimCsSecurityCksn());                 /* 设置MM信息                               */
        switch ( pMmcDetachReq->enDetachCause )
        {
        ...
        case MMC_MM_PS_CS_DETACH:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S0_E22:WARNING: Detach Cause Abnormal");
            break;
        }
    }
}
...
VOS_VOID Mm_Cell_S11_E47(VOS_VOID* pMsg)
{
    ...
    {                                                                           /* 支持CCBS                                 */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S11_E47:NORMAL: STATUS is PROCESS_CM_SERVICE_PROMPT");
...
VOS_VOID    Mm_Cell_S22_E24( VOS_VOID*pMsg )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        if (NAS_MML_NET_RAT_TYPE_LTE == NAS_MML_GetCurrNetRatType())
        {
            ...
            /* 如果当前驻留LTE,MM LOCATION_UPDATING_PENDING状态收到紧急呼叫需要给LMM
               发起ID_MM_LMM_CSFB_SERVICE_START_NOTIFY */
            if (MMCC_EMERGENCY_CALL == g_MmCcEstReq.ulCallType)
            {
                NAS_MM_RcvCcEstReq_CSFB();
                return;
                    ...
                    )
{
    ...
    if ( TC_RB_TEST_ACTIVE == pTcmmTestReq->ulMode )
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E71:NORMAL: STATUS is TEST_CONTROL_ACTIVE");
    }
    ...
    if ( TC_RB_TEST_DEACTIVE == pTcmmTestReq->ulMode )
    {
        ...
        else
        {
            ...
            case MM_NORMAL_SERVICE:
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E71:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
                NAS_MM_StartT3212Timer(NAS_MM_T3212_START_SCENE_NORMAL_START);
                break;
            case MM_LIMITED_SERVICE:
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E71:NORMAL: STATUS is MM_IDLE_LIMITED_SERVICE");
                break;
            case MM_ATTEMPTING_TO_UPDATE:
                Mm_ComSetMmState(MM_IDLE_ATTEMPTING_TO_UPDATE);

                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E71:NORMAL: STATUS is MM_IDLE_ATTEMPTING_TO_UPDATE");
            ...
            case MM_NO_IMSI:
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E71:NORMAL: STATUS is MM_IDLE_NO_IMSI");
                break;
            case MM_DETACHED:
                Mm_ComSetMmState(g_MmGlobalInfo.ucPreState);
                /*WUEPS_TRACE(MM_LOG_LEVEL_1,                                   */
                /*    "\nMM:ucState = %d\r", g_MmGlobalInfo.ucState);           */
                PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E71:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
                break;
            default:
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S31_E71:WARNING: g_MmGlobalInfo.ucMmServiceState Abnormal");
                break;
            }
        }
    }
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E13:INFO: MmServiceState is MM_NET_DETACH_PROC");
    if ( GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType )
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E13:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
    ...
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S22_E13:INFO: MmLikeB is MM_TRUE");
            break;
        case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
            Mm_TimerStop(MM_TIMER_PROTECT_SIGNALLING);
            /* Modified by libin 05-03-22 begin: NAS_IT_BUG_017 */
                    ...
                    )
{
    ...
    else if ( GMMMM_NET_DETACH_IMSI == pstNetWkDetachInd->enDetachType )
    {
        ...
        g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                     /* 记录前状态                               */
        Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E13:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
        Mm_TimerStart(MM_TIMER_T3240);                                          /* 启动TIMER3240                            */
    }
    else
    {
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_AND_NON_GPRS_SERV_NOT_ALLOW:
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S23_E13:INFO: MmServiceState is MM_NO_IMSI");
            Mm_ComToNoImsiHandle();                                             /* 调用删除IMSI的公共处理                   */
            g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                 /* 记录前状态                               */
            Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S23_E13:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
        ...
        case NAS_MML_REG_FAIL_CAUSE_GPRS_SERV_NOT_ALLOW_IN_PLMN:
            g_MmGlobalInfo.ucLikeB = MM_TRUE;                                   /* 类似于B模式的全局量                      */
            /*WUEPS_TRACE( MM_LOG_LEVEL_6, " \nMM:MmLikeB is MM_TRUE \r " );    */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S23_E13:INFO: MmLikeB is MM_TRUE");
            break;
        case NAS_MML_REG_FAIL_CAUSE_PLMN_NOT_ALLOW:
        case NAS_MML_REG_FAIL_CAUSE_LA_NOT_ALLOW:
        case NAS_MML_REG_FAIL_CAUSE_ROAM_NOT_ALLOW:
...
VOS_VOID Mm_Cell_S2_E33(VOS_VOID *pRcvMsg )
{
    ...
    {
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S2_E33:WARNING: ulRelCause Abnormal");
    }
}
                    ...
                    )
{
    ...
    switch(g_MmGlobalInfo.ucDetachType)
    {
        ...
        /*<==A32D10964*/
            ...
            Mm_ComSetMmState(MM_STATE_NULL);
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E76:NORMAL: STATUS is  MM_STATE_NULL");
            Mm_TimerStop(MM_TIMER_STOP_ALL);
            Mm_SndRrRelReq(RRC_CELL_UNBARRED);
            if (NAS_MML_NET_RAT_TYPE_GSM == NAS_MML_GetCurrNetRatType())
            {
        ...
        case MM_DETACH_CS_NORMAL:
            ...
            Mm_ComSetMmState(g_MmGlobalInfo.ucPreState);
            PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S25_E76:NORMAL: STATUS is",g_MmGlobalInfo.ucState);
            break;
        default:
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S25_E76:WARNING: Detach type is unexpect.");
            break;
                    ...
                    )
{
    /* WUEPS_ASSERT(0); */
    VOS_UINT8 ucCause;
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S12_E77:WARNING: Wait for RRMM_EST_CNF expired");
                ...
                g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_CC].ucMMConnEstingTI)
    {
        ...
        PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E77:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
    }
    ...
    Mm_TimerStart(MM_TIMER_T3240);
    Mm_ComSetMmState(WAIT_FOR_NETWORK_COMMAND);
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E77:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S14_E77:WARNING: MM_TIMER_PROTECT_SIGNALLING expire at WAIT FOR REESTABLISH(WAIT FOR EST_CNF).");
    ...
    g_MmGlobalInfo.ucPreState   = g_MmGlobalInfo.ucState;               /* 记录迁移之前的状态                       */
    Mm_ComSetMmState(g_MmGlobalInfo.ucStaOfRcvXXEstReq);
    PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S14_E77:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
...
VOS_VOID Mm_Cell_S6_E74(VOS_VOID *pRcvMsg)
{
     ...
     || ( RRC_NAS_T3122_EXPIRE == pRrMmAcInfoChgInd->ulAcChangeInd) )
    {
         ...
         && (VOS_FALSE == ucPsRestrictionFlg))
        {
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S6_E74:NORMAL: STATUS is MM_WAIT_FOR_ATTACH");
        }
        else
        {
            enCsUpdateStatus = NAS_MML_GetCsUpdateStatus();
...
VOS_VOID Mm_Cell_S31_E1(VOS_VOID* pMsg)
{
    if (MM_TRUE == Mm_RcvMmcStartReq(pMsg))
    {
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E1:NORMAL: STATUS is MM_STATE_NULL");
...
VOS_VOID Mm_Cell_S31_E23(VOS_VOID* pMsg)
{
    ...
    if ( MM_STATUS_ATTACHED == g_MmSubLyrShare.MmShare.ucCsAttachState )
    {
        if ( MM_ATT_NOT_NEED == g_MmGlobalInfo.ucAttFlg )
        {
            ...
            g_MmGlobalInfo.ucMmServiceState = MM_NO_SERVICE;                    /* 设置服务状态                             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S31_E23:INFO: MmServiceState is MM_NO_SERVICE");
            Mm_ComNasInfoSav(
                             MM_STATUS_DETACHED,
                             NAS_MML_GetSimCsSecurityCksn());             /* 设置MM信息                               */


            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E23:NORMAL: STATUS is MM_STATE_NULL");
        }
        else
        {
            if ( MM_CS_SIG_CONN_PRESENT == g_MmGlobalInfo.ucCsSigConnFlg )
            {
                ...
                Mm_TimerStart(MM_TIMER_PROTECT_DETACH);
                Mm_ComSetMmState(IMSI_DETACH_INITIATED);
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E23:NORMAL: STATUS is IMSI_DETACH_INITIATED");
            }
            else
            {
                NAS_MM_FillMobileID(&(Msg.MmIeMobileId.MobileID));
                ...
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S31_E23:NORMAL: STATUS is WAIT_FOR_RR_CONNECTION_IMSI_DETACH");
            }
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_WARNING, "Mm_Cell_S13_E79:WARNING: MM_TIMER_PROTECT_CC expire at WAIT FOR REESTABLISH(WAIT FOR REEST REQ).");

    Mm_ComSetMmState(g_MmGlobalInfo.ucStaOfRcvXXEstReq);
    PS_LOG1(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S13_E79:NORMAL: ucState = ", g_MmGlobalInfo.ucState);
                    ...
                    )
{
    ...
    {                                                                           /* 内存申请失败                             */
        ...
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_ERROR, "Mm_Cell_S10_E50:ERROR: MALLOC ERROR!");
        return;                                                                 /* 返回                                     */
    }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E80:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                      */
            /*    " \nMM:STATUS is  WAIT_FOR_NETWORK_COMMAND\r " );             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E81:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAN");
            Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
        }
        else
        {
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SS].aucMMConnExtFlg[0] ) )
            {
                ...
                /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                  */
                /*    " \nMM:STATUS is  WAIT_FOR_NETWORK_COMMAND\r " );         */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E80:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                Mm_TimerStart(MM_TIMER_T3240);                                  /* 启动TIMER3240                            */
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SMS].aucMMConnExtFlg[0] ) )
            {
                ...
                /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                  */
                /*    " \nMM:STATUS is  WAIT_FOR_NETWORK_COMMAND\r " );         */
                PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S10_E81:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
                Mm_TimerStart(MM_TIMER_T3240);                                  /* 启动TIMER3240                            */
                g_MmGlobalInfo.ConnCtrlInfo[MM_CONN_CTRL_SMS].
                                                    aucMMConnExtFlg[1] = 0;
            }
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                      */
            /*    " \nMM:STATUS is  WAIT_FOR_NETWORK_COMMAND\r " );             */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S12_E81:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
            Mm_TimerStart(MM_TIMER_T3240);                                      /* 启动TIMER3240                            */
        }
        else
        {
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S16_E80:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 终止的MM连接建立是正在建立的             */
            ...
            /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                      */
            /*    " \nMM:STATUS is  MM_CONNECTION_ACTIVE\r " );                 */
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S16_E81:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
            Mm_ComCheckDelayMmConn( MM_FALSE );                                 /* 检查是否有保留的需要建立的MM连接         */
        }
        else
        {
                    ...
                    )
{
    ...
    {                                                                           /* 消息检查结果成功                         */
        ...
        {                                                                       /* 没有MM连接存在                           */
            ...
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S16_E66:NORMAL: STATUS is WAIT_FOR_OUTGOING_MM_CONNECTION");
        }
                    ...
                    )
{
    ...
    PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "Mm_Cell_S27_E82:INFO: MM_TIMER_PROTECT_CCBS EXPIRED");
    ...
    {                                                                           /* 没有存在的MM连接 */
        ...
        /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                          */
        /*    " \nMM:STATUS is  WAIT_FOR_NETWORK_COMMAND\r " );                 */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S27_E82:NORMAL: STATUS is WAIT_FOR_NETWORK_COMMAND");
        Mm_TimerStart(MM_TIMER_T3240);                                          /* 启动TIMER3240                            */
    }
    else
    {                                                                           /* 有存在的MM连接 */
        ...
        /*WUEPS_TRACE( MM_LOG_LEVEL_1,                                          */
        /*    " \nMM:STATUS is  MM_CONNECTION_ACTIVE\r " );                     */
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S27_E82:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
    }
}
...
VOS_VOID Mm_Cell_S9_E83(VOS_VOID *pRcvMsg)
{
    ...
    if (MM_EST_SAPI3_SUCCESS == pstEstSapi3Cnf->ucResult)
    {
        ...
        g_MmGlobalInfo.ucPreState       = g_MmGlobalInfo.ucState;  /* 记录迁移之前的状态               */
        Mm_ComSetMmState(MM_CONNECTION_ACTIVE);
        PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "Mm_Cell_S9_E83:NORMAL: STATUS is MM_CONNECTION_ACTIVE");
...
VOS_VOID NAS_MM_ProcInterRatReselInLuProcedure(VOS_VOID)
{
    ...
    if (g_MmGlobalInfo.LuInfo.ucLuAttmptCnt < MM_CONST_NUM_4)
    {
        ...
        {
            g_MmGlobalInfo.ucMmServiceState = MM_NORMAL_SERVICE;
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "NAS_MM_ProcInterRatReselInLuProcedure:INFO: MmServiceState is MM_NORMAL_SERVICE");
            ...
            g_MmGlobalInfo.ucPreState = g_MmGlobalInfo.ucState;                 /* 记录前状态                               */
            Mm_ComSetMmState(MM_IDLE_NORMAL_SERVICE);
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_NORMAL, "NAS_MM_ProcInterRatReselInLuProcedure:NORMAL: STATUS is MM_IDLE_NORMAL_SERVICE");
        ...
        {
            g_MmGlobalInfo.ucMmServiceState = MM_ATTEMPTING_TO_UPDATE;
            PS_LOG(WUEPS_PID_MM, VOS_NULL, PS_PRINT_INFO, "NAS_MM_ProcInterRatReselInLuProcedure:INFO: MmServiceState is MM_ATTEMPTING_TO_UPDATE");
