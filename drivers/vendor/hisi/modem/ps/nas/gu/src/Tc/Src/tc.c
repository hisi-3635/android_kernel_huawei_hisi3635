...
VOS_VOID Tc_SndRrcfTestControlMsg(VOS_UINT32 ulMode)
{
    ...
    {
        /*打印出错信息---申请消息包失败:*/
        PS_LOG(WUEPS_PID_TC, 0, PS_PRINT_ERROR, "Tc_SndRrcfTestControlMsg:ERROR:Allocates a message packet for TC_RRCF_TEST_CONTROL_MSG msg FAIL!");
        return;
    }
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, 0, PS_PRINT_WARNING, "Tc_SndRrcfTestControlMsg:WARNING:Send TC_RRCF_TEST_CONTROL_MSG Msg Fail!");
    }
...
VOS_VOID Tc_SndRfaTestControlMsg(VOS_UINT32 ulMsgName)
{
    ...
    {
        /*打印出错信息---申请消息包失败:*/
        PS_LOG(WUEPS_PID_TC, 0, PS_PRINT_ERROR, "Tc_SndRfaTestControlMsg:ERROR:Allocates a message packet for TC_RFA_CONTROL_MSG msg FAIL!");
        return;
    }
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, 0, PS_PRINT_WARNING, "Tc_SndRfaTestControlMsg:WARNING:Send TC_RFA_CONTROL_MSG Msg Fail!");
    }
...
VOS_VOID Tc_SndMtaResetStoredPosInfoInd(TC_UE_POS_TECH_ENUM_UINT8 enUePosTech)
{
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, 0, PS_PRINT_WARNING, "Tc_SndMtaResetStoredPosInfoInd:WARNING:Send TCMTA_RESET_UE_POS_STORED_INFO_IND Msg Fail!");
    }
...
VOS_VOID Tc_RcvRabmRabInd(VOS_VOID *pMsg)
{
    ...
    {                                                                                   /* 判断RAB的修改模式                        */
        ...
        else
        {
            ...
            {
                PS_LOG2(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvRabmRabInd:WARNING:overflow ulRabCnt ,ulRbCnt :" ,usRabCnt, usRbCnt);
            }
        }
    }
    else
        ...
        {                                                                               /* 更新rab存储信息                          */
            ...
            {                                                                           /* 找到该RAB ID的位置                       */
                ...
                {                                                                       /* 删除该RAB                                */
                    ...
                    {
                        PS_LOG2(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvRabmRabInd:WARNING:overflow ulRabCnt ,ulRbCnt :" ,j + 1, (VOS_INT32)g_TcInfo.TcRabInfo.aRabInfo[j].ulRbCnt);
                    }
                    #endif
                }
                g_TcInfo.TcRabInfo.ulRabCnt --;                                         /* 更新目前的RAB个数                        */
...
VOS_VOID  Tc_SndRlcTcModeInfo(VOS_UINT8 ucTcFlag, VOS_UINT8 ucTcMode)
{
    ...
    {
        /*打印出错信息---申请消息包失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndRlcTcModeInfo:ERROR:Allocates a message packet for TC_RLC_TEST_IND_STRU msg FAIL!");
        return;
    }
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndRlcTcModeInfo:ERROR:Snd TC_RLC_TEST_IND_STRU msg FAIL!");
    }
...
VOS_VOID Tc_RcvCloseLoop(VOS_UINT8 * pRcvTcMsg)
{
    ...
    {                                                                                   /* 没有正在处理其它消息                     */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvCloseLoop:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType ");
        return;
    }
    if( 0 == g_TcInfo.TcRabInfo.ulRabCnt )
    {                                                                                   /* 当前不存在可用的rab                      */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvCloseLoop:WARNING:0 == g_TcInfo.TcRabInfo.ulRabCnt");
        return;
    }
        ...
        {                                                                               /* 判断模式是否是1                          */
            ...
            {                                                                           /* 检查LB中的RB ID是否存在                  */
                ...
                {                                                                       /* LB实体中的RB不存在或者与当前测试的域不同 */
                    PS_LOG1(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING,
...
VOS_VOID Tc_RcvOpenLoop()
{
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {                                                                                   /* 没有正在处理其它消息                     */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvOpenLoop:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    if( 0 == g_TcInfo.TcRabInfo.ulRabCnt )
    {                                                                                   /* 当前不存在可用的rab                      */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvOpenLoop:WARNING:0 == g_TcInfo.TcRabInfo.ulRabCnt");
        return;
    }
...
VOS_VOID Tc_RcvActRbTest()
{
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {                                                                                   /* 没有正在处理其它消息                     */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvActRbTest:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    switch(g_TcInfo.ucTcState)
    {                                                                                   /* 根据当前的状态进行分发                   */
...
VOS_VOID Tc_RcvResetUePosStoredInfo(VOS_UINT8 * pRcvTcMsg)
{
    ...
    switch (enUePosTech)
    {
        ...
        case TC_UE_POS_TECH_AGNSS:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvResetUePosStoredInfo:WARNING:Abnormal Msg!");
            break;
    }
...
VOS_INT32  Tc_SndPhyMsg( VOS_UINT16 usMsgId, VOS_UCHAR *pucStru )
{
    ...
    if ( 0 == ulMsgSize )
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndPhyMsg:WARNING:usMsgId is Abnormal!");
        return VOS_ERR;
    }
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndPhyMsg:ERROR:Alloc msg Error!");
        return VOS_ERR;
    }
...
VOS_VOID Tc_RcvPhyCloseTchLoopCnf(TC_CLOSE_TCH_LOOP_CNF_STRU *pCloseTchLoopCnf)
{
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvPhyCloseTchLoopCnf:WARNING:Abnormal Msg!");
    }
}
...
VOS_VOID Tc_RcvPhyOpenTchLoopCnf(TC_OPEN_TCH_LOOP_CNF_STRU *pOpenTchLoopCnf)
{
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvPhyOpenTchLoopCnf:WARNING:Abnormal Msg!");
    }
}
VOS_VOID Tc_RcvPhyTestInterfaceCnf(TC_TEST_INTERFACE_CNF_STRU *pTestInterfaceCnf)
{
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvPhyTestInterfaceCnf:WARNING:Abnormal Msg!");
    }
}
VOS_VOID Tc_RcvCloseTchLoopCmd(VOS_UCHAR *pRcvTcMsg)
{
    ...
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {                                                                      /*没有正在处理其它消息*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvCloseTchLoopCmd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    {                                                                      /*根据当前的状态进行分发*/
        case TC_NORMAL_MODE:
            ...
            /* Added by wx270776 for tas loop test, 2015-5-15, begin */
            /* 通知MTC环回状态 */
            NAS_TC_SndMtcStatusInfoInd(MTC_NAS_TC_START);
            /* Added by wx270776 for tas loop test, 2015-5-15, end */
            break;

        case TC_GSM_CLOSE_TCH_LOOP:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvCloseTchLoopCmd:WARNING:Ignore this Msg!");
            break;

        default:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_RcvCloseTchLoopCmd:ERROR:g_TcInfo.ucTcState ERROR!");
            break;
    }
    return;
}
VOS_VOID Tc_RcvOpenLoopCmd(VOS_UCHAR *pRcvTcMsg)
{
    ...
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {                                                                      /*没有正在处理其它消息*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvOpenLoopCmd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    {                                                                      /*根据当前的状态进行分发*/
        ...
        case TC_NORMAL_MODE:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvOpenLoopCmd:WARNING:Ignore this Msg!");
            break;
...
VOS_VOID Tc_RcvTestInterface(VOS_UCHAR *pRcvTcMsg)
{
    ...
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {                                                                      /*没有正在处理其它消息*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvTestInterface:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    {                                                                      /*根据当前的状态进行分发*/
        case TC_GSM_CLOSE_TCH_LOOP:
            ...
            break;
        case TC_NORMAL_MODE:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvTestInterface:WARNING:Ignore this Msg!");
            break;
        default:
            break;
    }
...
VOS_UINT32  Tc_SndGrmGtmSetupReq(VOS_UCHAR *pMsg)
{
    ...
    {
        /*打印出错信息---申请消息包失败*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndGrmGtmSetupReq:ERROR:Alloc msg Fail!");
        return VOS_ERR;
    }
    /*填写消息头*/
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndGrmGtmSetupReq:WARNING:SEND GRM_GTM_SETUP_REQ msg FAIL!");
        return VOS_ERR;
    }
    else
    {
        /*打印流程信息---发送了消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_NORMAL, "Tc_SndGrmGtmSetupReq:NORMAL:SEND GRM_GTM_SETUP_REQ Msg Success.");
...
VOS_VOID  Tc_SndGrmGtmRelRsp(VOS_VOID)
{
    ...
    {
        /*打印出错信息---申请消息包失败*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndGrmGtmRelRsp:ERROR:Alloc msg Fail!");
        return;
    }
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndGrmGtmRelRsp:WARNING:SEND GRM_GTM_REL_RSP msg FAIL!");
    }
    else
    {
        /*打印流程信息---发送了消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_NORMAL, "Tc_SndGrmGtmRelRsp:NORMAL:SEND GRM_GTM_REL_RSP Msg Success.");
    }
...
VOS_VOID  Tc_RcvGrmGtmSetupCnf(VOS_UCHAR *pMsg)
{
         ...
         && (TC_GPRS_TEST_MODE_CMD == g_TcInfo.ucMsgType) )
    {
        ...
        {
            /*打印警告信息---GPRS环回建立失败:*/
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmSetupCnf:WARNING:GPRS TC setup FAIL!");
    ...
    {
        /*打印警告信息---接收了不合逻辑的消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmSetupCnf:WARNING:RECEIVE An Illogic Msg!");
    }
...
VOS_VOID  Tc_RcvGrmGtmRelInd(VOS_VOID)
{
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmRelInd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmRelInd:WARNING:Illogic State when receive TC_GTM_REL_IND Msg!");
    }
...
VOS_VOID  Tc_RcvGrmMsgHandle(struct MsgCB *pMsg)
{
    ...
    switch ( pRcvMsg->usMsgType )
    {
        ...
        case ID_GTM_TC_SRB_REL_IND:
            ...
            break;
        default:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmMsgHandle:WARNING:Msg type Error!");
            break;
    }
...
VOS_VOID  Tc_RcvGprsTestModeCmd(VOS_UCHAR *pRcvTcMsg)
{
    ...
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGprsTestModeCmd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    switch(g_TcInfo.ucTcState)
    {
        ...
        case TC_GPRS_CLOSE_TCH_LOOP:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGprsTestModeCmd:WARNING:Ignore this Msg!");
            break;
        default:
            break;
    }
...
)
{
    ...
    {
        /*打印出错信息---申请消息包失败*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndGrmGtmEgprsSetupReq:ERROR:Alloc msg Fail!");
        return VOS_ERR;
    }
    /*填写消息头*/
    pSetupReqMsg->ulSenderCpuId     = VOS_LOCAL_CPUID;
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndGrmGtmEgprsSetupReq:WARNING:SEND TC_GTM_SRB_SETUP_REQ_MSG msg FAIL!");
        return VOS_ERR;
    }
    else
    {
        /*打印流程信息---发送了消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_NORMAL, "Tc_SndGrmGtmEgprsSetupReq:NORMAL:SEND TC_GTM_SRB_SETUP_REQ_MSG Msg Success.");
...
VOS_VOID  Tc_SndGrmGtmEgprsRelRsp(VOS_VOID)
{
    ...
    {
        /*打印出错信息---申请消息包失败*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_ERROR, "Tc_SndGrmGtmEgprsRelRsp:ERROR:Alloc msg Fail!");
        return;
    }
    ...
    {
        /*打印警告信息---发送消息失败:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_SndGrmGtmEgprsRelRsp:WARNING:SEND ID_TC_GTM_SRB_REL_RSP msg FAIL!");
    }
    else
    {
        /*打印流程信息---发送了消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_NORMAL, "Tc_SndGrmGtmEgprsRelRsp:NORMAL:SEND ID_TC_GTM_SRB_REL_RSP Msg Success.");
    }
...
VOS_VOID  Tc_RcvGrmGtmEgprsSetupCnf(VOS_UCHAR *pMsg)
{
         ...
         && (TC_EGPRS_START_RADIO_BLOCK_LOOPBACK_CMD == g_TcInfo.ucMsgType) )
    {
        ...
        {
            /*打印警告信息---EGPRS环回建立失败:*/
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmEgprsSetupCnf:WARNING:EGPRS TC setup FAIL!");
    ...
    {
        /*打印警告信息---接收了不合逻辑的消息:*/
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmEgprsSetupCnf:WARNING:RECEIVE An Illogic Msg!");
    }
...
VOS_VOID  Tc_RcvGrmGtmEgprsRelInd(VOS_VOID)
{
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmEgprsRelInd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGrmGtmEgprsRelInd:WARNING:Illogic State when receive ID_GTM_TC_SRB_REL_IND Msg!");
    }
...
)
{
    ...
    if(TC_MSG_INVALID != g_TcInfo.ucMsgType)
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvEgprsLoopBackCmd:WARNING:TC_MSG_INVALID != g_TcInfo.ucMsgType");
        return;
    }
    ...
    switch(g_TcInfo.ucTcState)
    {
        ...
        case TC_EGPRS_CLOSE_TCH_LOOP:
            PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvEgprsLoopBackCmd:WARNING:Ignore this Msg!");
            break;
        default:
            break;
    }
...
VOS_VOID Tc_RcvMmDataInd(VOS_VOID *pMsg)
{
    ...
    {                                                                                   /* 消息过短                                 */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvMmDataInd:WARNING:2 > pRcvMsg->RcvTcMsg.ulTcMsgSize");
        return;
    }
    if(( 0x0F != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0x0F)) &&
       ( 0    != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0xF0)))
    {                                                                                   /* PD为f和SI为0，可以分发处理               */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvMmDataInd:WARNING:( 0x0F != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0x0F)) &&( 0    != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0xF0))");
        return;
    }
...
VOS_VOID Tc_RcvGmmDataInd(VOS_VOID *pMsg)
{
   ...
   /* added by gaoming for A32D00546 begin */
    if( 2 > pRcvMsg->RcvTcMsg.ulTcMsgSize )
    {                                                                                   /* 消息过短                                 */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGmmDataInd:WARNING:2 > pRcvMsg->RcvTcMsg.ulTcMsgSize");
        return;
    }
    if(( 0x0F != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0x0F)) &&
       ( 0    != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0xF0)))
    {                                                                                   /* PD为f和SI为0，可以分发处理               */
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_RcvGmmDataInd:WARNING:( 0x0F != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0x0F)) &&( 0    != ( pRcvMsg->RcvTcMsg.aucTcMsg[0] & 0xF0))");
        return;
    }
...
VOS_VOID Tc_TaskEntry (struct MsgCB * pRcvMsg)
{
    ...
    {
        PS_LOG(WUEPS_PID_TC, VOS_NULL, PS_PRINT_WARNING, "Tc_TaskEntry:WARNING:The Entry Pointer is NULL!");
        return;
    }
...
)
{
    ...
    switch(g_TcInfo.ucTcState)
    {
        ...
        /* Added by wx270776 for tas loop test, 2015-5-18, begin */
        case TC_GSM_CLOSE_TCH_LOOP:
        case TC_GPRS_CLOSE_TCH_LOOP:
            /* 通知MTC环回测试停止 */
            NAS_TC_SndMtcStatusInfoInd(MTC_NAS_TC_STOP);
            break;
        /* Added by wx270776 for tas loop test, 2015-5-18, end */
...
/* Added by wx270776 for tas loop test, 2015-5-5, begin */
/*****************************************************************************
...
/* Added by wx270776 for tas loop test, 2015-5-5, end */
