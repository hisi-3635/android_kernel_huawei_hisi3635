...
VOS_VOID  NAS_MMC_DelPlmnSelectionRatInfoInDisabledPlmnWithValidPeriodList (
    NAS_MMC_PLMN_SELECTION_PLMN_INFO_STRU                  *pstPlmn,
    VOS_UINT32                                              ulPlmnNum,
    NAS_MML_DISABLED_PLMN_WITH_VALID_PERIOD_STRU           *pstPlmnIdList
)
{
    VOS_UINT32                          i;
    VOS_UINT8                           j;
...
VOS_VOID NAS_MMC_ConvertToMmaSrvStatus(
    NAS_MMC_SERVICE_ENUM_UINT8          enMmcServiceState,
    MMA_MMC_SERVICE_STATUS_ENUM_UINT32  *penMmaServiceState
)
{
    switch(enMmcServiceState)
    {
        case NAS_MMC_NO_SERVICE:
            *penMmaServiceState = MMA_MMC_SERVICE_STATUS_NO_SERVICE;
            break;
        case NAS_MMC_NORMAL_SERVICE:
            *penMmaServiceState = MMA_MMC_SERVICE_STATUS_NORMAL_SERVICE;
            break;
        case NAS_MMC_LIMITED_SERVICE:
            *penMmaServiceState = MMA_MMC_SERVICE_STATUS_LIMITED_SERVICE;
            break;
        case NAS_MMC_LIMITED_SERVICE_REGION:
            *penMmaServiceState = MMA_MMC_SERVICE_STATUS_LIMITED_SERVICE_REGION;
            break;
        default:
            *penMmaServiceState = MMA_MMC_SERVICE_STATUS_BUTT;
            break;
    }
...
)
{
    ...
    MMA_MMC_SERVICE_STATUS_ENUM_UINT32  enMmaServiceState;
    ...
    NAS_MMC_ConvertToMmaSrvStatus(enServiceState, &enMmaServiceState);

    NAS_MMC_SndMmaServiceStatusInd(ulCnDomainId,  enMmaServiceState);
