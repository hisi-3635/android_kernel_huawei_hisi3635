                    ...
                    )
{
    ...
    /*lint +e701*/
    {                                                                           /* 该timer已经启动                          */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerStart:WARNING: This Timer has been started");
        return;                                                                 /* 返回                                     */
    }
    ...
    {                                                                           /* T3302或T3312                             */
        ...
        {                                                                       /* T3302或T3312时长为0                      */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_NORMAL, "Gmm_TimerStart:NORMAL: Timer Length of T3302 or T3312 is 0");
            return;                                                             /* 返回                                     */
        }
    }
    ...
    if (VOS_OK != ulResult)
    {                                                                                         /* 启动失败                                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "Gmm_TimerStart:ERROR: Start timer unsuccessfully");
        return;                                                                               /* 返回                                     */
    }
    ...
    /*lint -e701*/
    g_GmmTimerMng.ulTimerRunMask |= (0x00000001 << ucTimerId);                  /* 置Timer的启动标志                        */
    ...
    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerStart:INFO: StartTimer: ", ucTimerId);
    ...
    {                                                                           /* 判断定时器类型                           */
        case GMM_TIMER_ALL:
            ...
            for (i = 0; i < GMM_TIMER_NUM; i ++)
            {
                ...
                /*lint -e701*/
                if (0 != (g_GmmTimerMng.ulTimerRunMask & (0x00000001 << i)))
                /*lint +e701*/
                {                                                                   /* 该定时器已经启动                         */
                    ...
                    {                                                               /* 停止失败：已经停止或Timer不存在          */
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerStop:WARNING: Stop all timer unsuccessfully");
                        return;                                                     /* 返回                                     */
                    }
                    /*lint -e701*/
                    g_GmmTimerMng.ulTimerRunMask &= ~(VOS_UINT32)(0x00000001 << i);             /* 清Timer的启动标志                        */

                    g_GmmTimerMng.ulTimerSusMask &= ~(VOS_UINT32)(0x00000001 << i);             /* 清Timer的挂起标志                        */
                    /*lint +e701*/

                    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerStop:INFO: StopTimer: ", i);
        ...
        case GMM_REGSTER_AND_SHUTDOWN_TIMER:
            for (i = 0; i < GMM_TIMER_NUM; i ++)
            {
                ...
                {                                                                   /* 该定时器已经启动                         */
                    ...
                    gstGmmSuspendCtrl.ulTimerRunMask &= ~(VOS_UINT32)(0x00000001 << i);
                    /*lint +e701*/
                    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerStop:INFO: StopTimer: ", i);
        ...
        case GMM_TIMER_T3312:
            ...
            {                                                                       /* Timer在启动中                            */
                ...
                {                                                                   /* 停止失败：已经停止或Timer不存在          */
                    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerStop:WARNING: Stop timer unsuccessfully");
                    return;                                                         /* 返回                                     */
                }
                /*lint -e701*/
                ...
                g_GmmTimerMng.ulTimerSusMask &= ~(VOS_UINT32)(0x00000001 << ucTimerId); /* 清Timer的挂起标志                        */
                /*lint +e701*/
                PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerStop:INFO: StopTimer: ", ucTimerId);
    ...
    for (i = 0; i < GMM_TIMER_NUM; i ++)
    {
        ...
        {                                                                   /* 该定时器已经启动                         */
            ...
            if (VOS_ERRNO_RELTM_STOP_TIMERINVALID ==
                Mm_StopRelTimer(WUEPS_PID_GMM, i, &g_GmmTimerMng.aTimerInf[i].hTimer))
            {                                                               /* 停止失败：已经停止或Timer不存在          */
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_TimerStopExceptSpecialTimers:WARNING: Stop all timer unsuccessfully");
                return;                                                     /* 返回                                     */
            }
            /*lint -e701*/
            g_GmmTimerMng.ulTimerRunMask &= ~(VOS_UINT32)(0x00000001 << i);             /* 清Timer的启动标志                        */
            ...
            g_GmmTimerMng.ulTimerSusMask &= ~(VOS_UINT32)(0x00000001 << i);             /* 清Timer的挂起标志                        */
            /*lint +e701*/
            PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "NAS_GMM_TimerStopExceptSpecialTimers:INFO: StopTimer: ", i);
                    ...
                    )
{
    ...
    {                                                                           /* 该timer已经启动                          */
        ...
        if( VOS_ERRNO_RELTM_STOP_TIMERINVALID ==
                    Mm_StopRelTimer(WUEPS_PID_GMM, ucTimerId, &g_GmmTimerMng.aTimerInf[ucTimerId].hTimer))
        {                                                                       /* 暂停失败                                 */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerPause:WARNING: Stop timer unsuccessfully");
            return;                                                             /* 返回                                     */
        }
        /*lint -e701*/
        g_GmmTimerMng.ulTimerSusMask |= (0x00000001 << ucTimerId);              /* 设置Timer的挂起标志                      */
        /*lint +e701*/
    }
    else
    {                                                                           /* 该timer未启动                            */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerPause:WARNING: Timer is not running");
        return;                                                                 /* 返回                                     */
    }
}
                      ...
                      )
{
    ...
    if (0 != ( g_GmmTimerMng.ulTimerRunMask & (0x00000001 << ucTimerId)))
    {                                                                           /* 该timer启动                              */
        if (0 == (g_GmmTimerMng.ulTimerSusMask & (0x00000001 << ucTimerId)))
        {                                                                       /* 该Timer未被挂起                          */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerResume:WARNING: This timer has been Stoped");
            return;                                                             /* 返回                                     */
        }
        ...
        {                                                                       /* 恢复失败                                 */
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerResume:WARNING: Start timer unsuccessfully");
            return;                                                             /* 返回                                     */
        }
    ...
    {                                                                           /* 该timer未启动                            */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerResume:WARNING: Timer is not running");
        return;                                                                 /* 返回                                     */
    }
    /*lint +e701*/
}
    ...
    for (i = 0; i < GMM_TIMER_NUM; i ++)
    {
        ...
        /*lint +e701*/
        {
            ...
            */
            ...
            {
                /*lint -e701*/
                g_GmmTimerMng.ulTimerRunMask |= (0x00000001 << i);
                /*lint +e701*/
            }
        }
    }
...
VOS_VOID Gmm_Tim3302Expired(VOS_VOID)
{
    ...
    case GMM_REGISTERED_UPDATE_NEEDED:
        ...
        break;                                                                  /* 跳出                                     */
    default:                                                                    /* 其他情况                                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Tim3302Expired:WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
        break;                                                                  /* 跳出                                     */
    }
}
...
VOS_VOID Gmm_Tim3310Expired(VOS_VOID)
{
    ...
    {                                                                           /* 判断GMM状态是GMM_REGISTERED_INITIATED    */
        ...
        {                                                                       /* 判断ucT3310OutCnt 大于 5                 */
            ...
            PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Tim3310Expired:INFO: specific procedure ended");
        }
    }
    return;                                                                     /* 返回                                     */
}
...
VOS_VOID Gmm_Tim3311Expired(VOS_VOID)
{
    ...
    default:                                                                    /* 其他情况                                 */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Tim3311Expired:WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
        break;                                                                  /* 跳出                                     */
    }
}
VOS_VOID Gmm_Tim3312Expired(VOS_VOID)
{
    ...
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Tim3312Expired:INFO:T3312 Expire.");
    GMM_PrintState();
...
VOS_VOID Gmm_Tim3317Expired(VOS_VOID)
{
    ...
    {                                                                           /* 判断当前状态是SERVICE_REQUEST_INITIATED  */
        ...
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_Tim3317Expired:INFO: specific procedure ended");
    }
}
...
VOS_VOID Gmm_Tim3321Expired(VOS_VOID)
{
    ...
    case GMM_REGISTERED_IMSI_DETACH_INITIATED:
        ...
        break;                                                                  /* 跳出                                     */
    default:                                                                    /* 其他情况                                 */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_Tim3321Expired:WARNING: g_GmmGlobalCtrl.ucState is Abnormal");
        break;                                                                  /* 跳出                                     */
    }
}
...
{
    /* 删除缓存的CS域DETACH */
    NAS_GMM_DeleteSavedDetachMsg(GMM_WAIT_CS_DETACH);
...
VOS_VOID Gmm_Tim3330Expired(VOS_VOID)
{
    ...
    {                                                                           /* 判断当前状态                             */
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "g_GmmGlobalCtrl.ucState:WARNING: g_GmmGlobalCtrl.ucState is not GMM_ROUTING_AREA_UPDATING_INITIATED");
        return;                                                                 /* 返回                                     */
    }
    ...
    {                                                                           /* 判断次数                                 */
        ...
        else
        {
             ...
             && (GMM_RAU_COMBINED != g_GmmGlobalCtrl.ucSpecProc))
            {
                ...
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "g_GmmGlobalCtrl:WARNING: g_GmmGlobalCtrl.ucSpecProc is Abnormal");
                return;                                                         /* 跳出                                     */
            }
...
{
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimProtectExpired:WARNING: Protected Timer is expired");
                         ...
                         )
{
    ...
    if (GMM_TIMER_ALL == ucTimerId)
    {
        ...
        {                                                                       /* 循环查找所有TIMER                        */
            if (0 != (g_GmmTimerMng.ulTimerRunMask & (0x00000001 << i)))
            {                                                                   /* 该定时器已经启动                         */
                if (0 == (g_GmmTimerMng.ulTimerSusMask & (0x00000001 << i)))
                {                                                               /* 该定时器没有被挂起                       */
                    if (VOS_ERRNO_RELTM_STOP_TIMERINVALID ==
                           Mm_StopRelTimer(WUEPS_PID_GMM, i, &g_GmmTimerMng.aTimerInf[i].hTimer))
                    {                                                           /* 停止失败：已经停止或Timer不存在          */
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerPauseForTc:WARNING: Stop all timer unsuccessfully");
                        return;                                                 /* 返回                                     */
                    }
                    g_GmmTimerMng.ulTimerSusTcMask |= (0x00000001 << i);        /* 置Timer的挂起标志(TC)                    */
                    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerPauseForTc:INFO: StopTimer: ",i);
                }
            }
        }
    }
    else if (0 != ( g_GmmTimerMng.ulTimerRunMask & ( 0x00000001 << ucTimerId)))
    {                                                                           /* 该timer已经启动                          */
        if ((0 == (g_GmmTimerMng.ulTimerSusTcMask & (0x00000001 << ucTimerId)))
            &&(0 == (g_GmmTimerMng.ulTimerSusMask & (0x00000001 << ucTimerId))))
        {
            if( VOS_ERRNO_RELTM_STOP_TIMERINVALID ==
                 Mm_StopRelTimer(WUEPS_PID_GMM, ucTimerId, &g_GmmTimerMng.aTimerInf[ucTimerId].hTimer))
            {                                                                   /* 暂停失败                                 */
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerPauseForTc:WARNING: Stop timer unsuccessfully");
                return;                                                         /* 返回                                     */
            }
            g_GmmTimerMng.ulTimerSusTcMask |= (0x00000001 << ucTimerId);        /* 设置Timer的挂起标志                      */
            PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerPauseForTc:INFO: StopTimer: ",ucTimerId);
        }
    }
    else
    {
                          ...
                          )
{
    ...
    if (GMM_TIMER_ALL == ucTimerId)
    {
        ...
        {                                                                       /* 循环查找所有TIMER                        */
            if (0 != (g_GmmTimerMng.ulTimerRunMask & (0x00000001 << i)))
            {                                                                   /* 该定时器已经启动                         */
                if (0 != (g_GmmTimerMng.ulTimerSusTcMask & (0x00000001 << i)))
                {                                                               /* 该定时器已经挂起                         */
                    ...
                    {                                                           /* 恢复失败                                 */
                        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerResumeForTc:WARNING: Start all timer unsuccessfully");
                        return;                                                 /* 返回                                     */
                    }
                    g_GmmTimerMng.ulTimerSusTcMask
                        &= ~(VOS_UINT32)(0x00000001 << i);      /* 清Timer的挂起标志                        */
                    PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerResumeForTc:INFO: StartTimer: ",i);
                }
            }
        }
    }
    ...
    {                                                                           /* 该timer已经启动                          */
        if (0 != (g_GmmTimerMng.ulTimerSusTcMask & (0x00000001 << ucTimerId)))
        {
            ...
            {                                                                   /* 恢复失败                                 */
                PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimerResumeForTc:WARNING: Start timer unsuccessfully");
                return;                                                         /* 返回                                     */
            }
            g_GmmTimerMng.ulTimerSusTcMask
                &= ~(VOS_UINT32)(0x00000001 << ucTimerId);      /* 设置Timer的挂起标志                      */
            PS_LOG1(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_INFO, "Gmm_TimerResumeForTc:INFO: StartTimer: ",ucTimerId);
        }
    }
    else
    {
...
{
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_TimProtectForSignalingExpired:WARNING: Protected timer for signalling is expired");
...
VOS_VOID GMM_TimProtectForRrRel()
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "GMM_TimProtectForRrRel:WARNING: Gmm State is unexpected.");
        return;
    }
...
{
    PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "NAS_GMM_TimerWaitConnectRelExpired:WARNING: Wait connect rel expired.");
