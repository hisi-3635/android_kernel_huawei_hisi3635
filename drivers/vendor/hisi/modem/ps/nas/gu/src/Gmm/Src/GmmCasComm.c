...
VOS_VOID GMM_CasRcvUsimCnfUmtsSucc(USIMM_TELECOM_AUTH_CNF_STRU *pAuthCnf)
{
    ...
    {/* 3G USIM */
        Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_KEY);    /* 更新SIM中的CKSN,Ck,IK*/
        Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_PS_KEY_GPRS);   /* 更新SIM中的GSM CKSN,Kc*/
    }
    else
    {/* 2G SIM */
        Gmm_SndAgentUsimUpdateFileReq(GMM_USIM_FILE_KC_KEY_GPRS);   /* 更新SIM中的GSM CKSN,Kc*/
    }
...
VOS_UINT32 GMM_SaveGsmSysInfoIndMsgPara(MMCGMM_GSM_SYS_INFO_IND_ST *pSysInfo)
{
    ...
    {
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_ERROR, "GMM_SaveGsmSysInfoIndMsgPara:ERROR: MALLOC FAIL!");
...
VOS_VOID GMM_CreateNewTlli(VOS_UINT32 *pulTmsi, VOS_UINT8 ucType)
{
    ...
    switch (ucType)
    {
        case GMM_RANDOM_TLLI:
            ...
            ulTLLI   = OM_GetSlice();   /* 取系统时钟数作为伪随机数 */
            break;
...
VOS_UINT32 GMM_FreeOldTlli(VOS_VOID)
{
...
VOS_UINT32 GMM_FreeSysTlli(VOS_VOID)
{
    LL_GMM_ASSIGN_REQ_MSG   *pAssignReqMsg;
    VOS_UINT32               ulRet;
...
VOS_UINT32 GMM_AssignSysTlli(VOS_VOID)
{
    LL_GMM_ASSIGN_REQ_MSG   *pAssignReqMsg;
    GRRGMM_ASSIGN_REQ_ST    *pGasAssignMsg;
...
VOS_UINT32 GMM_AssignGsmKc(VOS_VOID)
{
    LL_GMM_ASSIGN_REQ_MSG   *pAssignReqMsg;
    VOS_UINT32               ulRet;
...
VOS_UINT32 GMM_RcvGsmPagingAtRegNmlServ(GRRMM_PAGING_IND_ST *pMsg)
{
...
/*****************************************************************************
 ...
 History        :
  1.Date        : 2005-11-03
    ...
    Modification: Created function
*****************************************************************************/
VOS_UINT32 GMM_RcvGsmPagingAtDeregInit(GRRMM_PAGING_IND_ST *pMsg)
{
...
/*****************************************************************************
 ...
 History        :
  1.Date        : 2005-11-03
    ...
    Modification: Created function
*****************************************************************************/
VOS_UINT32 GMM_RcvGsmPagingAtRauInit(GRRMM_PAGING_IND_ST *pMsg)
{
    GRRMM_PAGING_IND_ST    *pMsgHold;
...
VOS_UINT32 GMM_RcvGsmPaging_RegPlmnSrch(GRRMM_PAGING_IND_ST *pMsg)
{
    if (GAS_IMSI != pMsg->ucMSIDType)
    {
...
VOS_UINT8 GMM_AuthType(VOS_UINT8 ucAutnFlag)
{
    ...
    {
        usAuthTypeRet = GMM_AUTH_FAILURE;
        PS_LOG(WUEPS_PID_GMM, VOS_NULL, PS_PRINT_WARNING, "Gmm_RcvAuthenAndCipherRequestMsg:WARNING: perform the GSM authentication challenge");
    }
