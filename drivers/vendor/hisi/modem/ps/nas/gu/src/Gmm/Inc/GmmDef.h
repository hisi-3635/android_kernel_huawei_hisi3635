...
#define LTE_NAS_INTER_RAT_UETRAN_CAP_LEN                   (128)  /* EUTRAN CAPBALITY 长度,最长128字节 */
...
#define GMM_ATTACH_ACCEPT_IE_PTMSI_SIGNATURE_FLG   \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_PTMSI_SIGNATURE)
#define GMM_ATTACH_ACCEPT_IE_READY_TIMER_FLG       \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_READY_TIMER)
#define GMM_ATTACH_ACCEPT_IE_PTMSI_FLG             \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_PTMSI)
#define GMM_ATTACH_ACCEPT_IE_MS_IDENTITY_FLG       \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_MS_IDENTITY)
#define GMM_ATTACH_ACCEPT_IE_GMM_CAUSE_FLG         \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_GMM_CAUSE)
#define GMM_ATTACH_ACCEPT_IE_T3302_VALUE_FLG       \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_T3302_VALUE)
#define GMM_ATTACH_ACCEPT_IE_CELL_NOTIFICATION_FLG \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_CELL_NOTIFICATION)
#define GMM_ATTACH_ACCEPT_IE_EQUIVALENT_PLMN_FLG   \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_EQUIVALENT_PLMN)
#define GMM_ATTACH_ACCEPT_IE_EMERGENCY_NUMBER_LIST_FLG   \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_EMERGENCY_NUMBER_LIST)
#define GMM_ATTACH_ACCEPT_IE_REQUESTED_MS_INFORMATION_FLG   \
      (VOS_UINT16)(0x01<<GMM_ATTACH_ACCEPT_IE_REQUESTED_MS_INFORMATION)

#define GMM_ATTACH_ACCEPT_IE_T3323_VALUE_FLG   \
      (VOS_UINT16)(0x01 << NAS_GMM_ATTACH_ACCEPT_IE_T3323_VALUE)


/*==================RAU ACCEPT消息中可选IE是否存在的宏定义====================*/
#define GMM_RAU_ACCEPT_IE_PTMSI_SIGNATURE_FLG      \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_PTMSI_SIGNATURE)
#define GMM_RAU_ACCEPT_IE_PTMSI_FLG                \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_PTMSI)
#define GMM_RAU_ACCEPT_IE_MS_IDENTITY_FLG          \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_MS_IDENTITY)
#define GMM_RAU_ACCEPT_IE_NPDU_NUMBER_FLG          \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_NPDU_NUMBER)
#define GMM_RAU_ACCEPT_IE_READY_TIMER_FLG          \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_READY_TIMER)
#define GMM_RAU_ACCEPT_IE_GMM_CAUSE_FLG            \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_GMM_CAUSE)
#define GMM_RAU_ACCEPT_IE_T3302_VALUE_FLG          \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_T3302_VALUE)
#define GMM_RAU_ACCEPT_IE_CELL_NOTIFICATION_FLG    \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_CELL_NOTIFICATION)
#define GMM_RAU_ACCEPT_IE_EQUIVALENT_PLMN_FLG      \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_EQUIVALENT_PLMN)

#define GMM_RAU_ACCEPT_IE_PDP_CONTEXT_STATUS_FLG      \
      (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_PDP_CONTEXT_STATUS)
#define GMM_RAU_ACCEPT_IE_NETWORK_FEATURE_SURPORT_FLG      \
          (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_NETWORK_FEATURE_SURPORT)
#define GMM_RAU_ACCEPT_IE_EMERGENCY_NUMBER_LIST_FLG      \
          (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_EMERGENCY_NUMBER_LIST)
#define GMM_RAU_ACCEPT_IE_REQUESTED_MS_INFORMATION_FLG      \
          (VOS_UINT16)(0x01<<GMM_RAU_ACCEPT_IE_REQUESTED_MS_INFORMATION)

#define GMM_RAU_ACCEPT_IE_T3323_VALUE_FLG          \
      (VOS_UINT16)(0x01<<NAS_GMM_RAU_ACCEPT_IE_T3323_VALUE)
