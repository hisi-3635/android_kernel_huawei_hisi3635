...
VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsg3440Exp(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru)
{
    (VOS_VOID)ulMsgId;
...
VOS_UINT32  NAS_EMM_MsRrcConnRelInitSsWaitRrcRelMsgReattachDelayTmrExp(VOS_UINT32 ulMsgId, VOS_VOID *pMsgStru)
{
    (VOS_VOID)ulMsgId;
    (VOS_VOID)pMsgStru;
