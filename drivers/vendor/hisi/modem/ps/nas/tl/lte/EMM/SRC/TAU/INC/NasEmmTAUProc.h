...
extern VOS_VOID  NAS_EMM_TAU_SpecialRelCauseCollisionProc
(
    NAS_LMM_SEND_TAU_RESULT_ACT_FUN     pfTauRslt,
    const VOS_VOID                     *pvPara,
...
extern VOS_VOID  NAS_EMM_TAU_RelCause1315CollisionProc
(
    NAS_LMM_SEND_TAU_RESULT_ACT_FUN     pfTauRslt,
    const VOS_VOID                     *pvPara
);
...
extern VOS_UINT32 NAS_EMM_TAU_CHKFSMStateMsgp(
                                    ...
                                    NAS_EMM_SUB_STATE_ENUM_UINT16   stSS,
                                    VOS_VOID   *pMsgStru);
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue367(VOS_VOID );
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue9(VOS_VOID );
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue10(VOS_VOID );
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue11( VOS_VOID);
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue12(VOS_VOID );
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue13( VOS_VOID);
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue14( VOS_VOID);
extern VOS_VOID   NAS_EMM_TAU_TAUReqRejectCasue15( VOS_VOID);
...
#if 0
extern VOS_VOID NAS_EMM_TAU_ProcTauAcpCauseValOther
(
...
extern VOS_VOID NAS_EMM_TAU_ProcTauAcpCauseVal161722
(
    VOS_VOID                           *pstRcvMsg
);
...
extern MMC_LMM_TAU_TYPE_ENUM_UINT32 NAS_EMM_TAU_GetEpsUpdateType
(
