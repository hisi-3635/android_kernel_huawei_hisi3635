...
typedef struct
{
    ...
    NAS_ESM_PDN_REQ_TYPE_ENUM_UINT8     enPdnReqType;       /* EMM指定的PDN连接请求类型，目前仅在CL多模场景使用 */
    VOS_UINT8                           rsv[3];
...
#if 0
extern VOS_VOID  NAS_ESM_WritePdpManInfoToNv( VOS_VOID );

extern VOS_VOID  NAS_ESM_ReadPdpManInfoFromNv( VOS_VOID );
#endif
