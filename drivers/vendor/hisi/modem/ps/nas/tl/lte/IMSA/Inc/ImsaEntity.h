...
{
    IMSA_SRV_DEREG_CAUSE_MMA_DEREG_REQ      = 0x0000,
...
typedef struct
{
    ...
    VOS_UINT8                           ucIsCmccTcallTimeOutProc;/**< 记录是否在Tcall超时处理过程中,CMCC定制*/
    ...
    IMSA_TIMER_STRU                     stCMCCTcallTimer;  /* Tcall SilentRedial定时器,CMCC定制 */
                                                           /* Tqos SilentRedial定时器重用stResReadyTimer,CMCC定制*/
...
typedef struct
{
    ...
    VOS_UINT32                          ulIsNrmCallSrvStatusChanged;     /**< 普通呼叫服务状态是否改变，IMSA_TRUE表示改变，IMSA_FALSE表示未改变 */
    VOS_UINT32                          ulIsEmcCallSrvStatusChanged;     /**< 紧急呼叫服务状态是否改变，IMSA_TRUE表示改变，IMSA_FALSE表示未改变 */
    #endif
...
typedef struct
{
    ...
    IMSA_IP_ADDRESS_STRU                stSourceIpaddr;
    IMSA_IP_ADDRESS_STRU                stSourceIpMask;
...
#define IMSA_GetLastEmcCallSrvStatus()      (pgstImsaEntity->stImsaControlManager.ulIsNrmCallSrvStatusChanged)
#define IMSA_GetIsNrmCallSrvStatusChanged() (pgstImsaEntity->stImsaControlManager.enLastNrmCallSrvStatus)
#define IMSA_GetIsEmcCallSrvStatusChanged() (pgstImsaEntity->stImsaControlManager.enLastEmcCallSrvStatus)
#endif
