...
typedef struct
{
    ...
    VOS_UINT8                           aucSrcBuf[LRRC_LNAS_MAX_DATA_LENGTH]; /*消息加保护或者解保护操作中的源空间*/
    VOS_UINT8                           aucDstBuf[LRRC_LNAS_MAX_DATA_LENGTH]; /*消息加保护或者解保护操作中的目的空间*/
...
extern VOS_VOID NAS_LMM_PreProcAnyStateUsimAuthCnf(const USIMM_AUTH_CNF_STRU  *pstUsimAuthCnf);
