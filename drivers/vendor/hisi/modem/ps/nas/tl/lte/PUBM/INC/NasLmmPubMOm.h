...
enum    NAS_EMM_OM_MSG_ENUM
{
    ...
    ID_NAS_EMM_OM_TIMER_MSG_MAX = PS_MSG_ID_EMM_TO_EMM_OM_BASE + NAS_LMM_PTL_TI_BUTT,


    ID_NAS_EMM_OM_DAM_PARA_LOG          = ID_NAS_EMM_OM_TIMER_MSG_MAX  + 0x01,  /* 美国需求DAM相关的EMM OM信息 */
    ID_NAS_EMM_OM_COMM_CONFIG_PARA_LOG  = ID_NAS_EMM_OM_TIMER_MSG_MAX  + 0x02,  /* LMM定制需求公共NV参数OM输出 */
    ID_NAS_EMM_OM_REJ19_CNT_LOG         = ID_NAS_EMM_OM_TIMER_MSG_MAX  + 0x03,  /* LMM输出REJ#19计数           */


    ID_NAS_EMM_OM_DEBUG_INFO_LOG        = PS_MSG_ID_EMM_TO_EMM_OM_BASE + 0x5F,  /* 雷显调增加的调试信息        */
