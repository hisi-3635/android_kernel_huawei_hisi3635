...
/* REGISTER DOMAIN */
#define NAS_LMM_GetEmmInfoRegDomain()               ((NAS_LMM_GetEmmInfoAddr())->enRegisteredDomain)
#define NAS_LMM_SetEmmInfoRegDomain(RegDomain)      (((NAS_LMM_GetEmmInfoAddr())->enRegisteredDomain) = (RegDomain))
...
/*leili modify for isr begin*/
#if 0
#define NAS_EMM_GetEpsBearerContextAddr()           (&((NAS_LMM_GetEmmInfoAddr())->stEpsBearerCxt))
#define NAS_EMM_GetEpsContextStatusChange()         ((NAS_EMM_GetEpsBearerContextAddr())->enStatusChange)
#define NAS_EMM_GetEpsContextStatusAddr()           (&((NAS_EMM_GetEpsBearerContextAddr())->stEpsContextStatus))
#define NAS_EMM_GetEpsIdNum()                       ((NAS_EMM_GetEpsContextStatusAddr())->ulEpsIdNum)
#define NAS_EMM_GetEpsId(i)                         ((NAS_EMM_GetEpsContextStatusAddr())->aulEsmEpsId[i])
#endif
/*leili modify for isr end*/
...
#define NAS_EMM_GetLteNoSubscribeNvConfigPublishmentTimerVplmnLen()     (NAS_EMM_GetLteNoSubscribeNvConfigAddr()->ulPublishmentTimerHplmnLen)
...
#define NAS_EMM_GetLteNoSubscribeNvConfigPublishmentTimerHplmnLen()     (NAS_EMM_GetLteNoSubscribeNvConfigAddr()->ulPublishmentTimerVplmnLen)
...
#if 0
extern  VOS_VOID    NAS_LMM_SoftUsimInit(VOS_VOID);
#endif
...
extern  VOS_UINT32  NAS_LMM_ReadSimImsi(VOS_VOID);
extern  VOS_VOID NAS_LMM_ReadNvimImei(VOS_VOID);

/*extern  VOS_VOID NAS_EMM_ReadNvRaMod (VOS_VOID);*/
...
#if 0
extern  VOS_VOID    NAS_EMM_StopAllEmmStateTimer( VOS_VOID );
extern  VOS_VOID    NAS_EMM_StopAllEmmPtlTimer( VOS_VOID );
#endif
...
extern VOS_UINT32  NAS_LMM_ReadSimMncLen(VOS_VOID);
...
extern VOS_VOID NAS_EMM_SetUsimState( VOS_UINT32 ulUsimStatus );
...
/*leili modify for isr begin*/
#if 0
extern VOS_VOID  NAS_EMM_SendMmcTinTypeInd(MMC_LMM_TIN_TYPE_ENUM_UINT32    ulTinType);
#endif
/*leili modify for isr end*/
...
/*extern VOS_VOID NAS_EMM_SendMmInfoChangeNotify( VOS_VOID );*/
#if 0
extern VOS_VOID    NAS_EMM_SendGmmInfoChangeNotify( VOS_VOID );
#endif
...
#if 0
extern VOS_UINT32 NAS_EMM_IsCause161722DisableNeeded
(
    NAS_EMM_CN_CAUSE_ENUM_UINT8         enEMMCause
);
extern VOS_VOID NAS_EMM_RecogAndProc161722Disable
(
    NAS_EMM_CN_CAUSE_ENUM_UINT8         enEMMCause
);
extern VOS_UINT32 NAS_EMM_IsCause18DisableNeeded
(
    NAS_EMM_CN_CAUSE_ENUM_UINT8         enEMMCause
);
extern VOS_VOID NAS_EMM_RecogAndProc18Disable
(
    NAS_EMM_CN_CAUSE_ENUM_UINT8         enEMMCause
);
#endif
