...
/*extern  VOS_UINT32  NAS_LMM_MsNullSsWaitUsimReadyTimerExp( MsgBlock  * pMsg );*/
extern  VOS_UINT32  NAS_LMM_PreProcUsimSetCnf(   MsgBlock  * pMsg);
/*extern  NAS_LMM_SIM_STAT_ENUM_UINT32  NAS_LMM_GetUsimStatusWhenStart( VOS_VOID );*/
/*extern  NAS_LMM_SIM_SRV_STATUS_ENUM_UINT32  NAS_LMM_GetUsimOptionFileStatus(VOS_UINT32 SrvN);*/
extern  VOS_VOID    NAS_LMM_SetImsiUnavail( VOS_VOID );
extern  VOS_VOID  NAS_LMM_SendStubSoftUsimCnf( VOS_UINT32 ulReadUsimRslt );
/*extern  VOS_VOID  NAS_LMM_SendStubIntraAppStartReq( VOS_VOID );*/
/*extern  VOS_VOID  NAS_LMM_ReadUsimManFile( VOS_VOID );*/
extern  VOS_UINT32  NAS_LMM_ReadUsimEmmInfoFile( VOS_VOID );
/*extern  VOS_VOID  NAS_LMM_ReadUsimOptFile( VOS_VOID );*/
extern  VOS_VOID  NAS_LMM_FreeDynMem( VOS_VOID );
extern  VOS_VOID  NAS_LMM_SubModFreeDyn( VOS_VOID );
extern  VOS_VOID  NAS_LMM_SendRabmRrcConRelInd(VOS_VOID);
extern  VOS_UINT32  NAS_LMM_PreProcMsgUsimStatusInd( MsgBlock  *pMsg );
#if 0
extern  VOS_UINT32  NAS_EMM_MsNotNullSsAnyStateMsgUsimStatusInd(  VOS_VOID  *pMsg  );
#endif
