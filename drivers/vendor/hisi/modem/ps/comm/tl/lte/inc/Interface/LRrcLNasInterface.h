...
enum LRRC_LNAS_MSG_ID_ENUM
{
    ...
    ID_LRRC_LMM_CELL_SIGN_REPORT_NOTIFY   = (LMM_LRRC_MSG_HDR + 0x16),    /* _H2ASN_MsgChoice LRRC_LMM_CELL_SIGN_REPORT_NOTIFY_STRU*/
    ...
    ID_LRRC_LMM_CELL_SIGN_REPORT_IND      = (LRRC_LMM_MSG_HDR + 0x23),   /* _H2ASN_MsgChoice LRRC_LMM_CELL_SIGN_REPORT_IND_STRU */
    /*LRRC指示LMM发生了互操作成功或失败*/
    ID_LRRC_LMM_INTER_OPT_IND             = (LRRC_LMM_MSG_HDR + 0x24),       /* _H2ASN_MsgChoice LRRC_LMM_INTER_OPT_IND */
...
typedef struct
{
    ...
    VOS_UINT16                          ausLteArfcnList[LRRC_LNAS_MAX_ARFCN_NUM];
...
/*****************************************************************************
 ...
 结构说明  : NAS只在NAS显式的使用RRC_MM_PLMN_SEARCH_REQ消息发起的SPEC PLMN和
              PLMN LIST过程中，使用此消息通知RRC停止PLMN搜索；
...
{
    VOS_MSG_HEADER
    LRRC_LNAS_MSG_ID_ENUM_UINT32    ulMsgId;
...
extern VOS_UINT8  RRC_NAS_REEST_GetSrb2ValidFlg(VOS_VOID);
