...
/*lint --e{740,537,958,718,746,767,553,516,701,830,732,830,438}*/
...
VOS_VOID SI_PIH_PCSC_PowerOn(SI_PIH_PCSC_REQ_STRU *pstMsg)
{
    ...
    {
        SI_PIH_PCSCDataCnf(pstMsg->ulCmdType, (VOS_UINT32)lSCIResult, (ulATRLen+stSCIATRInfo.tckLen), aucATR);
    }
...
VOS_VOID SI_PIH_GetRSimContent(SI_PIH_CARD_CONTENT_STRU *pstCardCont)
{
    ...
    VOS_UINT32                          ulDataLen;
    VOS_UINT8                          *pucData;/* [false alarm]:fortify */
    VOS_UINT8                           ucHplmnMncLen;
    ...
    {
        PIH_ERROR_LOG("SI_PIH_GetRSimContent: USIMM_GetCardType fail.");/* [false alarm]:fortify */
        return;
    }
...
VOS_UINT32 SI_PIH_DecodeVSimFile(VOS_UINT8 *pucXMLData, SI_PIH_CARD_CONTENT_STRU *pstCardCont)
{
    ...
    OAM_XML_NODE_STRU                  *pstXmlNode;    /* [false alarm]:fortify *//*根节点*/
    VOS_UINT8                          *pucData;/* [false alarm]:fortify */
    ...
    /*解析文件根节点*/
    if(VOS_OK != USIMM_DecodeVsimRoot(pstXmlNode, &enCardType, VOS_NULL_PTR))/* [false alarm]:fortify */
    {
    ...
    pstCardCont->ucCardType = (VOS_UINT8)PIH_BIT_N(enCardType);/* [false alarm]:fortify */
    ...
    if(VOS_NULL_PTR == pucData)
    {
        ...
        OAM_XML_ClearXMLCtx(&stXmlCtx);/* [false alarm]:fortify */
