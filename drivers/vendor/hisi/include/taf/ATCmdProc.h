...
#define AT_SYSCFG_SET_PARA_TIME                             (60000)
...
/*  AT_CMD_FRSSI, */
    ...
    AT_CMD_KSNAFAUTH,
#endif
	AT_CMD_HIGHRATHPLMNSEARCHACTIVESTUB,
    AT_CMD_ANTSWITCH,
...
extern TAF_VOID     At_QryParaRspCgsnProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);

extern TAF_VOID     At_QryParaRspCaattProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);
...
extern TAF_VOID     At_QryParaRspCfunProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);

extern TAF_VOID     At_QryParaRspCpamProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);

extern TAF_VOID     At_QryParaRspCsqProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);

extern TAF_VOID     At_QryParaRspCbcProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);
...
extern TAF_VOID     At_QryParaRspHsProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);
...
extern VOS_UINT32     AT_QryParaRspPrefPlmnProc(VOS_VOID *pMsg);
...
extern TAF_VOID     At_QryParaRspCqstProc(
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);
...
extern TAF_VOID AT_QryParaRspCsqlvlExtProc (
    TAF_UINT8                           ucIndex,
    TAF_UINT8                           OpId,
    TAF_VOID                            *pPara
);

extern VOS_VOID AT_QryParaRspCsqlvlProc (
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           OpId,
    VOS_VOID                           *pPara
);
...
extern VOS_UINT32 MN_PH_GetPrefPlmnCnt(
...
extern VOS_VOID  AT_QryParaRegisterTimeProc(
    VOS_UINT8                           ucIndex,
    VOS_UINT8                           OpId,
    VOS_VOID                           *pPara
);
...
extern VOS_UINT32 atQryFCALPDDCSParaCnfProc(VOS_UINT8 ucClientId, VOID *pMsgBlock);
...
VOS_INT AT_CCpuResetCallback(
    DRV_RESET_CALLCBFUN_MOMENT          eparam,
    VOS_INT                             iUserData
);
