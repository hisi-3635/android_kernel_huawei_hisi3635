...
{
/*V3 ERRLOG Start */
/*  782  */      PS_FILE_ID_PS_LOG_C = PS_FILE_ID_OM_PCCOMM_C+1,
...
#define OSA_ASSERT_RTN(exp, ret) \
    ...
    {\
        ...
        return ret; }
#else
#define OSA_ASSERT( exp ) ( (VOS_VOID)0 )
#define OSA_ASSERT_RTN(exp, ret) ( (VOS_VOID)0 )
#endif
