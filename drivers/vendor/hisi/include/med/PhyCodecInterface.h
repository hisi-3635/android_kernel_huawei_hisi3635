...
enum DSP_VOICE_MSG_ID_ENUM
{
    ...
    ID_VOICEPP_VOICEPP_LINEIN_IND                     = 0xDD11,                 /* linein loop dma start msg */
    ID_VOICEPP_VOICEPP_SPKOUT_IND                     = 0xDD12,                 /* spkout loop dma start msg */
    ID_VOICEPP_VOICEPP_LINEOUT_IND                    = 0xDD13,                 /* lineout loop dma start msg */
    ID_VOICEPP_VOICEPP_PROC_IND                       = 0xDD14,                 /* 启动上行数据搬运 */
    ID_VOICEPP_VOICEPP_RXPROC_IND                     = 0xDD15,                 /* 下行数据算法处理 */
    ID_VOICEPP_VOICEPP_TXPROC_IND                     = 0xDD16,                 /* 上行数据算法处理 */
