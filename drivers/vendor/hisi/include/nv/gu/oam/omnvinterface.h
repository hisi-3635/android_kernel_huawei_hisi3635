...
typedef struct
{
    CPM_PHY_PORT_ENUM_UINT32            enPortNum;      /* 通道号 */
    VOS_UINT32                          ulReserve;      /* 保留字段 */
...
typedef struct
{
    VOS_UINT16                          usStkSmsindCtrl;      /* 上一次选择的ITEM ID */
}SI_STK_SMSIN_CTRL_STRU;
typedef struct
{
    VOS_UINT16                          usVivo;      /* 上一次选择的ITEM ID */
...
typedef struct
{
    VOS_UINT16                          usABBSwitch;    /*对应模式使用的ABB物理通道，0为ABB CH0，1为ABB CH1，2为当前模式使用用两个通道*/
    VOS_UINT16                          usRFSwitch;     /*对应模式使用的RF物理通道，0为RF使用mipi0控制PA-Star上电；1为RF使用mipi1控制PA-Star上电，或者使用Smart-Star的BUCK6来上电，2为当前模式使用两个RFIC*/
    VOS_UINT16                          usTCXOSwitch;   /*对应模式使用的TCXO，0为TCXO0，1为TCXO */
    VOS_UINT16                          usRsv1;
...
typedef struct
{
    ...
    VOS_UINT32                              aulReserved[3];                     /* 保留，将来扩展使用 */
...
typedef struct
{
    COMM_NV_MODE_BASIC_PARA_STRU            stModeBasicPara[2];                  /* 下标[0]:表示GSM模式下的前端器件的上下电控制。
                                                                                    下标[1]:表示WCDMA模式下的前端器件的上下电控制。
                                                                                    注：副卡时，不使用WCDMA模式的配置。*/
    VOS_UINT32                              ulRfSwitch;                         /* 用于控制共分集的开关 */
    VOS_UINT32                              ulGsmRficSel;                       /* 信令模式下当前使用的通道（0：RF0,1：RF1） */
    VOS_UINT32                              ulGpioCtrl;                         /* 是否需要时钟通道切换(0:不需要1:需要)*/
...
typedef struct
{
    COMM_NV_TRI_MODE_CHAN_PARA_STRU              stPara[COMM_NV_TRI_MODE_CHAN_PARA_PROFILE_NUM];  /* 最多支持8个场景的配置 */
