...
int fpc1020_write_test_setup(fpc1020_data_t *fpc1020, u16 pattern)
{
   ...
   switch (fpc1020->chip.type) {
    case FPC1020_CHIP_1020A:
           error =fpc1020_write_sensor_checkerboard_setup_1020(fpc1020, pattern) ;
           break;
    case FPC1020_CHIP_1021A:
    case FPC1020_CHIP_1021B:
    case FPC1020_CHIP_1021F:
           error =fpc1020_write_sensor_checkerboard_setup_1021(fpc1020, pattern);
            break;
    case FPC1020_CHIP_1150A:
    case FPC1020_CHIP_1150B:
           error =fpc1020_write_sensor_checkerboard_setup_1150(fpc1020, pattern) ;
           break;
    default:
           error=-EINVAL;
           break;
