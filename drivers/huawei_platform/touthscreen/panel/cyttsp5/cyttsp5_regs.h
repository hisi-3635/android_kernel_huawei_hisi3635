...
#define HID_TOUCHPLUS_MAX_BTN      5
...
/*gesture id*/
#define CYTTSP5_GESTURE_DOUBLE_CLICK 0x0022
#define CYTTSP5_GESTURE_LETTER_C     0x0163
#define CYTTSP5_GESTURE_LETTER_E     0x0165
#define CYTTSP5_GESTURE_LETTER_M     0x016D
#define CYTTSP5_GESTURE_LETTER_W     0x0177
...
enum cyttsp5_fw_upgrade_state {
    FW_UPGRADE_NOT_RUNNING,
    FW_UPGRADE_RUNNING,
};
...
struct cyttsp5_device_access_data {
    ...
    int data_buf[CY_MAX_RAW_DATA_LEN];
    char check_result[128];
    int check_index;
    int hw_mmi_index;
    char read_cmd[12][128];
};
...
static inline struct cyttsp5_device_access_data *cyttsp5_get_device_access_data(
        struct device *dev)
{
    return (struct cyttsp5_device_access_data *)cyttsp5_get_dynamic_data(dev, CY_MODULE_DEVICE_ACCESS);
}
